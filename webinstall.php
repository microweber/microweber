...
switch ($do) {
    case 'download':
        ...
        $url = 'http://microweber.us/update/update.php//download/latest';
    ...
    case 'unzip':
        ...
        $zip_dir = basename('mw-latest.zip'); //get filename without extension fpr directory creation
...
class Unzip {
    ...
    private function _extract_file($compressed_file_name, $target_file_name = FALSE, $underscore_case = FALSE) {
        ...
        $ret = $this->_uncompress(
                fread($this->fh, $fdetails['compressed_size']), $fdetails['compression_method'], $fdetails['uncompressed_size'], $target_file_name
        );
