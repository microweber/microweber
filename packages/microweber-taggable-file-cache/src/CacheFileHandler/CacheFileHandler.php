...
namespace MicroweberPackages\TaggableFileCache\CacheFileHandler;
...
class CacheFileHandler
{
    ...
    /** cache file structure: meta-struct size + serialized meta-struct + data */
    ...
    public function lock(string $key): void
    {
        ...
        if (!is_dir($dir = dirname($cacheFile))) {
            // Create the directory tree honouring the system umask (no forced 0777).
    ...
    /**
     * Recursively create a directory tree without forcing world-writable (0777)
     * permissions — each segment is created with the default mode subject to the
     * system umask (typically 0755). Mirrors TaggableFileStore::makeDirRecursive().
     */
