<!--
  ...
  Architecture:
    ...
    - Close via: × button / backdrop tap / ESC / Tab-out-of-trap.
    ...
    <Teleport to="body">
        ...
        >
            ...
            <nav class="mw-main-drawer__nav" aria-label="Main">
                ...
                <a
                    v-if="backToAdminLink"
                    :href="backToAdminLink"
                    class="mw-main-drawer__item"
                    @click="close()"
                >
                ...
                <button
                    ...
                    @click="openLayers()"
                >
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" width="18" height="18" fill="currentColor" aria-hidden="true">
            ...
            <!-- Footer — dark-mode toggle + Logout per L3.1. -->
            <footer class="mw-main-drawer__footer">
                ...
                >
                    <svg v-if="theme === 'light'" xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" width="18" height="18" fill="currentColor" aria-hidden="true">
                    ...
                    <svg v-else xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" width="18" height="18" fill="currentColor" aria-hidden="true">
