...
<template>
    ...
    <div :class="'mw-live-edit-right-sidebar-template-' + template" class="mw-live-edit-right-sidebar-wrapper me-2 ">
        ...
        <!--
          ...
          renamed "Template settings" → "Template & Layout" to match the
          updated controlBox title in `bootstrap.js`. The `toggle()`
          target string 'template-settings' is left unchanged — it's an
          internal state key, not user-visible copy.
        -->
        <button type="button"
            ...
            <v-tooltip activator="parent" location="start"><Lang>Template & Layout</Lang></v-tooltip>
