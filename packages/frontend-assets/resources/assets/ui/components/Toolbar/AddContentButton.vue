<template>
    <button v-on:click="openContentAddModal()" aria-label="Add content" class=" btn btn-icon me-2 px-3 live-edit-toolbar-buttons live-edit-toolbar-buttons-undo-redo tblr-body-color">
        ...
        <span class="sm:ms-2 hidden add-content-button-svg" style="font-size: 12px; font-weight: bold;">ADD</span>
    </button>
