<template>
    <button v-on:click="undo()" class="btn btn-icon me-2 py-2 live-edit-toolbar-buttons live-edit-toolbar-buttons-undo-redo" id="vue-toolbar-undo" :disabled='undoIsDisabled'>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="20px">
            <path
                d="M12.5,8C9.85,8 7.45,9 5.6,10.6L2,7V16H11L7.38,12.38C8.77,11.22 10.54,10.5 12.5,10.5C16.04,10.5 19.05,12.81 20.1,16L22.47,15.22C21.08,11.03 17.15,8 12.5,8Z"/>
        </svg>
    </button>
    <button v-on:click="redo()" class="btn btn-icon py-2 live-edit-toolbar-buttons live-edit-toolbar-buttons-undo-redo" id="vue-toolbar-redo" :disabled='redoIsDisabled'>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="20px">
            <path
