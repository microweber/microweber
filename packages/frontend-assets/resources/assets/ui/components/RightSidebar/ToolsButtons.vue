    ...
    <ul class="d-grid gap-3 list-unstyled p-3 pb-0">
        <li>
            <a class="mw-admin-action-links mw-adm-liveedit-tabs" v-on:click="showCodeEditor()">
                <svg class="mb-2 me-2" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px">
                    <path
        ...
        <li>
            <a class="mw-admin-action-links mw-adm-liveedit-tabs" v-on:click="handleLayers()">
                <svg class="mb-2 me-2" xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px" fill="currentColor">
