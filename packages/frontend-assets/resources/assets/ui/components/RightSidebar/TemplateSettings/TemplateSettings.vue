    ...
    <div class="mw-template-settings-panel">
        ...
        <div v-else>
            ...
            <div v-if="hasStyleSettings" class="form-control-live-edit-label-wrapper"
                ...
                <p class="text-muted small mb-3" style="margin-top: 0; font-size: 0.75rem; color: var(--ese-text-muted, #6b7280);">Choose a page layout template or edit global styles</p>
                ...
                <div id="layout-id-display" class="mt-3 small text-muted" v-if="applyMode === 'layout'"
                    ...
                    <div class="d-flex justify-content-between align-items-center p-2" style="border: 1px solid var(--ese-border, rgba(0,0,0,0.08)); border-radius: 6px; background: var(--ese-surface-muted);">
                        <span id="active-layout-id" @click="scrollToSelectedLayout" class="cursor-pointer" style="color: var(--ese-accent, #182433);">{{ activeLayoutId }}</span>
                        <span id="active-layout-id-open-settings" @click="openSelectedLayoutSettings" class="cursor-pointer" style="color: var(--ese-accent, #182433);">
            ...
            <div v-if="currentPath !== '/' && currentSetting && showStyleSettings !== 'styleEditor'">
                ...
                <div v-else>
                    ...
                    <div v-else class="text-muted text-center py-4" style="color: var(--ese-text-muted, #6b7280);">
                        <svg xmlns="http://www.w3.org/2000/svg" height="32px" viewBox="0 -960 960 960" width="32px" fill="currentColor" class="mb-2"><path d="M382-240 154-468l57-57 171 171 367-367 57 57-424 424Z"/></svg>
