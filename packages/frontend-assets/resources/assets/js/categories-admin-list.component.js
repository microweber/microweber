...
import {CategoriesAdminListBulkService} from "./categories-admin-list.bulk.service.js";
            ...
            options: {
                ...
                contextMenu: [
                    ...
                    },
                    {
                        ...
                        icon: '<svg class="tblr-body-color" fill="currentColor" data-bs-toggle="tooltip" aria-label="Edit Category" data-bs-original-title="Edit Category" xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="18px" viewBox="0 0 24 24" width="18px"><g><rect fill="none" height="24" width="24"></rect></g><g><g><g><path d="M3,21l3.75,0L17.81,9.94l-3.75-3.75L3,17.25L3,21z M5,18.08l9.06-9.06l0.92,0.92L5.92,19L5,19L5,18.08z"></path></g><g><path d="M18.37,3.29c-0.39-0.39-1.02-0.39-1.41,0l-1.83,1.83l3.75,3.75l1.83-1.83c0.39-0.39,0.39-1.02,0-1.41L18.37,3.29z"></path></g></g></g></svg>',
                        action: function (element, data, menuitem) {
                    ...
                    {
                        // Edit action for PAGE rows (top level of the tree). Category rows have
                        // "Edit Category" above; pages previously only had "Add category", so
                        // main-level pages couldn't be edited/viewed from here. Uses the
                        // admin_edit_url added to page nodes in AdminJsCategoryTree::appendPage.
                        title: 'Edit Page',

                        icon: '<svg class="tblr-body-color" fill="currentColor" data-bs-toggle="tooltip" aria-label="Edit Page" data-bs-original-title="Edit Page" xmlns="http://www.w3.org/2000/svg" enable-background="new 0 0 24 24" height="18px" viewBox="0 0 24 24" width="18px"><g><rect fill="none" height="24" width="24"></rect></g><g><g><g><path d="M3,21l3.75,0L17.81,9.94l-3.75-3.75L3,17.25L3,21z M5,18.08l9.06-9.06l0.92,0.92L5.92,19L5,19L5,18.08z"></path></g><g><path d="M18.37,3.29c-0.39-0.39-1.02-0.39-1.41,0l-1.83,1.83l3.75,3.75l1.83-1.83c0.39-0.39,0.39-1.02,0-1.41L18.37,3.29z"></path></g></g></g></svg>',
                        action: function (element, data, menuitem) {
                            if (data.admin_edit_url) {
                                self.location.href = data.admin_edit_url;
                            }
                        },
                        filter: function (obj, node) {
                    ...
                    },
                    {
                        ...
                        filter: function (obj, node) {
                            // View works for categories AND pages — both carry a frontend `url`.
                            return obj.type === 'category' || obj.type === 'page';
                        },
                        className: ''
                    },
