...
class GoogleTrendsService
{
     ...
     */
    public function getProxyConfigs(): ?array
    {
    ...
    public function getKnownEndpoints(): array
    {
        return [
            ...
            'interest_over_time' => self::INTEREST_OVER_TIME_ENDPOINT,
            'related_queries' => self::RELATED_QUERIES_ENDPOINT,
            'suggestions' => self::SUGGESTIONS_AUTOCOMPLETE_ENDPOINT,
            'compared_geo' => self::COMPARED_GEO_ENDPOINT,
            'categories' => self::CATEGORIES_ENDPOINT,
            'geo' => self::GEO_ENDPOINT,
            'daily' => self::DAILY_SEARCH_TRENDS_ENDPOINT,
            'realtime' => self::REAL_TIME_SEARCH_TRENDS_ENDPOINT,
        ];
    }
    ...
    {
        $cacheKey = "trends_queries_{$keyword}_" . md5((string) json_encode($options));
 ...
 * @param array<string|int, mixed> $relatedQueries
 * @param array<string|int, mixed> $suggestions
 * @return array<string|int, mixed>
 */
 ...
 * @param array<string|int, mixed> $existingQueries
 */
 ...
 * @param array<string|int, mixed> $trendingQueries
 * @param array<string|int, mixed> $productCategories
 * @return array<string|int, mixed>
 */
    ...
    /**
     * @param array<string|int, mixed> $proxy
     */
