 ...
 * @method static void registerGlobalSearchEntry(string $title, string $url, array $keywords = [], string $group = 'Settings', array $details = [], ?string $icon = null, string $panelId = 'admin')
 * @method static array getGlobalSearchEntries(string $panelId = 'admin')
