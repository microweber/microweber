...
<div class="mw-ui-dropdown right" id="history_dd">
      ...
      <span class="mw-ui-btn mw-ui-btn-medium mw-ui-btn-green mw-ui-btn right" onclick="mw.drag.save(this)" id="main-save-btn">Save</span>
        ...
        <div class="mw-ui-dropdown right"> <a href="<?php print mw('url')->current(); ?>/editmode:n" class="mw-ui-btn mw-ui-btn-medium" style="margin-left: 0;">Actions<span class="ico idownarr right"></span></a>
          <div class="mw-dropdown-content" style="width: 155px;">

            <ul class="mw-dropdown-list">
              <li><a href="<?php print mw('url')->current(); ?>/editmode:n">View Website</a></li>
              ...
              <?php endif; ?>
              <li><a href="<?php print mw('url')->api_link('logout'); ?>">Logout</a></li>
            </ul>
          </div>
        </div>
