...
<div class="editor_wrapper editor_wrapper_tabled" id="liveedit_wysiwyg">
  <div class="wysiwyg-table">
    <?php if(is_admin()): ?>
    <div class="wysiwyg-cell"> <span class="mw_editor_btn mw_editor_undo" data-command="custom-historyUndo" title="<?php _e("Undo"); ?>"><span class="ed-ico"></span></span> <span class="mw_editor_btn mw_editor_redo disabled" data-command="custom-historyRedo" title="<?php _e("Redo"); ?>"><span class="ed-ico"></span></span> <span class="mw_editor_btn"  onclick="mw.$('#mw-history-panel').toggle()"><span class="dd_rte_arr" style="margin: 12px 5px 0;"></span></span>
    ...
    <div class="wysiwyg-cell">
      <div class="relative"> <span class="mw_editor_btn mw_editor_justifyleft wysiwyg-convertible-toggler wysiwyg-convertible-toggler-1440"> <span class="dd_rte_arr"></span> <span class="ed-ico"></span> </span>
