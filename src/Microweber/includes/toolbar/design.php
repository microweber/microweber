    ...
    <li class="ts_main_li"> <a class="ts_main_a dd_design_spacing" href="javascript:;"><?php _e("Spacing"); ?></a>
      <div class="ts_action" style="width: 200px;">
        <div class="ts_action_item mw-designtype-universal">
          <div class="mw_dropdown mw_dropdown_type_wysiwyg mw_dropdown_func_slider left" id="margin_selector" data-for="margin_slider"> <span class="mw_dropdown_val_holder"> <span class="dd_rte_arr"></span> <span class="mw_dropdown_val"><?php _e("Margin"); ?></span> </span>
        ...
        <div class="ts_action_item mw-designtype-element">
          <div class="mw_dropdown mw_dropdown_type_wysiwyg mw_dropdown_func_slider left" id="padding_selector" data-for="padding_slider"> <span class="mw_dropdown_val_holder"> <span class="dd_rte_arr"></span> <span class="mw_dropdown_val"><?php _e("Padding"); ?></span> </span>
            <div class="mw_dropdown_fields">
              <ul style="width: 100%">
                <li value="true">
                  <div class="square_map">
    ...
    <li class="ts_main_li mw-designtype-universal"> <a class="ts_main_a dd_design_border" href="javascript:;"><?php _e("Border"); ?></a>
      <div class="ts_action" style="width: 185px;">
        ...
        <div class="ts_action_item">
          ...
          <div class="mw_dropdown mw_dropdown_type_wysiwyg dd_borderwidth_Selector" style="margin-left: -5px;width: auto"  title="<?php _e("Border Width"); ?>" data-value="0"> <span class="mw_dropdown_val_holder"> <span class="dd_rte_arr"></span> <span class="mw_dropdown_val" style="width: auto">0</span> </span>
            <div class="mw_dropdown_fields">
              <ul style="width: auto">
      ...
      <div class="ts_action ts_bg_action" style="width: 200px;">
        ...
        <div class="ts_action_item">
          <div class="ts_action_centerer"> <span class="ed_label left"><?php _e("Repeat"); ?></span>
            <div class="mw_dropdown mw_dropdown_type_wysiwyg hovered" style="margin-left: -5px;margin-top: -3px;width: auto;" id="ts_bg_repeat" title="Background Repeat" data-value="none"> <span class="mw_dropdown_val_holder"> <span class="dd_rte_arr"></span> <span class="mw_dropdown_val" style="width: auto"><?php _e("No-Repeat"); ?></span> </span>
              <div class="mw_dropdown_fields">
        ...
        <div class="ts_action_item">
          <div class="ts_action_centerer">
            <div class="mw_dropdown mw_dropdown_type_wysiwyg mw_dropdown_func_slider left hovered" style="width: auto;margin-left: -6px;" id="ts_bg_position"> <span class="mw_dropdown_val_holder"> <span class="dd_rte_arr"></span> <span class="mw_dropdown_val" style="width: auto;"><?php _e("Background Position"); ?></span> </span>
              <div class="mw_dropdown_fields">
                <ul style="width: 100%">
                  <li value="true">
                    <div class="square_map">
