  ...
  <ul class="ts_main_ul">
    ...
    <li class="ts_main_li"> <a class="ts_main_a dd_design_spacing" href="javascript:;"><?php _e("Spacing"); ?></a>
      <div class="ts_action" style="width: 200px;">
        ...
        <div class="ts_action_item mw-designtype-element">
          <div class="mw-dropdown mw-dropdown-type-wysiwyg mw-dropdown_func_slider left" id="padding_selector" data-for="padding_slider"> <span class="mw-dropdown-value"> <span class="mw-dropdown-arrow"></span> <span class="mw-dropdown-val"><?php _e("Padding"); ?></span> </span>
            <div class="mw-dropdown-content">
              <ul style="width: 100%">
                <li value="true">
                  <div class="square_map">
    ...
    <li class="ts_main_li mw-designtype-universal"> <a class="ts_main_a dd_design_border" href="javascript:;"><?php _e("Border"); ?></a>
      <div class="ts_action" style="width: 185px;">
        ...
        <div class="ts_action_item">
          <div class="mw-dropdown mw-dropdown-type-wysiwyg dd_border_selector" style="margin: 0 8px 0 0;width: auto;"  title="<?php _e("Border Style"); ?>" data-value="solid"> <span class="mw-dropdown-value"> <span class="mw-dropdown-arrow"></span> <span class="mw-dropdown-val" style="width: 62px;"><span class="border_selector" style="border-bottom-style: solid">Solid</span></span> </span>
            <div class="mw-dropdown-content">
              <ul style="width: auto">
    ...
    <li class="ts_main_li mw-designtype-element"> <a class="ts_main_a dd_design_bg" href="javascript:;"><?php _e("Background"); ?></a>
      <div class="ts_action ts_bg_action" style="width: 200px;">
        ...
        <div class="ts_action_item">
          <div class="ts_action_centerer">
            <div class="mw-dropdown mw-dropdown-type-wysiwyg mw-dropdown_func_slider left hovered" style="width: auto;margin-left: -6px;" id="ts_bg_position"> <span class="mw-dropdown-value"> <span class="mw-dropdown-arrow"></span> <span class="mw-dropdown-val" style="width: auto;"><?php _e("Background Position"); ?></span> </span>
              <div class="mw-dropdown-content">
                <ul style="width: 100%">
                  <li value="true">
                    <div class="square_map">
