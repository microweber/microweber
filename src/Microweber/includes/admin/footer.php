  ...
  <div class="create-content-menu">
    ...
    <a href="<?php print admin_url('view:content'); ?>#action=new:product">
        <span class="mw-icon-product"></span>
        <strong>Product</strong></a>
    <?php /* <a href="<?php print admin_url('view:content'); ?>#action=new:product"><span class="product-icon"><span class="product-icon-1"></span><span class="product-icon-2"></span><span class="product-icon-3"></span></span><strong>Product</strong></a> */ ?>
    </div>
</div>
