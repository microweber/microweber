...
function reorder_content($params)
{
    ...
    return \mw('Mw\ContentUtils')->reorder($params);
...
{
    return \mw('Mw\ContentUtils')->save_edit($post_data);
}
...
function delete_content($data)
{
    ...
    return \mw('Mw\ContentUtils')->delete($data);
...
function save_content($data, $delete_the_cache = true)
{
    ...
    return \mw('Mw\ContentUtils')->save_content($data, $delete_the_cache);
...
function save_content_field($data, $delete_the_cache = true)
{
    ...
    return \mw('Mw\ContentUtils')->save_content_field($data, $delete_the_cache);
...
{
    return \mw('Mw\ContentUtils')->edit_field_draft($data);
}
...
function content_set_published($params)
{
    ...
    return \mw('Mw\ContentUtils')->set_published($params);
...
function content_set_unpublished($params)
{
    ...
    return \mw('Mw\ContentUtils')->set_unpublished($params);
...
{
    return \mw('Mw\ContentUtils')->templates_list($options);
...
function mw_print_admin_dashboard_orders_btn()
{
    ...
    $notif_html = '';
    $notif_count = mw('Mw\Notifications')->get('module=shop&rel=cart_orders&is_read=n&count=1');
    if ($notif_count > 0) {
...
{
    return \mw('Mw\ContentUtils')->menu_create($data_to_save);
...
{
    return \mw('Mw\ContentUtils')->menu_delete($id);
...
function delete_menu_item($id)
{
    ...
    return \mw('Mw\ContentUtils')->menu_item_delete($id);
...
function get_menu_item($id)
{
    ...
    return \mw('Mw\ContentUtils')->menu_item_get($id);
...
{
    return \mw('Mw\ContentUtils')->menu_item_save($data_to_save);
...
function reorder_menu_items($data)
{
    ...
    return \mw('Mw\ContentUtils')->menu_items_reorder($data);
...
{
    return \mw('Mw\ContentUtils')->is_in_menu($menu_id,$content_id);
...
{
    return \mw('Mw\ContentUtils')->add_content_to_menu($content_id,$menu_id);
...
function reorder_modules($data)
{
    ...
    return \mw('Mw\Modules')->reorder_modules($data);
}
...
{
    return \mw('Mw\Modules')->delete_module($id);
}

function delete_modules_from_db()
{
    return \mw('Mw\Modules')->delete_all();
}
...
function uninstall_module($params)
{
    ...
    return \mw('Mw\Modules')->uninstall($params);
...
function re_init_modules_db()
{
    ...
    return \mw('Mw\Modules')->update_db();
...
function install_module($params)
{
    ...
    return \mw('Mw\Modules')->install($params);

}

function save_module_to_db($data_to_save)
{
    return \mw('Mw\Modules')->save($data_to_save);

}

function get_saved_modules_as_template($params)
{
    return \mw('Mw\Modules')->get_saved_modules_as_template($params);
}
...
function delete_module_as_template($data)
{
    ...
    return \mw('Mw\Modules')->delete_module_as_template($data);
...
function save_module_as_template($data_to_save)
{
    ...
    return \mw('Mw\Modules')->save_module_as_template($data_to_save);
}
...
function modules_list($options = false)
{
    ...
    return \mw('Mw\Modules')->scan_for_modules($options);
}
...
{
    return \mw('Mw\Modules')->get_layouts($options);
