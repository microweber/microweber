<?php if($section == 'dashboard'){ ?>
 ...
 <div class="mw-helpinfo semi_hidden">
           <div class="mw-help-item" data-for="#mw_toolbar_logo" data-pos="bottomleft">
                <div >
                  <img src="<?php print INCLUDES_URL; ?>img/helpinfo/logo.png" alt=""  class="mwhelpinfoimg" />
           ...
           <div style="width: 605px;">
               <img src="<?php print INCLUDES_URL; ?>img/helpinfo/stat.png" alt="" class="mwhelpinfoimg" />
           ...
           <div class="mw-help-item" data-for="#real_users_online" data-pos="rightcenter">
             <div style="width: 360px;">
                 <img src="<?php print INCLUDES_URL; ?>img/helpinfo/users.png" alt=""  class="mwhelpinfoimg" />
           ...
           <div class="mw-help-item" data-for=".mw-toolbar-notification" data-pos="bottomright" data-css="margin-left:17px;">
               <img src="<?php print INCLUDES_URL; ?>img/helpinfo/notifications.png" alt="" class="mwhelpinfoimg" />
           ...
           <div class="mw-help-item" data-for="#mw-go_livebtn_admin" data-pos="bottomright" data-onnext="nextpage('<?php print admin_url('view:content'); ?>');">
              <div style="width: 320px;">
                <img src="<?php print INCLUDES_URL; ?>img/helpinfo/live_edit.png" alt="" class="mwhelpinfoimg" />
...
<div class="mw-helpinfo semi_hidden">
           ...
           <div class="mw-help-item" data-for="#pages_tree_toolbar" data-pos="righttop">
             <div  style="width: 500px;">
               <img src="<?php print INCLUDES_URL; ?>img/helpinfo/tree.png" class="mwhelpinfoimg" alt="" />
           ...
           <div  style="width: 400px;">
                 <img src="<?php print INCLUDES_URL; ?>img/helpinfo/posts.png" class="mwhelpinfoimg" alt="" />
           ...
           <div class="mw-help-item" data-for="#action_new_page button" data-pos="rightcenter" data-onshow="addnewpage()">
                ...
                <img src="<?php print INCLUDES_URL; ?>img/helpinfo/add_new.png" class="mwhelpinfoimg" alt="" />
           ...
           <div class="mw-help-item" data-for=".mw_action_product button" data-pos="rightcenter">
                <div  style="width: 295px;">
                <img src="<?php print INCLUDES_URL; ?>img/helpinfo/product.png" class="mwhelpinfoimg" alt="" />
                 <p style="padding-top: 24px">... or Product</p>
           </div>
           </div>

           <div class="mw-help-item" data-for=".mw-template-selector .mw-ui-select" data-pos="topright" >
           <img src="<?php print INCLUDES_URL; ?>img/helpinfo/design.png" class="mwhelpinfoimg" alt="" />
           ...
           <img src="<?php print INCLUDES_URL; ?>img/helpinfo/layout.png" class="mwhelpinfoimg" alt="" />
           ...
           <div class="mw-help-item" data-for=".module-custom-fields-admin-holder" data-pos="topcenter" data-onbeforeshow="showcustomfields()">
               <div style="width: 410px;">
                <img src="<?php print INCLUDES_URL; ?>img/helpinfo/price.png" class="mwhelpinfoimg" alt="" />
...
<div class="mw-helpinfo semi_hidden">
    ...
    <div class="mw-help-item" data-for="#mw-admin-shop-navigation" data-pos="bottomcenter" data-onnext="nextpage('<?php print admin_url('view:modules'); ?>')">
         <div style="width: 700px;">
             <img src="<?php print INCLUDES_URL; ?>img/helpinfo/settings.png" class="mwhelpinfoimg" alt="" />
...
<script type="text/javascript">
   ...
   mw.require("<?php print INCLUDES_URL; ?>css/helpinfo.css", true);
</script>
...
<div id="HELPINFOGHOST" style="display: none;">
    <div style="width: 320px;">
      <img src="<?php print INCLUDES_URL; ?>img/helpinfo/help.png" class="mwhelpinfoimg" alt="" />
