...
class MwCache {
	...
	function mw('cache')->delete($cache_group = 'global') {
		// return true;
	...
	function mw('cache')->get($cache_id, $cache_group = 'global', $time = false) {
		//
	...
	function mw('cache')->save($data_to_cache, $cache_id, $cache_group = 'global') {
	 ...
	 *        	object or array, please use the mw('cache')->save() function
	 * @param string $cache_group
	 *        	(default is 'global') - this is the subfolder in the cache dir.
	 *
	 * @return string
