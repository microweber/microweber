...
class Shop
{
    ...
    static function get_cart($params)
    {
    ...
    static function get_orders($params = false)
    {
    ...
    static function checkout_confirm_email_send($order_id, $to = false, $no_cache = false) {
    ...
    static function payment_options($option_key = false)
    {
    ...
    static function remove_cart_item($data)
    {
    ...
    static function update_cart_item_qty($data)
    {
    ...
    static function update_cart($data)
    {
   ...
   static  function checkout_confirm_email_test($params)
    ...
    static function checkout_ipn($data)
    {
        if (!session_id() and !headers_sent()) {
            //	session_start();
        }
    ...
    static function cart_sum($return_amount = true)
    {
        if (!session_id() and !headers_sent()) {
            session_start();
        }
     ...
     */
    static function update_order($params = false)
    {
    ...
    static function delete_client($data)
    {
    ...
    static function delete_order($data)
    {
    ...
    static function create_mw_shop_default_options()
    {
