...
class Swift_Transport_MailTransport implements \Swift_Transport
{
     ...
     *
     * Note that $this->_escapeShellArg and escapeshellcmd are inadequate for our purposes, especially on Windows.
     *
    ...
    {
        // Future-proof
        if ($this->_escapeShellArg($string) !== $string || !in_array($this->_escapeShellArg($string), array("'$string'", "\"$string\""))) {
            return false;
        }
