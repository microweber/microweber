...
//                                    } else {
                                    ...
                                    if ($root_module_id) {
                                        ...
                                        $mod_id = $mod_id . 'data-parent-module-id' . md5($attrs['data-parent-module-id']);
                                    } else {
...
//                                }
                                ...
                                if ($this->have_more) {
                                    if ($root_module_id and !$coming_from_parent) {
                                        ...
                                        $attrs2['data-root-module-id'] = $root_module_id;
                                        $attrs2['data-root-module'] = $root_module_id;
