...
//
        ...
        if ($render_file) {
            ...
            if (isset($_REQUEST['isolate_content_field'])) {
                ...
                if ($is_admin == true) {
                    ...
                    $layout_toolbar = $this->app->view($tb);
            ...
            if ($is_editmode == true and $this->isolate_by_html_id == false and !isset($_REQUEST['isolate_content_field'])) {
                ...
                if ($is_admin == true) {
                    ...
                    if (is_file($custom_live_edit)) {
                        $layout_live_edit = $this->app->view($custom_live_edit);
    ...
    public function admin()
    {
        ...
        $l = $this->app->view(MW_ADMIN_VIEWS_DIR . 'admin.php');
        $l = $l->__toString();
        // var_dump($l);
    ...
    public function module()
    {
        ...
        if (!isset($_REQUEST['module'])) {
            ...
            if ($pos !== false) {
                $url = substr_replace($url, '', $pos, strlen($needle));
            }
            $needle = 'module_api/';
            $pos = strpos($url,$needle);
            if ($pos !== false) {
...
// dump the picture and stop the script
    ...
    public function apijs()
    {
        ...
        $l = $this->app->view(MW_INCLUDES_DIR . 'api' . DS . 'api.js');
        $l = $l->__toString();
        // var_dump($l);
        //session_write_close();
    ...
    public function editor_tools()
    {
        ...
        //$v = $this->app->view(MW_ADMIN_VIEWS_DIR . '404.php');
        //echo $v;
    }
