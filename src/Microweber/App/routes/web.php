...
Route::group(['middleware' => \Microweber\App\Http\Middleware\SessionlessMiddleware::class, 'namespace' => '\Microweber\App\Controllers'], function () {
...
Route::group(['namespace' => '\Microweber\App\Controllers'], function () {
