...
<body class="is_admin loading <?php if(isset($body_class)){ print $body_class ; } ?> view-<?php print mw()->url_manager->param('view'); ?> action-<?php print mw()->url_manager->param('action'); ?>">
