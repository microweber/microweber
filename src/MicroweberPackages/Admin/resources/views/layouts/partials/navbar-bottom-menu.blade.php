...
<ul class="navbar-nav-padding nav-item-profile-wrapper" style="margin-bottom: 0;">
    ...
    <a href="javascript:mw_admin_toggle_dark_theme()"
       class="dropdown-item nav-link navbar-change-theme-icon navbar-change-theme-icon-light">
        <div id="navbar-change-theme-icon-light" <?php if ($bodyTheme == 'dark'): ?> style="display: none;" <?php endif; ?>>
           <div class="d-flex">
        ...
        <div id="navbar-change-theme-icon-dark" <?php if ($bodyTheme == 'light'): ?> style="display: none;" <?php endif; ?> >
            <div class="d-flex">
                <svg fill="currentColor" style="margin-right: 20px;" xmlns="http://www.w3.org/2000/svg" height="24"
                     viewBox="0 96 960 960" width="24">
                    <path
