<aside class="admin-dashboard-left-nav col-lg-2 justify-content-center d-flex py-3">
    ...
    <ul class="nav flex-column" id="mw-admin-main-navigation">
        ...
        <li class="nav-item dropdown">
            <a class="nav-link py-3 fs-3  <?php if (  ($view == 'settings')): ?> active <?php endif; ?>" href="<?php print admin_url(); ?>view:settings?group=all">
        ...
        <?php /*
                <li class="nav-item dropdown">
                    <a class="nav-link py-3 fs-3 dropdown-toggle <?php if (!url_param('has_core_update') and ($view == 'settings')): ?> active <?php endif; ?>" href="<?php print admin_url(); ?>view:settings?group=website">
                        <i class="fs-1 me-2 mdi mdi-cog"></i>
                        <span class="badge-holder"><?php _e("Settings"); ?></span>
                    </a>
                    <div class="dropdown-menu">
