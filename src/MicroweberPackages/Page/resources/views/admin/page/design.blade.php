        ...
        <div class="card-body">
            <div class="row">
                <div class="d-flex align-items-start flex-wrap justify-content-between mb-4 px-0">
                    ...
                    <div class="col-lg-6 col-12 text-end" id="mw-design-page-icons" style="display: none;">
                        <a href="" target="_new" class="js-layout-preview btn btn-link fs-3 me-2 tblr-body-color mw-admin-action-links text-decoration-none" data-bs-toggle="tooltip" aria-label="{{ _e("Preview") }}" data-bs-original-title="{{ _e("Preview") }}">
                        ...
                        <a href="" class="js-layout-customize btn btn-link fs-3 tblr-body-color mw-admin-action-links text-decoration-none" data-bs-toggle="tooltip" aria-label="{{ _e("Customize") }}" data-bs-original-title="{{ _e("Customize") }}">
