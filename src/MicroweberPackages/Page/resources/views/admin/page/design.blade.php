                    ...
                    <div class="col-lg-6 col-12 mb-xl-0 mb-2">
                       ...
                       <div class="mb-4">
                        ...
                        <div class="d-flex align-items-center gap-3">
                            <a class="tblr-body-color font-weight-bold text-decoration-none mw-admin-action-links" href="{{admin_url('settings?group=general')}}">
                            ...
                            <a class="tblr-body-color font-weight-bold text-decoration-none mw-admin-action-links" href="{{admin_url('marketplace?keyword=&category=microweber-template')}}">
