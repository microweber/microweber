                ...
                @if($fonts->count() > 0)
                    @foreach($fonts as $font)
                        ...
                        <div wire:key="font-id-{{$fontId}}"
                            ...
                            <div>
                                <button type="button" x-on:click="favorite = true"
                                        wire:click="favorite('{{$font['family']}}')">
                            ...
                            <div>
                                <div x-show="favorite" class="pr-3" x-on:click="favorite = false"
                                     wire:click="removeFavorite('{{$font['family']}}')">
                                ...
                                <div x-show="!favorite" class="pr-3" x-on:click="favorite = true"
                                     wire:click="favorite('{{$font['family']}}')">
