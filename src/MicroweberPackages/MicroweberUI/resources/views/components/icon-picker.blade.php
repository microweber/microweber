...
<div
    ...
    <div class="form-control-live-edit-label-wrapper d-flex justify-content-between flex-wrap gap-2">
        ...
        <div class="d-flex justify-content-start gap-2 col-6">
            ...
            <button style="display:none" id="btn-icon-preview-{{$randId}}" class="btn text-center col-1" onclick="mw.app.iconPicker.selectIcon('#btn-icon-pick-{{$randId}}')" style="font-size:24px; background-color: #f5f5f5;">
                Loading...
            </button>
        </div>

        <button style="display:none" id="btn-icon-delete-{{$randId}}" class="btn border-0 col-auto px-1" onclick="mw.app.iconPicker.removeIcon('#btn-icon-pick-{{$randId}}')" type="button">
