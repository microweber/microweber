    ...
    <div class="table-responsive">
        <div class="mw-responsive-table-wrapper">
            <table class="table card-table table-vcenter mw-mobile-table" style="min-width: 270px;">
                ...
                <tr>
                    <td data-tip="{{$customField->name}}" class="tip custom-field-icon">
                    ...
                    <td class="text-center">
                        <button onclick="Livewire.emit('openModal', 'custom-field-edit-modal', {{ json_encode(['customFieldId'=>$customField->id]) }})" type="button">
                    ...
                    <td class="text-center">
                        ...
                        @endphp
                        <button onclick="Livewire.emit('openModal', 'admin-confirm-modal', {{ json_encode($deleteModalData) }})" type="button" class="text-danger" data-bs-toggle="tooltip" aria-label="Delete" data-bs-original-title="Delete">
