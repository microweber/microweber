        ...
        <div>
            <div class="d-flex justify-content-between mb-3">
                ...
                <div class="d-flex align-items-center">
                    <button type="button" onclick="Livewire.emit('openModal', 'custom-field-add-modal', {{ json_encode(['relId'=>$relId,'relType'=>$relType]) }})" class="d-flex align-items-center btn btn-outline-dark">
