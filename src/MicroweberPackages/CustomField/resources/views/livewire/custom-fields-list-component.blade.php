        ...
        <div>
            <div class="d-flex justify-content-between mb-3">
                ...
                <div class="d-flex align-items-center">
                    <button type="button" onclick="Livewire.dispatch('openMwTopDialogIframe', 'custom-field-add-modal', {{ json_encode(['relId'=>$relId,'relType'=>$relType]) }})" class="d-flex align-items-center btn btn-outline-dark js-add-custom-field">
            ...
            <div class="table-responsive">
                <div class="mw-responsive-table-wrapper">
                    <table class="table card-table table-vcenter mw-mobile-table" style="min-width: 270px;">
                        ...
                        <tr class="js-sortable-item" sort-key="{{ $customField->id }}" ondblclick="Livewire.dispatch('openMwTopDialogIframe', 'custom-field-edit-modal', {{ json_encode(['customFieldId'=>$customField->id]) }})">
                            <td>
                            ...
                            <td class="text-center">
                                <button class="mw-liveedit-button-actions-component" onclick="Livewire.dispatch('openMwTopDialogIframe', 'custom-field-edit-modal', {{ json_encode(['customFieldId'=>$customField->id]) }})" type="button">
                            ...
                            <td class="text-center">
                                ...
                                @endphp
                                <button onclick="Livewire.dispatch('openModal', 'admin-confirm-modal', {{ json_encode($deleteModalData) }})" type="button" class="mw-liveedit-button-actions-component" data-bs-toggle="tooltip" aria-label="Delete" data-bs-original-title="Delete">
                        ...
                        mw.$("#js-sortable-items-holder-{{$this->getId()}}").sortable({
                            ...
                            update: function () {
                                setTimeout(function () {
                                    ...
                                    Livewire.dispatch('onReorderCustomFieldsList', obj);
                                }, 300);
                            },
                            scroll: false
                        });
