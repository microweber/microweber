                    ...
                    <table class="table card-table table-vcenter mw-mobile-table" style="min-width: 270px;">
                        ...
                        <tr class="js-sortable-item" sort-key="{{ $customField->id }}">
                            ...
                            <td class="text-center">
                                <button class="mw-liveedit-button-actions-component" onclick="Livewire.emit('openModal', 'custom-field-edit-modal', {{ json_encode(['customFieldId'=>$customField->id]) }})" type="button">
