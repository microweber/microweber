<div style="margin:60px;padding:20px;background:#fff;">
    ...
    <div class="d-flex justify-content-between mb-3">
        ...
        <div class="d-flex align-items-center">
            <button type="button" onclick="Livewire.emit('openModal', 'custom-field-add-modal', {{ json_encode(['contentId'=>$contentId,'contentType'=>$contentType]) }})" class="d-flex align-items-center btn btn-outline-dark">
            ...
            <table class="table card-table table-vcenter mw-mobile-table" style="min-width: 270px;">
                ...
                <tr>
                    ...
                    <td class="text-center">
                        ...
                        @endphp
                        <button onclick="Livewire.emit('openModal', 'admin-confirm-modal', {{ json_encode($deleteModalData) }})" type="button" class="mw-liveedit-button-animation-component" data-bs-toggle="tooltip" aria-label="Delete" data-bs-original-title="Delete">
