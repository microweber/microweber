<x-microweber-ui::form-section submit="createProfileInformation">
    ...
    <x-slot name="description">
        Please fill the form below to create a new user.
    </x-slot>
    ...
    <x-slot name="form">
        ...
        <div class="col-span-6 sm:col-span-4">
            ...
            <x-microweber-ui::input id="username" type="text" class="mt-1 block w-full" wire:model="state.username"  name="username" />
        ...
        <div class="live-edit-label">
            ...
            <x-microweber-ui::input id="first_name" type="text" class="mt-1 block w-full" wire:model="state.first_name" name="first_name" />
        ...
        <div class="live-edit-label">
            ...
            <x-microweber-ui::input id="last_name" type="text" class="mt-1 block w-full" wire:model="state.last_name"  name="last_name" />
        ...
        <div class="live-edit-label">
            ...
            <x-microweber-ui::input id="password" type="password" class="mt-1 block w-full" wire:model="state.password" name="password" />
        ...
        <div class="col-span-6 sm:col-span-4 my-3">
            ...
            <select id="role" class="form-select" wire:model="state.is_admin" name="is_admin">
        ...
        <div class="col-span-6 sm:col-span-4 my-3">
            ...
            <select id="is_active" class="form-select" wire:model="state.is_active" name="is_active">
