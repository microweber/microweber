<div class="ms-4 input-icon col-xl-3 col-sm-5 col-12  mb-3 mb-md-0 ps-0">
    <div class="input-group input-group-flat ">
        ...
        <span class="input-group-text">
            <a href="#" class="link-secondary ms-2" data-bs-target="#js-order-filters" data-bs-toggle="dropdown" aria-expanded="false" ><!-- Download SVG icon from http://tabler-icons.io/i/adjustments -->
    ...
    <div class="d-flex">
        <div class="ms-0 ms-md-2 mb-3 mb-md-0">
            ...
            <div class="dropdown-menu p-3" id="js-order-filters" style="max-height:300px;overflow-y: scroll;padding-bottom:10px">
