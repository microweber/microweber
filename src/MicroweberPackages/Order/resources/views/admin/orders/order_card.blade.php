...
@section('content')
    ...
    if ($order->customer_id > 0) {
        $orderUser = \Modules\Customer\Models\Customer::where('id', $order->customer_id)->first();
    }
    ...
    <div
        class="js-order-card-<?php print $order['id'] ?> card <?php if($order['order_status']=='new'):?>card-success<?php endif;?> mb-3 not-collapsed-border collapsed card-order-holder"
        data-bs-toggle="collapse" data-bs-target="#notif-order-item-<?php echo $order['id'];?>" aria-expanded="false"
        aria-controls="collapseExample">
        <div class="card-body py-2">
            <div class="row">
                <div class="col-12 col-md-6" data-bs-toggle="collapse"
                     data-bs-target="#notif-order-item-<?php print $order['id'] ?>">
                    <div class="row align-items-center">
                        ...
                        <div class="col item-title" style="min-width: 210px;">
                            ...
                            <?php endif; ?>
                            <small
                                class="text-muted  text-break-line-2"><?php print mw('format')->ago($order['created_at']); ?>  </small>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="col-sm-6 col-md-4">
                        ...
                        <div>
                            ...
                            <p>
                                ...
                                <i class="<?php echo $paymentGatewayModuleInfo['settings']['icon_class'];?>"
