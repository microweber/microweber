                    ...
                    modalImageSettingsOpen: false,
                     init() {
                      ...
                      async deleteMediaById(id) {
                          ...
                          if(dialogConfirm) {
                           $dispatch('deleteMediaItemById', { id: id })
                          }
                      }
                    ...
                    >
                        @foreach($this->mediaItems as $item)
                            ...
                            <span class="mw-post-media-img" style="background-image: url('{{ $item->filename }}');">
                                ...
                                <svg @click="deleteMediaById('{{ $item->id }}')" xmlns="http://www.w3.org/2000/svg" class="image-settings remove-image tip"
