            ...
            function mwMediaManagerComponent({mediaIds}) {
                return {
                    ...
                    editMediaOptionsById(id) {
                        this.modalImageSettingsOpen = true;
                    },
                    ...
                    >
                        ...
                        <div class="admin-thumbs-holder" x-sortable>
                            ...
                            <span class="mw-post-media-img" style="background-image: url('{{ $item->filename }}');">
                                    ...
                                    <svg @click="editMediaOptionsById('{{ $item->id }}')" class="image-settings settings-img tip" width="20px" height="20px"
                            ...
                            @endforeach
                                ...
                                <div x-show="modalImageSettingsOpen" class="fixed inset-0 z-50 overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true">
                                    <div class="flex items-end justify-center min-h-screen px-4 text-center md:items-center sm:block sm:p-0">
                                        <div x-cloak @click="modalImageSettingsOpen = false" x-show="modalImageSettingsOpen"
                                        ...
                                        <div x-cloak x-show="modalImageSettingsOpen"
                                             x-transition:enter="transition ease-out duration-300 transform"
                                        ...
                                        >
                                            <div class="flex items-center justify-between space-x-4">
                                                <h1 class="text-xl font-medium text-gray-800 ">Todo</h1>

                                                <button @click="modalImageSettingsOpen = false" class="text-gray-600 focus:outline-none hover:text-gray-700">
                                            ...
                                            <form class="mt-5">
                                                <div>
                                                    <label for="user name" class="block text-sm text-gray-700 capitalize dark:text-gray-200">Todo</label>
                                                    <input placeholder="Todo" type="text" class="block w-full px-3 py-2 mt-2 text-gray-600 placeholder-gray-400 bg-white border border-gray-200 rounded-md focus:border-indigo-400 focus:outline-none focus:ring focus:ring-indigo-300 focus:ring-opacity-40">
                                                </div>

                                                <div class="mt-4">
                                                    <label for="email" class="block text-sm text-gray-700 capitalize dark:text-gray-200">Todo</label>
                                                    <input placeholder="Todo" type="email" class="block w-full px-3 py-2 mt-2 text-gray-600 placeholder-gray-400 bg-white border border-gray-200 rounded-md focus:border-indigo-400 focus:outline-none focus:ring focus:ring-indigo-300 focus:ring-opacity-40">
                                                </div>
