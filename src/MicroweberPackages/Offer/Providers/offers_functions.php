...
if (!function_exists('offers_get_price')) {
    ...
    {
        return app()->offers_repository->getPrice($product_id, $price_id);
...
if (!function_exists('offers_get_by_product_id')) {
    ...
    {
        return app()->offers_repository->getByProductId($product_id);
...
if (!function_exists('offer_get_by_id')) {
    ...
    {
        return app()->offers_repository->getById($offer_id);
    }
}
