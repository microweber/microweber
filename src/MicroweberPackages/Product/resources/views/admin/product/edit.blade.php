...
@section('topbar2-links-right')
    ...
    <a href="<?php echo route('admin.product.create'); ?>"
       class="btn btn-outline-dark border-1 rounded-circle p-2 mx-1" style="height: 40px; width: 45px;" data-bs-toggle="tooltip" data-bs-placement="bottom" title="New Product">
    ...
    @if (user_can_access('module.content.edit'))
        <a href="{{$past_page}}?editmode=y"
           class="btn btn-outline-dark border-1 rounded-circle p-2 mx-1" style="height: 40px; width: 45px;" data-bs-toggle="tooltip" data-bs-placement="bottom" title="Live Edit">
    ...
    <button id="js-admin-save-content-main-btn" type="submit" class="js-bottom-save btn btn-outline-dark mx-1" form="quickform-edit-content"><span>
