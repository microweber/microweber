...
@section('topbar2-links-right')
   ...
   <div id="content-title-field-buttons" class="mw-page-component-disabled">
       <button id="js-admin-save-content-main-btn" type="submit" class="btn btn-dark mw-admin-bold-outline-dark btn-save js-bottom-save shadow-none ms-atuo me-3" form="quickform-edit-content"><span>
