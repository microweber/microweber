...
class ShopServiceProvider extends ServiceProvider
{
    ...
    public function registerMenu()
    {
        ...
        AdminManager::getMenuInstance('left_menu_top')->getChild('Shop')->addChild('Products', [
            'uri' => route('admin.product.index'),
        ]);
        AdminManager::getMenuInstance('left_menu_top')->getChild('Shop')->addChild('Orders', [
            'uri' => route('admin.order.index'),
        ]);
        AdminManager::getMenuInstance('left_menu_top')->getChild('Shop')->addChild('Categories', [
            'uri' => route('admin.category.index'),
        ]);
        AdminManager::getMenuInstance('left_menu_top')->getChild('Shop')->addChild('Customers', [
