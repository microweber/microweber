...
<div class="card-body mb-3 card-in-live-edit">
    ...
    <div class=" ">
        ...
        <nav class="nav nav-pills nav-justified btn-group btn-group-toggle btn-hover-style-3">
            <a class="btn btn-outline-primary justify-content-center  active" data-bs-toggle="tab" href="#products"><i class="mdi mdi-cog-outline mr-1"></i> <?php _e('Products'); ?></a>
                ...
                <div class="module-live-edit-settings module-blog-settings">
                    ...
                    <div class="form-row row">
                        ...
                        <div class="form-group col-12">
                            <label class="form-label d-block"><?php echo _e("Display products from", true); ?></label>
