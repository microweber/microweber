...
use MicroweberPackages\LaravelTemplates\Generators\TemplateGenerator;
...
class TemplateMakeCommand extends Command
{
    ...
    public function handle(): int
    {
        ...
        foreach ($names as $name) {
            $code = with(new TemplateGenerator($name))
                ->setFilesystem($this->laravel['files'])
                ->setModule($this->laravel['templates'])
                ->setConfig($this->laravel['config'])
                ->setTemplatesActivator($this->laravel[TemplateActivatorInterface::class])
                ->setConsole($this)
    ...
    {
        return [
            ['name', InputArgument::IS_ARRAY, 'The names of templates will be created.'],
        ];
    }
