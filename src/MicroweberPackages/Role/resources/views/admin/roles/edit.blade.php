                                        ...
                                        <tr class="js-check-for-checked">
                                            ...
                                            <td class="text-center">
                                                ...
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox" name="permission[]" value="module.{{strtolower($permission['name'])}}.view" @if(in_array('module.'.strtolower($permission['name']).'.view', $selectedPermissions))checked="checked"@endif class="custom-control-input" id="customCheck1_{{$permissionHash}}">
                                                    <label class="custom-control-label" for="customCheck1_{{$permissionHash}}"></label>
                                                </div>
                                            </td>
                                            <td class="text-center">
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox" name="permission[]" value="module.{{strtolower($permission['name'])}}.create" @if(in_array('module.'.strtolower($permission['name']).'.create', $selectedPermissions))checked="checked"@endif class="custom-control-input" id="customCheck2_{{$permissionHash}}">
                                                    <label class="custom-control-label" for="customCheck2_{{$permissionHash}}"></label>
                                                </div>
                                            </td>
                                            <td class="text-center">
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox" name="permission[]" value="module.{{strtolower($permission['name'])}}.edit" @if(in_array('module.'.strtolower($permission['name']).'.edit', $selectedPermissions))checked="checked"@endif class="custom-control-input" id="customCheck3_{{$permissionHash}}">
                                                    <label class="custom-control-label" for="customCheck3_{{$permissionHash}}"></label>
                                                </div>
                                            </td>
                                            <td class="text-center">
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox" name="permission[]" value="module.{{strtolower($permission['name'])}}.delete" @if(in_array('module.'.strtolower($permission['name']).'.delete', $selectedPermissions))checked="checked"@endif class="custom-control-input" id="customCheck4_{{$permissionHash}}">
