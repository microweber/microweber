...
@if(isset($setting['title']))
    ...
    <div>
        @if(isset($setting['fieldType']))            @if ($setting['fieldType'] == 'button')
            ...
            @if ($setting['fieldType'] == 'backButton')
                <div class="mb-3">
                    <button 
                        x-on:click="showStyleSettings = '{{ $setting['backUrl'] ?? '/' }}'"
                        ...
                        <div class="ms-1 font-weight-bold">{{ $setting['title'] ?? 'Back' }}</div>
                    </button>
                </div>
            @endif
