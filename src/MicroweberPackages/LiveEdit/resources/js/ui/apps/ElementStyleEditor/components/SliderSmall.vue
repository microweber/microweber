      ...
      <div class="mw-multiple-fields">
        <div class="mw-field mw-field-flat" data-size="medium">
          ...
          <span @click="resetValue"
              class="reset-field tip" data-tipposition="top-right" data-tip="Restore default value"><i
              class="mdi mdi-history"></i></span></div>
      </div>
...
export default {
  ...
  watch: {
    selectedValue(newValue) {
      // Emit the 'update:modelValue' event to update the parent's v-model
      this.$emit("update:modelValue", newValue);
    },
    modelValue(newValue) {
      // Update the selected value when the parent's v-model changes
