<template>
  <div class="form-control-live-edit-label-wrapper d-flex align-items-center">
    <label  v-if="showLabel" class="live-edit-label px-0 col-4">{{ label }} {{ selectedValue }}{{ unit }}</label>
    <div class="ms-4" data-size="medium" :class="{ 'col-12': !showLabel , 'col-6': showLabel }">
