<template>
 <div class="form-control-live-edit-label-wrapper my-4 background-image-nav d-flex justify-content-between gap-2">
    <label class="live-edit-label px-0 col-auto text-start">{{ label }}</label>
        <div>
            <span
                class="mw-ui-btn mw-ui-btn-outline rounded-0 tip background-select-item" style="height: 30px; width: 30px; border: 1px solid #000;"
