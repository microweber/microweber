<template>
    <button v-on:click="openContentAddModal()" class=" btn btn-icon me-2 px-3 live-edit-toolbar-buttons live-edit-toolbar-buttons-undo-redo tblr-body-color" style="background-color: #e1edf8 !important;">
