...
<template>
    <div id="toolbar" class="shadow-sm">
        ...
        <div class="toolbar-nav toolbar-nav-hover">
            <a href="./" class="mw-live-edit-toolbar-link mw-live-edit-toolbar-link--arrowed">
                Admin
                <svg xmlns="http://www.w3.org/2000/svg" class="mw-live-edit-toolbar-arrow-icon" height="24" viewBox="0 -960 960 960"
                     width="24">
                    <g fill="none" stroke="#2175FF" stroke-width="1.5" stroke-linejoin="round" stroke-miterlimit="10">

                        <circle class="arrow-icon--circle" cx="16" cy="16" r="15.12"></circle>

                        <path class="arrow-icon--arrow" d="M480-160 160-480l320-320 42 42-248 248h526v60H274l248 248-42 42Z"></path>
                    </g>
