<template>
    <div class="p-3">
        ...
        <div class="d-grid gap-2">
            <a class="text-decoration-none cursor-pointer fs-5 my-2" v-on:click="show('html-editor')">
            ...
            <a class="text-decoration-none cursor-pointer fs-5 my-2" v-on:click="show('style-editor')">
            ...
            <a class="text-decoration-none cursor-pointer fs-5 my-2" v-on:click="openContentRevisionsDialog()">
            ...
            <a class="text-decoration-none cursor-pointer fs-5 my-2" v-on:click="openContentResetContent()">
            ...
            <a class="text-decoration-none cursor-pointer fs-5 my-2" v-on:click="clearCache()">
