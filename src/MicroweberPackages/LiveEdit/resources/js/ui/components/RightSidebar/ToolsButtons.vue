<template>
    <div className="p-3">
        <label className="font-weight-bold fs-2 mt-2 mb-2">Tools</label>
        <div className="d-grid gap-2">
            <a className="live-edit-tools" v-on:click="show('html-editor')">

                <svg className="me-1" fill="currentColor" xmlns="http://www.w3.org/2000/svg" height="24"
            ...
            <a className="live-edit-tools" v-on:click="show('style-editor')">
                <svg className="me-1" fill="currentColor" xmlns="http://www.w3.org/2000/svg" height="25"
            ...
            <a className="live-edit-tools" v-on:click="openContentRevisionsDialog()">
                <svg className="me-1" fill="currentColor" xmlns="http://www.w3.org/2000/svg" height="24"
                     viewBox="0 -960 960 960" width="24">
                    <path
            ...
            <a className="live-edit-tools" v-on:click="openContentResetContent()">
                <svg className="me-1" fill="currentColor" xmlns="http://www.w3.org/2000/svg" height="24"
                     viewBox="0 -960 960 960" width="24">
                    <path
            ...
            <a className="live-edit-tools" v-on:click="clearCache()">
                <svg className="me-1" fill="currentColor" xmlns="http://www.w3.org/2000/svg" height="24"
                     viewBox="0 -960 960 960" width="24">
                    <path
