<template>
    ...
    >
        ...
        >
            <div class="modules-list modules-list-defaultModules px-3">

                <div class="py-3 text-end" v-if="showModal">
                ...
                <div class="modules-list-search-block input-icon px-3">
                ...
                <div class="modules-list-block">
                    ...
                    <div v-if="modulesCategoriesList.length > 0" v-for="category in modulesCategoriesList" class="modules-list-block-category-section">
                        <div class="w-100 pt-3 text-capitalize">
                            <h4 class="mb-2">{{category}}</h4>
                        </div>
                        <div v-for="item in modulesListFiltered[category]"
                             class="col-md-6 px-0 mb-1 mw-modules-list-block-item d-flex align-items-center p-2 modules-list-block-item-is-locked-false cursor-pointer"
