...
class LiveEditMenusApi extends Controller
{
    ...
    public function getTopRightMenu()
    {
        ...
        $menus[] = [
            ...
            'icon_html'=>' <svg xmlns="http://www.w3.org/2000/svg" x="0" y="0" viewBox="0 0 40 40" xml:space="preserve"
...
//            'href'=> admin_url(),
//            'icon_html'=>'<svg viewBox="0 0 40 32.29">
//                                                        <path
...
//        ];
        ...
        $menus[] = [
            'title' => 'Logout',
            'href'=> logout_url(),
            'icon_html'=>'<svg viewBox="0 0 36 36.1">
                                                        <path
