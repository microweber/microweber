<div class="col-md-5 col-12 ps-0 d-flex align-items-center mb-md-0 mb-4">
    ...
    <div class="btn-group">
        <a href="#" wire:click="setDisplayType('card')" class="btn btn-outline-dark btn-sm mw-content-vision-tabs @if($displayType=='card') active @endif">
            ...
            {{ _e('Card') }} </a>
        <a href="#" wire:click="setDisplayType('table')" class="btn btn-outline-dark btn-sm mw-content-vision-tabs @if($displayType=='table') active @endif">
