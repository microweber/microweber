<div class="col-md-5 col-12 ps-0 d-flex align-items-center mb-md-0 mb-4">
    ...
    <div class="btn-group">
        <a href="#" wire:click="setDisplayType('card')" class="btn btn-outline-dark btn-sm border-0 @if($displayType=='card') active @endif">
            ...
            {{ _e('List') }} </a>
        <a href="#" wire:click="setDisplayType('table')" class="btn btn-outline-dark btn-sm border-0 @if($displayType=='table') active @endif">
