<div class="ms-4 input-icon col-xl-3 col-sm-5 col-12  mb-3 mb-md-0 ps-0">
    <div class="input-group input-group-flat ">
        ...
        <span class="input-group-text">
            <a href="#" class="link-secondary ms-2" data-bs-toggle="tooltip" aria-label="Search filter" data-bs-original-title="Search settings"><!-- Download SVG icon from http://tabler-icons.io/i/adjustments -->
