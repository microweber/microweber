        ...
        <div class="form-group">
            <div data-toggle="filter-buttons">
                @foreach($filter->options as $option)
                    ...
                    @endphp
                    <label class="btn px-0 btn-sm border rounded-circle @if ($option->active) active @endif" for="{{$randIdForCheck}}" style="width: 30px; height: 30px; background:{{$option->value}};">
