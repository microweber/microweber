...
$entry = $item = get_form_entires('id=' . $id . '&single=1');

$form_values = $form_values_1 = $form_values_2 = [];
...
<div class="card mb-2 not-collapsed-border collapsed card-message-holder <?php if (!isset($is_entry)): ?>card-bubble<?php endif; ?> <?php if (isset($item['is_read']) AND $item['is_read'] == 0): ?>active<?php endif; ?> bg-silver"
     data-toggle="collapse" data-target="#notif-entry-item-<?php print $item_id ?>" aria-expanded="false"
    ...
    <div class="card-body">
        ...
        <div class="row align-items-center">
            ...
            <div class="col-10 col-sm item-id"><span class="text-primary">#<?php echo $entry_params['id']; ?></span>
            </div>
