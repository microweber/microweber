        ...
        if ($mod_n == 'layout') {
            ...
            if (isset($data['template'])) {
                ...
                if (is_file($possible_layout)) {
                    $l = new \Weber\View($possible_layout);
                    $layout = $l->__toString();
...
//                }
            ...
            if ($is_editmode == true and $this->isolate_by_html_id == false and !isset($_REQUEST['isolate_content_field'])) {
                ...
                if ($is_admin == true) {
                    ...
                    $custom_live_edit = normalize_path($custom_live_edit, false);
                    if (is_file($custom_live_edit)) {
                        $layout_live_edit = new \Weber\View($custom_live_edit);
...
//d($page['render_file']);
        ...
        if (!$standalone_edit) {
            if (isset($page['render_file'])) {
                ...
                $l = new \Weber\View($page['render_file']);
                $l->page_id = PAGE_ID;
                $l->content_id = CONTENT_ID;
                $l->post_id = POST_ID;
                $l->category_id = CATEGORY_ID;
...
//                }
        ...
        //$v = new \Weber\View(MW_ADMIN_VIEWS_DIR . '404.php');
        //echo $v;
    }
    ...
    {
        $this->app->content_manager->define_constants($page);
        $l = new \Weber\View(mw_includes_path() . 'api' . DS . 'api.js');
