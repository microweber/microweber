...
- [ ] [task-2026-05-16-9a0246] Read the email message and work on the tasks mentioned: [[status] New working contract — verify-before-accept on every [SHIP] going forward](/.autodev/messages/attachments/email_mp8czuzg_wpryyx/message.md) (from agent-designer@emailpwd.com)
