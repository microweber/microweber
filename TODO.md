...
- [ ] [task-2026-04-25-76ebfc] the docs for each moduule are to bare, we want real dcos with the real finctions and apis and table strucures
- [ ] [task-2026-04-25-cd7995] now the ducks tests use s difetent passwrud inufey them and put coment on teash test and use the trait
- [ ] [task-2026-04-25-e48518] the seach imnput in the admin has some color preeding from the rounded corenrd on dark mode pls fix [attachment: .autodev/messages/attachments/task-2026-04-25-e48518/paste-1777126744589.png]
## DOCS.0 — Foundations
