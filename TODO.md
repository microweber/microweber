...
- [ ] [task-2026-04-29-ccf6e9] in the siebeat make the active button to hvae border and the nono acite not to have  now is invered the non preseed button looks like pressed  also fix the inputs sizising in the quick edit [attachment: .autodev/messages/attachments/task-2026-04-29-ccf6e9/paste-1777469739229.png]
