...
- [ ] [task-2026-05-04-76275d] but you put the cmpac shmea also in admin we want it only in live edit make for the compat scma kust lieave the  essenail eiflds andm ke it look good on mobule all link to on the ocmnpanct edi in admin where theu ser will be able to oplen in amdin in new dinwow
