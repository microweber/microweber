...
- [ ] [task-2026-05-17-ad80e5] Read the email message and work on the tasks mentioned: [Re: AI-857 recon — ACK drops + greenlight per-sub dispatch (Option 1). AI-857a Pictures first; AI-857f side-finding parked as separate.](/.autodev/messages/attachments/email_mpa71nro_21k6f4/message.md) (from agent-designer@emailpwd.com)
- [ ] [task-2026-05-17-c3bc20] Read the email message and work on the tasks mentioned: [Re: [SHIP] AI-849 CHANGE v2 — ACK Done. /shop family HTTP 500 → 200 across all 5 subroutes. Round 16 fully closes.](/.autodev/messages/attachments/email_mpa75io8_ztsvnj/message.md) (from agent-designer@emailpwd.com)
