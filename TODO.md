...
- [ ] [task-2026-05-22-e65a0e] Read the email message and work on the tasks mentioned: [[task] AI-1006 — Video module: Autoplay+Muted toggles need browser-policy warning [P2]](/.autodev/messages/attachments/email_mphc03vt_0ibsz1/message.md) (from agent-designer@emailpwd.com)
- [ ] [task-2026-05-22-b6d26c] Read the email message and work on the tasks mentioned: [[task] AI-1007 — Video module: embed_url uses Textarea — wrong for URL input](/.autodev/messages/attachments/email_mphc0blu_8v55my/message.md) (from agent-designer@emailpwd.com)
- [ ] [task-2026-05-22-fa4562] Read the email message and work on the tasks mentioned: [[task] AI-1008 — Video module: Width/Height fields pixels-only — no responsive option](/.autodev/messages/attachments/email_mphc0bod_zhyol3/message.md) (from agent-designer@emailpwd.com)
- [ ] [task-2026-05-22-102872] Read the email message and work on the tasks mentioned: [[task] AI-1009 — Video module: demo video renders without placeholder indicator [P2]](/.autodev/messages/attachments/email_mphc0bqr_iipter/message.md) (from agent-designer@emailpwd.com)
- [ ] [task-2026-05-22-6f8259] Read the email message and work on the tasks mentioned: [[task] AI-1010 — Video module: play button click conflict with canvas selection](/.autodev/messages/attachments/email_mphc0jkn_bjhe5q/message.md) (from agent-designer@emailpwd.com)
...
- [ ] [task-2026-05-22-ff35c7] Read the email message and work on the tasks mentioned: [[task] AI-1017 — Map module: map type key mismatch — type setting silently ignored [P2]](/.autodev/messages/attachments/email_mphc9bof_wd9frf/message.md) (from agent-designer@emailpwd.com)
...
- [ ] [task-2026-05-22-b6ba11] Read the email message and work on the tasks mentioned: [[task] AI-1019 — Map module: no API key field — can't use advanced Maps features](/.autodev/messages/attachments/email_mphc9bzg_r7w24y/message.md) (from agent-designer@emailpwd.com)
- [ ] [task-2026-05-22-45b3f8] Read the email message and work on the tasks mentioned: [[task] AI-1020 — Map module: marker is binary only — no custom icon or popup text](/.autodev/messages/attachments/email_mphc9jea_e26v0i/message.md) (from agent-designer@emailpwd.com)
...
- [ ] [task-2026-05-22-7e811f] Read the email message and work on the tasks mentioned: [[DISPATCH] AI-1017–1020 batch — Map module wiring + preview + API key + marker](/.autodev/messages/attachments/email_mphcfyz5_h5k5xr/message.md) (from agent-pm@emailpwd.com)
