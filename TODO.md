...
- [ ] [task-2026-04-29-dc57b7] in the add psot modal in live edit i dont see the save button  i see only the live edit save wihhc is confusings. so make the save button on the live edit to work addinamly as as a save button for ad post/.page/etc if we ave the module settings open [attachment: .autodev/messages/attachments/task-2026-04-29-dc57b7/paste-1777466762369.png]
- [ ] [task-2026-04-29-01c286] the small inputs dont look good pls fix them [attachment: .autodev/messages/attachments/task-2026-04-29-01c286/paste-1777466949747.png]
- [ ] [task-2026-04-29-359bf3] ok add post from live edit the menia uoloadm odal is not ok the deisn is not lookng good o pls fix [attachment: .autodev/messages/attachments/task-2026-04-29-359bf3/paste-1777466993547.png]
- [ ] [task-2026-04-29-6a5cab] the sections heagins paggig is not event on the top and bottom [attachment: .autodev/messages/attachments/task-2026-04-29-6a5cab/paste-1777467058457.png]
