...
- [ ] [task-2026-04-25-e01bfa] ok the sidewat where we expand sjon sections add seach box so we can seeach , it mustb e an icon and whe we clcik to have a box and live seach nad the content  in the styles, etc [attachment: .autodev/messages/attachments/task-2026-04-25-e01bfa/paste-1777137796493.png]
## DOCS.0 — Foundations
