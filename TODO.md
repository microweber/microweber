...
- [ ] [task-2026-05-22-3f5366] Read the email message and work on the tasks mentioned: [[task] AI-1000 — Admin: Scheduled posts show no countdown to publication](/.autodev/messages/attachments/email_mphbl3xl_9qfl6p/message.md) (from agent-designer@emailpwd.com)
- [ ] [task-2026-05-22-9ac78d] Read the email message and work on the tasks mentioned: [[task] AI-1001 — Admin: Category tree has no expand-all/collapse-all controls](/.autodev/messages/attachments/email_mphbm6b1_ey4ecj/message.md) (from agent-designer@emailpwd.com)
- [ ] [task-2026-05-22-82b8c1] Read the email message and work on the tasks mentioned: [[task] AI-1002 — Live-edit: MainDrawer pages list has no search](/.autodev/messages/attachments/email_mphbm6dg_hohtui/message.md) (from agent-designer@emailpwd.com)
- [ ] [task-2026-05-22-4a2ac6] Read the email message and work on the tasks mentioned: [[task] AI-1003 — Admin: File upload shows no progress indicator](/.autodev/messages/attachments/email_mphbme0w_wchfjr/message.md) (from agent-designer@emailpwd.com)
- [ ] [task-2026-05-22-86d0ac] Read the email message and work on the tasks mentioned: [[task] AI-1004 — Frontend: Product detail page lacks breadcrumb + schema](/.autodev/messages/attachments/email_mphbme3a_ywkin3/message.md) (from agent-designer@emailpwd.com)
- [ ] [task-2026-05-22-d6837f] Read the email message and work on the tasks mentioned: [[task] AI-1005 — Admin: Notification bell has no unread badge count](/.autodev/messages/attachments/email_mphbme69_hf28vh/message.md) (from agent-designer@emailpwd.com)
...
- [ ] [task-2026-05-22-957119] Read the email message and work on the tasks mentioned: [[task] AI-1018 — Map module: no live preview in settings panel](/.autodev/messages/attachments/email_mphc9brj_4xl53f/message.md) (from agent-designer@emailpwd.com)
...
- [ ] [task-2026-05-22-a50280] Read the email message and work on the tasks mentioned: [[task] AI-1021 — Embed module: no code validation before save](/.autodev/messages/attachments/email_mphce1fy_a1e96v/message.md) (from agent-designer@emailpwd.com)
- [ ] [task-2026-05-22-2d2712] Read the email message and work on the tasks mentioned: [[task] AI-1022 — Embed module: no line numbers in code textarea](/.autodev/messages/attachments/email_mphce95b_n71h4a/message.md) (from agent-designer@emailpwd.com)
- [ ] [task-2026-05-22-0ab065] Read the email message and work on the tasks mentioned: [[task] AI-1023 — Embed module: code type selector separated from editor — UX friction](/.autodev/messages/attachments/email_mphce97s_l1aeud/message.md) (from agent-designer@emailpwd.com)
- [ ] [task-2026-05-22-7ee302] Read the email message and work on the tasks mentioned: [[task] AI-1024 — Embed module: floating toolbar has no 'Edit code' shortcut](/.autodev/messages/attachments/email_mphce9ad_rs9y4g/message.md) (from agent-designer@emailpwd.com)
...
- [ ] [task-2026-05-22-9263db] Read the email message and work on the tasks mentioned: [[DISPATCH] AI-1021–1024 batch — Embed module validation + line numbers + toolbar](/.autodev/messages/attachments/email_mphcgec4_03c5mj/message.md) (from agent-pm@emailpwd.com)
- [ ] [task-2026-05-22-6efdd4] Read the email message and work on the tasks mentioned: [[task] AI-1025 — Admin posts/products: filter '0' badge should hide when inactive](/.autodev/messages/attachments/email_mphck1qi_13t4ae/message.md) (from agent-designer@emailpwd.com)
- [ ] [task-2026-05-22-dffa06] Read the email message and work on the tasks mentioned: [[task] AI-1026 — Admin posts/products: 'Per page: 250' default is too high](/.autodev/messages/attachments/email_mphck97r_xcq8q0/message.md) (from agent-designer@emailpwd.com)
- [ ] [task-2026-05-22-dd1103] Read the email message and work on the tasks mentioned: [[task] AI-1027 — Admin Create Post: 'Live edit' and 'Save' both blue — hierarchy ambiguous](/.autodev/messages/attachments/email_mphck9a8_iumpgi/message.md) (from agent-designer@emailpwd.com)
- [ ] [task-2026-05-22-7af247] Read the email message and work on the tasks mentioned: [[task] AI-1028 — Admin Create Post: 'Live edit' button on unsaved form is confusing](/.autodev/messages/attachments/email_mphck9cq_rpt529/message.md) (from agent-designer@emailpwd.com)
- [ ] [task-2026-05-22-043ae6] Read the email message and work on the tasks mentioned: [[task] AI-1029 — Admin Create Post: Permalink accordion collapsed by default — SEO field hidden](/.autodev/messages/attachments/email_mphck9f8_5iqo6l/message.md) (from agent-designer@emailpwd.com)
- [ ] [task-2026-05-22-343ad1] Read the email message and work on the tasks mentioned: [[task] AI-1030 — Admin Products empty state: bright illustration clashes with dark admin](/.autodev/messages/attachments/email_mphck9hu_lbm0qc/message.md) (from agent-designer@emailpwd.com)
- [ ] [task-2026-05-22-25eb08] Read the email message and work on the tasks mentioned: [[DISPATCH] AI-1025 — Admin filter badge hide when 0](/.autodev/messages/attachments/email_mphcl4bc_7nw9zo/message.md) (from agent-pm@emailpwd.com)
- [ ] [task-2026-05-22-9d1fb9] Read the email message and work on the tasks mentioned: [[task] AI-1031 — Admin users: ROLES column empty — role labels not rendering](/.autodev/messages/attachments/email_mphcobu0_429sk2/message.md) (from agent-designer@emailpwd.com)
- [ ] [task-2026-05-22-3161d6] Read the email message and work on the tasks mentioned: [[task] AI-1032 — Admin users: PHONE column always empty — wastes column space](/.autodev/messages/attachments/email_mphcojm9_8iympn/message.md) (from agent-designer@emailpwd.com)
- [ ] [task-2026-05-22-a86335] Read the email message and work on the tasks mentioned: [[task] AI-1033 — Admin users: ID column shows database primary key — remove from UI](/.autodev/messages/attachments/email_mphcojoo_mmjoy3/message.md) (from agent-designer@emailpwd.com)
- [ ] [task-2026-05-22-7819a2] Read the email message and work on the tasks mentioned: [[task] AI-1034 — Admin comments: APPROVED and SPAM both show identical red × icon](/.autodev/messages/attachments/email_mphcojr6_l8q489/message.md) (from agent-designer@emailpwd.com)
- [ ] [task-2026-05-22-130bd8] Read the email message and work on the tasks mentioned: [[task] AI-1035 — Admin /admin/media: 404 — no media library admin route [P2]](/.autodev/messages/attachments/email_mphcojvy_0ls9on/message.md) (from agent-designer@emailpwd.com)
- [ ] [task-2026-05-22-5b8775] Read the email message and work on the tasks mentioned: [[DISPATCH] AI-1031–1035 — Admin users/comments/media batch](/.autodev/messages/attachments/email_mphcq1lf_qfgesv/message.md) (from agent-pm@emailpwd.com)
