<div>
    ...
    <div class="d-flex flex-wrap justify-content-between align-items-center">
        ...
        <div class="col-md-4 col-12 text-xl-end mt-4">
            <button onclick="Livewire.dispatch('openModal', 'contact-form.settings-modal')" class="btn btn-link tblr-body-color font-weight-bold text-decoration-none me-3 fs-3 mw-admin-action-links" href="{{admin_url('settings?group=general')}}">
            ...
            <button onclick="Livewire.dispatch('openModal', 'contact-form.integrations-modal')" class="btn btn-link tblr-body-color font-weight-bold text-decoration-none fs-3 mw-admin-action-links" href="{{admin_url('settings?group=general')}}">
