...
<!--    <div class="mt-4 mb-3">
    ...
    <div class="mt-4 mb-3">
        ...
        @php
            $radioModernOptions = [
                '1' => `<svg viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
...
'2' => `<svg   viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
...
'3' => `<svg viewBox="0 0 22 22" fill="none" xmlns="http://www.w3.org/2000/svg">
