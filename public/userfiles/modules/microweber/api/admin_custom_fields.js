...
mw.admin.custom_fields.addValueButtons = function (root) {
    ...
    for (; i < l; i++) {
        ...
        all[i].onclick = function () {
            ...
            span.innerHTML = '<small class="mw-admin-custom-field-value-edit-inline p-1 text-dark" data-id="' + mw.$(this).attr('data-id') + '"></small><small onclick="mw.admin.custom_fields.deleteFieldValue(this);" class="delete-custom-fields bg-danger text-white p-1"><i class="mdi mdi-close"></i></small>   ';
