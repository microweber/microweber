...
<div id="mw_map_editor<?php print $rand_id ?>">
  <h3><a href="#"><img  src="<?php   print( ADMIN_STATIC_FILES_URL);  ?>img/icons/72-pin.png"  height="24" class="css_editor_accordeon_icon" /><?php _e('Map settings'); ?></a></h3>
  <div>
    <div class="mw_tag_editor_item_holder">
      <table border="0" cellspacing="5" cellpadding="0" >
        <tr valign="middle">
          <td><div class="mw_tag_editor_label_wide"><?php _e('Map address'); ?></div>
        ...
        <tr valign="middle">
          <td><label><?php _e('Map zoom'); ?></label>
         ...
         <tr valign="middle">
          <td><label><?php _e('Map height'); ?></label>
          ...
          <tr valign="middle">
          <td><label><?php _e('Map width'); ?></label>
