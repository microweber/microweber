                    ...
                    <div class="<?php print $config['module_class'] ?> user-id-<?php print $data['id']; ?>" id="users_edit_<?php echo $usersEditRand; ?>">
                        ...
                        <div class="d-block">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group input-group-password mb-3 append-transparent <?php if ($data['id'] != 0): ?>semi_hidden js-reset-password<?php endif; ?>">
                                    ...
                                    <div class="input-group-append">
                                        <span class="input-group-text js-show-password  " data-bs-toggle="tooltip" data-title="<?php _e("Show/Hide Password"); ?>"><i class="mdi mdi-eye-outline text-muted mdi-20px"></i></span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div>
                                ...
                                <?php print \Livewire\Livewire::mount('user::profile.two-factor-authentication-form', []);  ?>

                            </div>
                            <div>
                                <?php print \Livewire\Livewire::mount('user::profile.logout-other-browser-sessions-form', []);  ?>
