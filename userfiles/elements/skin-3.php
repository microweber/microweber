<div class="mw-static-element mw-head-image" id="head-image-<?php print CONTENT_ID; ?>">
    <div class="mw-image-holder" style="background-image: url('<?php print elements_url() ?>images/default-3.jpg');">
        <img src="<?php print elements_url() ?>images/default-3.jpg" alt=""/>
