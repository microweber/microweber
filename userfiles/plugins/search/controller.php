	...
	switch ($search_what) {
		...
		*/
			...
			if ($categories == false) {
				...
				$params ['selected_categories'] = false; //izbrahme za vas

			} else {

				$params ['selected_categories'] = array ($categories ); //izbrahme za vas
			...
			$params ['search_by_keyword'] = $search_for; //izbrahme za vas
			...
			$this->template ['search_data'] = $items;

			$this->template ['items'] = $items;

			$this->template ['posts'] = $items ["posts"];

			$this->template ['search_data_pages_links'] = $items ["posts_pages_links"];

			$this->template ['search_data_pages_count'] = $items ["posts_pages_count"];

			$this->template ['posts_pages_curent_page'] = $items ["posts_pages_curent_page"];
...
*/
		...
		$posts_data2 ['keyword'] = $search_for;

		$posts_data2 ['debug'] = true;
