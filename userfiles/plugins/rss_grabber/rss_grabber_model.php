...
p($channel); 
			...
			if (trim ( $feed ['content_subtype'] ) != '') {
				$to_save ['content_subtype'] = $feed ['content_subtype'];
			}
			
			if (trim ( $feed ['content_subtype_value'] ) != '') {
				$to_save ['content_subtype_value'] = $feed ['content_subtype_value'];
			}
