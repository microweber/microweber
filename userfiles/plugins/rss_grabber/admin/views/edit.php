...
d.openAll();
  ...
  <tr>
   ...
   <tr>
    ...
    <td><input name="content_subtype" id="content_subtype" type="text" value="<?php print $form_values['content_subtype'] ?>"  style="width:100px;" />
  </td>
    <td>&nbsp;</td>
  </tr>
  ...
  <tr>
    ...
    <td><input name="content_subtype_value" id="content_subtype_value" type="text" value="<?php print $form_values['content_subtype_value'] ?>"  style="width:100px;" />
  </td>
    <td>&nbsp;</td>
  </tr>
