...
<div id="RU-content">
  <form class="" action="<?php print site_url($this->uri->uri_string()); ?>"   method="post" enctype="multipart/form-data"   id="postform">
    <div class="pad2"></div>
    ...
    <div class="panes" id="form-manager">
      <div id="form-manager-holder" style="left: 0px;">
        ...
        <div class="tab" id="edit-template">
          ...
          <?php p($form_errors); ?>
          <?php endif; ?>
          <input name="content_layout_name" type="hidden" id="content_layout_name" value="<?php print $form_values['content_layout_name'] ?>" />
          <input name="content_layout_style" type="hidden" id="content_layout_style" value="<?php print $form_values['content_layout_style'] ?>" />
          
          <input name="content_subtype" type="hidden" id="content_subtype" value="form" />
          
          
          <textarea name="content_body" id="content_body" class="required richtext"  cols="" rows=""><?php print $form_values['content_body']; ?></textarea>
        ...
        <div class="tab" id="publish">
            <div class="box-holder">
                ...
                ?>
                    ...
                    <span class="field">
                        <input style="width: 550px;" class="required type-text" name="content_title" type="text" value="<?php print $form_values['content_title']; ?>" />
                    </span>
                    ...
                    <span class="field">
                        <textarea style="width: 550px;height: 50px;" class="required"  name="content_description" cols="" rows=""><?php print $form_values['content_description']; ?></textarea>
                    </span>
