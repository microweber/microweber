...
<div class="mw-reset mw-newsletter mw-newsletter-default">
  <div class="well">
      <div class="edit" field="newsletter_form_title"  rel="newsletter_module" data-option_group="<?php print $params['id'] ?>" data-module="<?php print $params['type'] ?>">
        <h3>Subscribe for our Newsletter</h3>
      </div>
      <div class="edit" field="form_sub_title"  rel="newsletter_module" data-option_group="<?php print $params['id'] ?>" data-module="<?php print $params['type'] ?>">
