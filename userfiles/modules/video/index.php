...
function video_module_url2embed($u){
    if(stristr($u,'youtube.com') !== false){
      ...
      return '<div class="element mw-embed-iframe" style="height:315px;width:560px;"><iframe frameborder="0" width="315px" height="560" src="http://www.dailymotion.com/embed/video/'.$id[0].'"></iframe></div>';
    }
