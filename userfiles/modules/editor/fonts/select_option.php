...
<select   class="mw_option_field " option-group="<?php print $group ?>" data-width="100%" data-size="5" data-live-search="true" name="<?php print $name ?>">
...
<a href="javascript:;" onClick="mw.top().tools.open_global_module_settings_modal('editor/fonts/admin','<?php print $params['id'] ?>');" style="background-color: #f5f5f5; text-align: center; padding-top: 2px; padding-bottom: 5px;"><small style="text-transform: lowercase; color: black;"><?php _e('More fonts'); ?></small></a>
<?php } ?>
