...
function mw_reload_all_modules(){
	...
	mw.$('#modules_admin_<?php print $params['id']; ?>').attr('cleanup_db',1);
  	 ...
  	 mw.load_module('admin/modules_manager/manage','#modules_admin_<?php print $params['id']; ?>');
...
_modulesSort = function(){
   ...
   // hash.category === undefined ? mw.url.windowHashParam('category', '0') : '' ;
    ...
    mw.load_module('admin/modules_manager/manage','#modules_admin_<?php print $params['id']; ?>', function(){
...
function mw_show_marketplace(){
	 ...
	 $("#modules_market_<?php print $params['id']; ?>").show();
	  ...
	  $(".modules-index-bar").hide();
  	 ...
  	 mw.load_module('admin/modules_manager/market','#modules_market_<?php print $params['id']; ?>');
