...
<div id="mw-admin-content">
    <div class="mw_edit_page_default" id="mw_edit_page_left">
        <p class="advanced-settings-p-helper "><?php _e("This module will remove categories, images and custom fields which are connected to content that is manually deleted from the database"); ?>.</p>
