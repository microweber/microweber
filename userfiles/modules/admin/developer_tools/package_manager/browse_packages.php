...
<div class="card mb-3 <?php if ($from_live_edit): ?>card-in-live-edit<?php endif; ?>">
    <div class="card-header justify-content-between">
        ...
        <div class="d-flex">
            <?php if ($is_update_mode) { ?>
                <a href="<?php print admin_url() ?>marketplace" class="btn btn-outline-primary btn-sm d-block my-xl-0 my-1 mx-lg-1"> <i class="mdi mdi-arrow-left"></i><?php _e("Back to list"); ?></a>
            <?php } else { ?>
                    ...
                    <nav class="nav nav-pills nav-justified btn-group btn-group-toggle btn-hover-style-3">
                        <?php if ($packages_by_type_all && $is_update_mode == false) : ?>
                            ...
                            <?php foreach ($packages_by_type as $pkkey => $pkitems): ?>
                                ...
                                ?>
                                <a class="btn btn-outline-dark justify-content-center  <?php if ($count == 1): ?>active<?php endif; ?>" data-bs-toggle="tab" id="js-packages-tab-<?php echo $pkkeys; ?>" href="#<?php echo $pkkeys; ?>"><i class="mdi mr-1 <?php if ($pkkeys == 'template'): ?>mdi-pencil-ruler<?php elseif ($pkkeys == 'module'): ?>mdi-view-grid-plus<?php elseif ($pkkeys == 'update'): ?>mdi-flash-outline<?php endif; ?>"></i> <?php print titlelize($pkkeys) ?></a>
                            <?php endforeach; ?>
                        <?php endif; ?>
                        ...
                        <?php if ($packages_by_type_with_update OR $is_update_mode): ?>
                            ...
                            foreach ($packages_by_type_with_update as $pkkey => $pkitems):
                                ...
                                $count = count($pkitems);
                                $total += $count;
                                $items .= '<a class="btn btn-outline-dark justify-content-center " data-bs-toggle="tab" href="#' . $pkkeys . '">' . titlelize($pkkeys) . '&nbsp; <sup class="badge badge-success badge-sm badge-pill">' . $count . '</sup></a>';
                            endforeach;
                            ?>
                            <?php print $items; ?>
                        <?php endif; ?>
