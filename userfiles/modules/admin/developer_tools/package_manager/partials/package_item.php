        ...
        <div class="card style-1 bg-light">
            <div class="card-body pb-3">
                <?php if ($item['type'] != 'microweber-core-update'): ?>
                    <?php if ($screenshot): ?>
                        <a target="_blank" href="<?php print $item['homepage']; ?>" class="package-image package-<?php print $item['type'] ?>" style="background-image: url('<?php print thumbnail($screenshot, 400); ?>')"></a>
                    <?php else: ?>
                        <?php if (!isset($no_img)): ?>
                ...
                <div class="package-item-footer">
                    ...
                    <a <?php print (isset($item['homepage']) ? 'href="' . $item['homepage'] . '"' : ''); ?> class="btn btn-md btn-link text-dark p-0"><?php print $item['description'] ?></a> <span class="btn btn-link btn-sm p-0 text-muted tip" data-tip="#<?php print $tooltipid ?>" data-trigger="click"><i class="mdi mdi-information-outline"></i></span>
                            ...
                            <div>
                                <div class="d-inline-block">
                                    <select class="mw-sel-item-key-install selectpicker" data-style="btn-sm" data-width="80px" data-size="5" data-vkey="<?php print $key; ?>">
                                        <option value="<?php print $item['latest_version']['version'] ?>">v<?php print $item['latest_version']['version'] ?></option>
