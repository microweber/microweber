...
<div class="mw-ui-field-holder"><a class="mw-ui-btn"
    ...
    <a class="mw-ui-btn"
       href="javascript:mw.load_module('admin/developer_tools/media_cleanup','#mw-advanced-settings-dev-tools-output')"><?php _e('Media cleanup'); ?></a>
    <a class="mw-ui-btn"
       href="javascript:mw.load_module('admin/developer_tools/database_cleanup','#mw-advanced-settings-dev-tools-output')"><?php _e('Database cleanup'); ?></a>
    <a class="mw-ui-btn"
       href="javascript:mw.load_module('admin/notifications/system_log','#mw-advanced-settings-dev-tools-output')">
