        ...
        if (mods_in_mod) {
            $(mods_in_mod).each(function () {
                ...
                if (inner_mod_type) {
                    ...
                    mod_in_mods_html_btn += '<a class="mw-ui-btn mw-ui-btn-info" href=\'javascript:window.parent.mw.tools.open_global_module_settings_modal("' + inner_mod_type_admin + '","' + inner_mod_id + '")\'>' + inner_mod_title + '</a>';
                }
            });
        }
...
<?php if (is_array($templates)): ?>
    ...
    <div class="mw-accordion mw-accordion-full-height">
