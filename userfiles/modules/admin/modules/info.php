...
<div class="position-relative">
    <div class="main-toolbar mw-modules-toolbar-back-button-holder" id="mw-modules-toolbar" style="display: none">
        <?php if (is_admin()): ?>
            <a <?php if (isset($params['history_back'])) { ?>href="javascript:;" onClick="history.go(-1)"<?php } else { ?> href="<?php print admin_url(); ?>view:modules"<?php } ?> class="btn btn-link text-silver px-0"><i class="mdi mdi-chevron-left"></i> <?php _e("Back"); ?></a>
