...
<div class="mw_box right" style="width: 48%">
  ...
  <div class="mw_box_content">
    <table width="100%">
      <tr>
        <td>Names:</td>
        <td class="orange"><? print $order['names']; ?> <? print $order['first_name']; ?> <? print $order['last_name']; ?></td>
      </tr>
      <tr>
        <td>Email:</td>
  ...
  <h4>Other info</h4>
           ...
           <span title="Date and time on the server"><strong >Date:</strong> <? print $order['updated_on']; ?></span><br />
            <strong>Session id:</strong> <small><? print $order['sid']; ?></small><br />
