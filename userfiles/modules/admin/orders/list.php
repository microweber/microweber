<?
 // $CI = get_instance ();
get_instance()->load->model( 'Cart_model', 'cart_model' );
 
$data = array ();
$ord = get_instance()->cart_model->ordersGet ( $params, $limit = false );
							//p($ord);
    ...
    <table width="100%" border="0" cellspacing="0" cellpadding="0" id="orders_table">
      ...
      <tbody>
        ...
        <tr id="order_id_<?  print $item['id']; ?>">
          ...
          <td><? print $item['names'] ; ?> <? print $item['first_name']; ?> <? print $item['last_name']; ?></td>
