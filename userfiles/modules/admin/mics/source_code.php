...
<fieldset class="inputs">
    ...
    "java",  "m", "mxml", "perl", "pl", "pm", "py",  "sh", "xml", "xsl"); ?>
          ...
          <?php $l_sel =  mw('option')->get('source_code_language', $params['module_id']); ?>  
          ...
          <textarea name="source_code" cols=""  class="mw_option_field mw_tag_editor_textarea textarea" style="height:400px;" refresh_modules="mics/source_code"   option_group="<?php print $params['module_id'] ?>" rows="2"><?php print mw('option')->get('source_code', $params['module_id']) ?></textarea>
