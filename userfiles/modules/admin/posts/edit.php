...
function save_post() {
  ...
  save_post_options.data = $('#save_post_form').serialize();
  
  
  $.ajax(save_post_options);
 ...
 content_parent = $("#content_parent").val();
	...
	data1 = {}
						   ...
						   data1.page_id = content_parent;
						     data1.post_id = '<? print intval($form_values['id'] ) ?>';
...
reload_categories_form_page()
  ...
  <br />
      <input type="button" value="Save post" onclick="save_post()" class="sbm right post_saved" name="save">
      <br />
      <br />
  <h2> Options  </h2>  <br />
    ...
    <div id="tabs">
      ...
      <div id="fragment-4">
        ...
        <? // p($form_values); ?>
          ...
          <microweber module="admin/content/custom_fields" page_id="<? print $form_values['content_parent'] ?>" post_id="<? print intval($form_values['id']) ?>" />
        </div>
