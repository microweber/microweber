...
<a href="<? print ADMIN_URL ?>/action:post_edit/id:<? print $the_post['id'] ?>" class="img">
    <img src="<? print thumbnail($the_post['id'], 150) ?>" />
</a>


<h2><? print $the_post['content_title'] ?> </h2>

<? print $the_post['content_descpriotion'] ?>
<a class="btn2" href="<? print  post_link($the_post['id']);  ?>" target="_blank">Read</a>
<a class="btn2" href="<? print ADMIN_URL ?>/action:post_edit/id:<? print $the_post['id'] ?>">Edit</a>
