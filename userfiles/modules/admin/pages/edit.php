...
function save_page() {
  ...
  save_page_options.data = $('#save_page_form').serialize();
  
  
  $.ajax(save_page_options);
...
<div class="box radius">
  <div class="box_header radius_t">
    <input type="button" value="Save page" onclick="save_page()" class="sbm right post_saved" name="save">
