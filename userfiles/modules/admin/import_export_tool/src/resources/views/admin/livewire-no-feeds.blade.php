...
<div class="no-items-box" style="background-image: url('<?php print modules_url(); ?>microweber/api/libs/mw-ui/assets/img/no_notifications.svg'); ">
    ...
    <br>
    <button type="button" wire:loading.attr="disabled" wire:click="$emit('openModal', 'import_export_tool::new_import_modal')" class="btn btn-primary btn-rounded">Create new import feed</button>
</div>
