        ...
        <form class="wizard-container" method="POST" action="#" id="js-wizard-form" novalidate="novalidate">
            ...
            <ul class="import-wizard justify-content-center">
                <li class="import-wizard__item active">
                    <a class="import-wizard__link" href="#tab1">
            ...
            <div class="mt-5 mb-5">
                <div class="d-flex justify-content-center">
                    <a href="{{route('admin.import-export-tool.import-wizard')}}?import_to=pages" class="import-wizard-select-type">
                    ...
                    <a href="{{route('admin.import-export-tool.import-wizard')}}?import_to=posts" class="import-wizard-select-type">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" style="width:50px;">
                    ...
                    <a href="{{route('admin.import-export-tool.import-wizard')}}?import_to=products" class="import-wizard-select-type">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" style="width:50px;">
                    ...
                    <a href="{{route('admin.import-export-tool.import-wizard')}}?import_to=categories" class="import-wizard-select-type">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" style="width:50px;">
