...
class ItemMapReader
{
    ...
    private static $map = [
        ...
        'media_urls' => ['image', 'g:image_link','media_urls','media_urls_url'],
        'price' => ['price', 'g:price'],
        'title' => ['title'],
        'url' => ['url'],
        'id' => ['id'],
        ...
        'categories' => ['categories_tree', 'category_0', 'category_1','category_2', 'category_3', 'category_4', 'genre', 'category', 'g:google_product_category'],
