        ...
        <div class="d-flex justify-content-between align-items-center py-1">
            <ul class="nav">
                ...
                <li class="mx-1 logo d-none d-md-block">
                    <h5 class="text-white mr-3 d-flex align-items-center h-100"><img src="assets/img/logo.svg" alt="Microweber"></h5>
                </li>
                <li class="mx-1 d-none d-md-block">
                    <button type="button" class="btn btn-outline-secondary btn-rounded btn-sm-only-icon" data-toggle="dropdown">
                        <span class="d-none d-md-block">Add new</span> <i class="mdi mdi-plus"></i>
                    </button>
            ...
            <ul class="nav nav-last">
                <li class="mx-1">
                    <a href="#" class="btn btn-primary btn-rounded btn-sm-only-icon">
...
<div class="main container my-3" id="mw-admin-main-block">
    <aside>
