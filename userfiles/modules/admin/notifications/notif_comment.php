...
<div class="card mb-2 not-collapsed-border collapsed card-bubble <?php if ($item['is_read'] == 0): ?>active<?php endif; ?> bg-silver" data-toggle="collapse" data-target="#notif-item-<?php print $item['id'] ?>" aria-expanded="false" aria-controls="collapseExample">
    <div class="card-body">
        ...
        <div class="collapse" id="notif-item-<?php print $item['id'] ?>">
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <h6><strong>Boris Sokolov</strong>
