...
<div class="card mb-2 not-collapsed-border collapsed card-bubble bg-silver" data-toggle="collapse" data-target="#notif-item-<?php print $item['id'] ?>" aria-expanded="false" aria-controls="collapseExample">
    <div class="card-body">
