                                ...
                                <td style="border-top: 0;">
                                    <div class="mw-flex-row">
                                                ...
                                                <div>
                                                    ...
                                                    <div class="mw-dropdown mw-dropdown-default m-l-10">
                                                        ...
                                                        <div class="mw-dropdown-content" style="display: none;">
                                                            <ul>
                                                                <li style="padding: 0px;"><a style="border:0px;" href="?">All notification</a></li>
                                        ...
                                        <div class="mw-flex-col-xs-5">
                                            <div class="box" style="align-items: center; align-content: center; height: 100%; display: flex;">
                                                <div>
                                                    <a href="javascript:mw.notif_read_selected();" class="mw-ui-btn mw-ui-btn-outline mw-ui-btn-small mw-ui-btn-notification notif-read-selected" style="margin: 0 5px;">
                                                        <?php _e("Mark as Read"); ?>
                                                    </a>

                                                    <a href="javascript:mw.notif_reset_selected();" class="mw-ui-btn mw-ui-btn-outline mw-ui-btn-small mw-ui-btn-warn notif-unread-selected" style="margin: 0 5px;">
                                                        <?php _e("Mark as Unread"); ?>
                                                    </a>

                                                    <a href="javascript:mw.notif_delete_selected();" class="mw-ui-btn mw-ui-btn-outline mw-ui-btn-small mw-ui-btn-important notif-delete-selected" style="margin: 0 5px;">
