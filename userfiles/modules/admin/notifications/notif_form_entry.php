...
<div class="js-form-entry-<?php print $item_id ?> card shadow-sm mb-4 not-collapsed-border collapsed card-message-holder <?php if (!isset($is_entry)): ?>card-bubble<?php endif; ?> <?php if (isset($item['is_read']) AND $item['is_read'] == 0): ?>active<?php endif; ?> bg-silver" data-bs-toggle="collapse" data-bs-target="#notif-entry-item-<?php print $item_id ?>" aria-expanded="false" aria-controls="collapseExample">
    <div class="card-body">
        ...
        <div class="row align-items-center" data-bs-toggle="collapse" data-bs-target="#notif-entry-item-<?php print $item_id ?>" >
            ...
            <div class="col-2 text-end">
                <a href="#" class="btn" data-bs-toggle="modal" data-bs-target="#notif-entry-item-<?php print $item_id ?>">
                    <?php _e("View") ?>
                </a>
            </div>
        </div>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <button type="button" class="btn btn-link pull-right" onclick="deleteFormEntry(event,<?php echo $item_id; ?>)"><i class="mdi mdi-delete-outline"></i> <?php _e('Delete'); ?></button>
                            </div>
                        </div>
                    </div>
