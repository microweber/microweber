...
<div class="module-live-edit-settings module-tweet-embed-settings">
    <div class="mw-ui-field-holder">
        ...
        <input type="text" option-group="<?php print $option_group; ?>" class="mw_option_field mw-ui-field mw-ui-field-medium mw-full-width" name="twitter_url" value="<?php print $twitter_url; ?>" placeholder="Enter your Tweet URL"/>
    </div>
</div>