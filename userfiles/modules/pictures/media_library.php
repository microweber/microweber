    ...
    <div class="media-search-stock-images-wrapper">
        ...
        <div class="text-center text-center mt-3 mx-auto" style="max-width: 450px;">
            ...
            <div class="form-group stock-field mt-4">
                <input type="text" class="form-control" placeholder="<?php _e("Example: cars, business or landscape..."); ?>" onkeyup="mw.on.stopWriting(this,function(){searchMediaLibrary(this.value, 1)})">
            </div>
        </div>
