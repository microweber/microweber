...
<style>
    .scw-cookie-panel-toggle::before {
        content: '<?php print _lang('Turn cookies on / off', 'modules/cookie_notice'); ?>';
    }
...
<div class="scw-cookie<?php print ($this->decisionMade ? ' scw-cookie-out' : ''); ?>" style="<?php print $scw_cookie_style; ?>">
    ...
    <div class="scw-cookie-content">
        <div class="scw-cookie-message">
            ...
            <?php print _lang('We use cookies to personalise content ' . $liveChatMessage.' and to analyse our web traffic.', 'modules/cookie_notice'); ?>
        </div>
        <div class="scw-cookie-decision">
            <div class="scw-cookie-btn" onclick="scwCookieHide('<?php print $this->mod_id; ?>')">
                <?php print _lang('OK', 'modules/cookie_notice'); ?>
            </div>
            <div class="scw-cookie-settings scw-cookie-tooltip-trigger"
                 onclick="scwCookieDetails()"
                 data-label="<?php print _lang('Cookie settings', 'modules/cookie_notice'); ?>"
            >
                <span class="icon icon-settings"></span>
            </div>
            <div class="scw-cookie-policy scw-cookie-tooltip-trigger" data-label="<?php print _lang('Cookie policy', 'modules/cookie_notice'); ?>">
        ...
        <div class="scw-cookie-details">
            <div class="scw-cookie-details-title"><?php print _lang('Manage your cookies', 'modules/cookie_notice'); ?></div>
            <div class="scw-cookie-toggle">
                <div class="scw-cookie-name"><?php print _lang('Essential site cookies', 'modules/cookie_notice'); ?></div>
