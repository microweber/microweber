...
<div id="mw-language-settings">
    <div class="mw-ui-btn-nav mw-ui-btn-nav-tabs m-1 w-100">
        <nav id="nav-language-settings" class="nav nav-pills nav-justified btn-group btn-group-toggle btn-hover-style-3">
            ...
            <a class="btn btn-outline-primary justify-content-center " data-bs-toggle="tab" href="#mw-multilang-settings">  <?php print _e('Settings'); ?></a>
            <a class="btn btn-outline-primary justify-content-center " data-bs-toggle="tab" href="#mw-multilang-templates">  <?php print _e('Templates'); ?></a>
        </nav>
