...
<div class="mw_simple_tabs mw_tabs_layout_simple">
  <ul class="mw_simple_tabs_nav">
    <li><a class="active" href="javascript:;"><?php _e("New Comments"); ?></a></li>
    <li><a href="javascript:;"><?php _e("Skin/Template"); ?></a></li>
    <li><a href="javascript:;" class=""><?php _e("Settings"); ?></a></li>
  </ul>
...
$get_comments_params['is_new'] = 'y';
    ...
    <?php if($new > 0){ ?>
    <?php if($new == 1){ ?>
    <h2 class="relative inline-block left"><?php _e("You have one new comment"); ?> &nbsp;<span class="comments_number"><?php print $new; ?></span></h2>
    <?php } else { ?>
    <h2 class="relative inline-block left"><?php _e("You have"); ?> <?php print $new; ?> new comments &nbsp;<span class="comments_number"><?php print $new; ?></span></h2>
    <?php  } ?>
    <a href="<?php print admin_url('view:comments'); ?>/#content_id=<?php print  $get_comments_params['rel_id']; ?>" target="_top" class="mw-ui-btn mw-ui-btn-green right"><?php _e("See new"); ?></a>
    <?php }  else { ?>
    <?php
	 unset($get_comments_params['is_moderated']);
		$old = get_comments($get_comments_params); ?>
    <h2 class="relative inline-block left"><?php _e("You don't have new comments"); ?> </h2>
    <a href="<?php print admin_url('view:comments'); ?>/#content_id=<?php print  $get_comments_params['rel_id']; ?>" target="_top" class="mw-ui-btn right" style="top:6px;"><?php _e("See all"); ?> <strong><?php print $old; ?></strong></a>
    <?php } ?>
  ...
  <div class="tab semi_hidden">
    ...
    <div class="mw-ui-field-holder checkbox-plus-select">
      ...
      <div class="mw-ui-select" style="width: 290px;">
        <select name="display_comments_from_which_post" id="post_select" class="mw_option_field">
          <option value="current_post" <?php if($display_comments_from_which_post == 'current_post'): ?> selected="selected" <?php endif ?>><?php _e("Current Post"); ?></option>
    ...
    <div class="mw-ui-field-holder">
      <label class="mw-ui-check">
        ...
        <span></span> <span><?php _e("Recent comments"); ?></span> </label>
    </div>
    <div class="mw-ui-field-holder" style="padding-bottom: 20px;">
      <label class="mw-ui-check left">
        ...
        <span></span> <span><?php _e("Custom comments"); ?></span></label>
    ...
    <div class="mw-ui-field-holder" id="custom_comm_toggle" style="display:none; margin-top:5px;">
      <label class="mw-ui-label-inline"><?php _e("From module"); ?>: </label>
      <?php
