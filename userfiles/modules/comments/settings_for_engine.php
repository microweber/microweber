...
<select name="engine"  option-group="comments" class="mw-ui-field mw_option_field"  data-also-reload="#<?php print $params['id']?>">
  <option value="default"  <?php if(!$engine or $engine=='default'): ?>  selected="selected"  <?php endif; ?> >Default</option>
...
<div class="mw-ui-field-holder">
  <label class="mw-ui-field">
    ...
    <select name="facebook_color_scheme"  option-group="comments" class="mw-ui-field mw_option_field">
      <option value="default"  <?php if(!$facebook_color_scheme or $facebook_color_scheme=='default'): ?>  selected="selected"  <?php endif; ?> >Default</option>
      <option value="light"  <?php if($facebook_color_scheme=='light"  '): ?>  selected="selected"  <?php endif; ?> >Light</option>
      <option value="dark"  <?php if($facebook_color_scheme=='dark"'): ?>  selected="selected"  <?php endif; ?> >Dark</option>
    </select>
  </label>
</div>
<?php endif; ?>
