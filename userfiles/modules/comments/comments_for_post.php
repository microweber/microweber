...
<div class="comment-post">
  <div class="comment-info-holder" onclick="mw.adminComments.toggleMaster(this, event)"> <span class="img"> <img src="<?php print thumbnail(get_picture($content_id),67,67); ?>" alt="" />
    ...
    <div class="comment-post-content-side">
      ...
      <a class="comment-post-url" href="<? print $item['url'] ?>"> <? print $item['url'] ?></a> <br>
  ...
  <div class="comments-show-btns">
    <span class="mw-ui-btn comments-show-all" onclick="mw.adminComments.display(event,this, 'all');"><?php print ($count_old+$count_new); ?> All</span>
    <span class="mw-ui-btn mw-ui-btn-green comments-show-new" onclick="mw.adminComments.display(event,this, 'new');"><?php print $count_new; ?> New</span>
  </div>
</div>
