...
mw.require("<?php print $config['url_to_module']; ?>templates/amelia/amelia.css");


</script>
<div class="amelia">
<div class="contact-form-container contact-form-template-amelia">
