...
<nav class="nav nav-pills nav-justified btn-group btn-group-toggle btn-hover-style-3">
    <a class="btn btn-outline-dark justify-content-center  active" data-bs-toggle="tab" href="#settings" id="form_options"><i class="mdi mdi-email-outline mr-1"></i> <?php _e('Settings'); ?></a>
    <a class="btn btn-outline-dark justify-content-center " data-bs-toggle="tab" href="#settings-advanced">  <?php _e('Advanced Settings'); ?></a>
    <a class="btn btn-outline-dark justify-content-center " data-bs-toggle="tab" href="#custom-fields"><i class="mdi mdi-pencil-box-outline mr-1"></i> <?php _e('Custom Fields'); ?></a>
