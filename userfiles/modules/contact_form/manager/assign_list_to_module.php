...
<?php if (is_array($data)): ?>
        ...
        <div class="mw-ui-row-nodrop valign">
            ...
            <div class="mw-ui-col">
                ...
                <button class="mw-ui-btn pull-right"
                        onclick="mw.$('.mw_create_new_list, #form_dropdown_lists').toggle()"><?php _e("Create New"); ?></button>
            </div>
        </div>
    ...
    <div class="mw_create_new_list" style="display: none;">
        ...
        &nbsp;<span class="mw-ui-delete"
                    onclick="mw.$('.mw_create_new_list, #form_dropdown_lists').toggle()"><?php _e("Cancel"); ?></span>
    </div>
