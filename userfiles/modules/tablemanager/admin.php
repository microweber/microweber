...
<div class="module-live-edit-settings">
    ...
    <span class="mw-ui-btn mw-ui-btn-notification pull-right" onclick="table.ServerSave()"><?php _e('Save'); ?></span>

    <span class="mw-ui-btn" onclick="table.addCol();" id="adcol"><span
                class="mw-icon-plus"></span> <?php _e('Add Column'); ?></span>
    <span class="mw-ui-btn" onclick="table.addRow();" id="adrow"><span
                class="mw-icon-plus"></span> <?php _e('Add Row'); ?></span>

    <hr>

    <div id="holder">
        <table id="table" class="mw-ui-table">
            <thead>
            <tr id="thead"></tr>
            </thead>
            <tbody id="tbody">
