...
<<?php  print $wrap_element; ?> class="<?php  print $wrap_element_class; ?>">
 ...
 <? $to_user =$user['id']  ?>
  ...
  <a href="javascript:mw.users.FollowingSystem.follow(<?php echo $to_user?>);" class="mw_btn_s_orange right"><span    title="Add as friend <?php print get_instance()->users_model->getPrintableName($to_user, 'first'); ?>">Add as friend</span></a>
  <?php  else : ?>
  <a id="unfollow_<?php echo $to_user?>" href="javascript:mw.users.FollowingSystem.unfollow(<?php echo $to_user?>, '#unfollow_<?php echo $to_user?>');" class="mw_btn_s right"><span    title="Remove friend <?php print get_instance()->users_model->getPrintableName($to_user, 'first'); ?>">Remove friend</span></a>
  <? endif; ?>
