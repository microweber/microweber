    ...
    <div class="card-body pt-3">
        <div class="row d-flex align-items-center justify-content-around">
            <div class="col-md-5 py-5">
                ...
                <a href="#" class="btn btn-success btn-sm"><i class="mdi mdi-book-account"></i> Add new role</a>
                <a href="#" class="btn btn-outline-success btn-sm"><i class="mdi mdi-format-list-checks"></i> Manage roles</a>
            </div>
