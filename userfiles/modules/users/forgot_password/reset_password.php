...
<div id="form-holder<? print $params['id'];  ?>">
...
$data = get_users("single=true&password_reset_hash=".$reset); ?>
  ...
  <form id="user_reset_password_form<? print $params['id'];  ?>" method="post" class="clearfix">
    <div class="reset-pass-form-wrap">
      <h4>Set the new information below</h4>
      ...
      <div class="control-group">
       <!-- <label class="control-label">Enter new password</label>-->
        <div class="controls">
          <input type="password" placeholder="Choose a password" name="pass1" >
        </div>
      </div>
      <div class="control-group">
...
-->        <div class="controls">
      ...
      <button type="submit" class="btn btn-large pull-right btn-success"><? print $form_btn_title ?></button>
    </div>
