...
$(document).ready(function(){
  ...
  mw.$("#lang_selector").bind("change", function(){
   ...
   <div id="sign_logo_version">
    ...
    <a href="http://microweber.com" target="_blank"><img src="<?php print MW_INCLUDES_URL; ?>img/sign_logo.png" alt="" /></a>
  ...
  <div class="mw-box-content" id="admin_login">
    ...
    <a href="<?php print site_url() ?>"><?php _e("Go to"); ?> <?php print site_url() ?></a> <a href="<?php print api_link('logout') ?>" ><?php _e("Log Out"); ?></a>
    <?php else:  ?>
