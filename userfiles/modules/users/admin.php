...
<script type="text/javascript">
    ...
    function mw_admin_delete_user_by_id(id) {
        mw.confirm("<?php _ejs("Are you sure you want to delete this user?"); ?>", function () {
            data = {};
            data.id = id
...
<?php if ($user_params['id'] != 0): ?>
    <h5 class="main-pages-title"><?php _e("Edit User"); ?></h5>
<?php else: ?>
...
<div class="card  mb-3">
    ...
    <div class="card-body" id="users-manage-body">
        <div class="row">
