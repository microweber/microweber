...
<div class="mw-ui-box"><ul id="post_fields_sort_<?php print  $rand ?>" class="fields-controlls">
  ...
  <div class="mw-ui-row-nodrop">
    <div class="mw-ui-col"><label class="mw-ui-check">
      ...
      <span></span> <span><?php _e("Title"); ?></span></label></div>
    <div class="mw-ui-col">
  ...
  <div class="mw-ui-row-nodrop">
    <div class="mw-ui-col"><label class="mw-ui-check">
      ...
      <span></span> <span><?php _e("Description"); ?></span></label></div>
    <div class="mw-ui-col">
      <label class="mw-ui-label-horizontal"><?php _e("Length"); ?></label>
  ...
  <div class="mw-ui-row-nodrop">
    <div class="mw-ui-col"><label class="mw-ui-check">
      ...
      <span></span> <span><?php _e("Add to cart button"); ?></span></label></div>
    <div class="mw-ui-col">
  ...
  <div class="mw-ui-row-nodrop">
    <div class="mw-ui-col"><label class="mw-ui-check">
      ...
      <span></span><span><?php _e("Hide paging"); ?></span></label></div>
    <div class="mw-ui-col">
