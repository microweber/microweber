...
<?php if (isset($params['global']) and $params['global'] != false) : ?>
    ...
    <select name="data-content-type" id="the_post_data-content-type<?php print  $rand ?>" class="mw-ui-field w100 mw_option_field" onchange="mw_reload_content_mod_window(1)">
        <option value="" <?php if (('' == trim($set_content_type))): ?>  selected="selected"  <?php endif; ?>>
            <?php _e("Choose content type"); ?>
        </option>
        <option value="page" <?php if (('page' == trim($set_content_type))): ?>   selected="selected"  <?php endif; ?>>
            <?php _e("Pages"); ?>
        </option>
        <option value="post" <?php if (('post' == trim($set_content_type))): ?>   selected="selected"  <?php endif; ?>>
            <?php _e("Posts"); ?>
        </option>
        <option value="product" <?php if (('product' == trim($set_content_type))): ?>   selected="selected"  <?php endif; ?>>
            <?php _e("Product"); ?>
        </option>
        <option value="none" <?php if (('none' == trim($set_content_type))): ?>   selected="selected"  <?php endif; ?>>
            <?php _e("None"); ?>
        </option>
    </select>
<?php endif; ?>
<?php if (!isset($set_content_type) or $set_content_type != 'none') : ?>
    ...
    <?php if ($posts_parent_page != false and intval($posts_parent_page) > 0): ?>
        ...
        <div class="mw-ui-field-holder">
            ...
            <select name="data-category-id" id="the_post_data-page-id<?php print  $rand ?>" class="mw-ui-field w100 mw_option_field" data-also-reload="<?php print  $config['the_module'] ?>">
    ...
    <label class="mw-ui-label">
        <?php _e("Display on"); ?>
        <?php print ($set_content_type) ?>: </label>
    <div class="mw-ui-box">
        <ul id="post_fields_sort_<?php print  $rand ?>" class="fields-controlls">
          ...
          <?php _e("Title"); ?>
                ...
                <div class="mw-ui-col">
                    ...
                    <input name="data-title-limit" class="mw-ui-field mw_option_field" type="text" placeholder="255" style="width:95px;"
                           value="<?php print get_option('data-title-limit', $params['id']) ?>"/>
                </div>
            </div>
            <div class="mw-ui-row-nodrop">
                <div class="mw-ui-col">
          ...
          <?php _e("Description"); ?>
                ...
                <div class="mw-ui-col">
                    ...
                    <input name="data-character-limit" class="mw-ui-field mw_option_field" type="text" placeholder="80" style="width:95px;"
                           value="<?php print get_option('data-character-limit', $params['id']) ?>"/>
                </div>
            </div>
            <?php if ($is_shop): ?>
                <div class="mw-ui-row-nodrop">
          ...
          <?php _e("Show price"); ?>
                ...
                <div class="mw-ui-row-nodrop">
                    <div class="mw-ui-col">
                        <label class="mw-ui-check">
                            <input type="checkbox" name="data-show" value="add_to_cart"
                                   class="mw_option_field" <?php if (in_array('add_to_cart', $show_fields)): ?>   checked="checked"  <?php endif; ?> />
                            <span></span> <span>
          <?php _e("Add to cart button"); ?>
          </span></label>
                    </div>
                    <div class="mw-ui-col">
                        <label class="mw-ui-label-horizontal">
                        ...
                        <input name="data-add-to-cart-text" class="mw-ui-field mw_option_field" style="width:95px;" placeholder="<?php _e("Add to cart"); ?>" type="text"
                               value="<?php print get_option('data-add-to-cart-text', $params['id']) ?>"/>
                    </div>
                </div>
            <?php endif; ?>
            <div class="mw-ui-row-nodrop">
          ...
          <?php _e("Read More Link"); ?>
                ...
                <div class="mw-ui-col">
                    ...
                    <input name="data-read-more-text" class="mw-ui-field mw_option_field" type="text" placeholder="<?php _e("Read more"); ?>" style="width:95px;"
                           value="<?php print get_option('data-read-more-text', $params['id']) ?>"/>
                </div>
            </div>
            <div class="mw-ui-row-nodrop">
                <div class="mw-ui-col">
          ...
          <?php _e("Date"); ?>
            ...
            <div class="mw-ui-row-nodrop">
                <div class="mw-ui-col">
                    <label class="mw-ui-check">
                        <input type="checkbox" name="data-hide-paging" value="y"
                               class="mw_option_field" <?php if (get_option('data-hide-paging', $params['id']) == 'y'): ?>   checked="checked"  <?php endif; ?> />
                        <span></span><span>
          <?php _e("Hide paging"); ?>
          </span></label>
                </div>
                <div class="mw-ui-col">
                    ...
                    <input name="data-limit" class="mw-ui-field mw_option_field right" type="number" style="width:95px;" placeholder="10"
                           value="<?php print get_option('data-limit', $params['id']) ?>"/>
                </div>
            </div>
            <div class="mw-ui-row-nodrop">
                <label class="mw-ui-label-horizontal">
        ...
        <?php _e("Order by"); ?>
                ...
                <div class="mw-ui-col">
                    <select name="data-order-by" class="mw-ui-field w100 mw_option_field" data-also-reload="<?php print  $config['the_module'] ?>">
                        <option value="" <?php if ((0 == intval($ord_by))): ?>   selected="selected"  <?php endif; ?>>
                            <?php _e("Position"); ?>
                            (ASC)
                        </option>
                        <option value="position asc" <?php if (('position asc' == trim($ord_by))): ?>   selected="selected"  <?php endif; ?>>
                            <?php _e("Position"); ?>
                            (DESC)
                        </option>
                        <option value="created_at desc" <?php if (('created_at desc' == trim($ord_by))): ?>   selected="selected"  <?php endif; ?>>
                            <?php _e("Date"); ?>
                            (ASC)
                        </option>
                        <option value="created_at asc" <?php if (('created_at asc' == trim($ord_by))): ?>   selected="selected"  <?php endif; ?>>
                            <?php _e("Date"); ?>
                            (DESC)
                        </option>
                        <option value="title asc" <?php if (('title asc' == trim($ord_by))): ?>   selected="selected"  <?php endif; ?>>
                            <?php _e("Title"); ?>
                            (ASC)
                        </option>
                        <option value="title desc" <?php if (('title desc' == trim($ord_by))): ?>   selected="selected"  <?php endif; ?>>
                            <?php _e("Title"); ?>
                            (DESC)
                        </option>
                    </select>
