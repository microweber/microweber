...
<div class="module-live-edit-settings">
    ...
    <nav class="nav nav-pills nav-justified btn-group btn-group-toggle btn-hover-style-3">
        <a class="btn btn-outline-dark justify-content-center  active" data-bs-toggle="tab" href="#list">  <?php _e('Menus'); ?></a>
        <a class="btn btn-outline-dark justify-content-center " data-bs-toggle="tab" href="#templates">   <?php _e('Templates'); ?></a>
        <a class="btn btn-outline-dark justify-content-center  d-none" data-bs-toggle="tab" href="#add_new_menu" id="add_new_menu_tab">   1</a>
        <a class="btn btn-outline-dark justify-content-center  d-none" data-bs-toggle="tab" href="#add_new_page" id="add_new_content_tab">   2</a>
    </nav>
