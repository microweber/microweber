        ...
        <div class="module-live-edit-settings module-social-links-settings">
            <div class="row">
                <div class="col-12 socials-settings">
                    ...
                    <div class="form-check">
                        <div class="d-flex align-items-center">
                            <input type="checkbox" class="mw_option_field form-check-input me-2" name="skype_enabled" id="skype_enabled" option-group="<?php print $option_group; ?>" value="y" <?php if ($skype_enabled) print 'checked="checked"'; ?>>
                            <label class="form-check-label mr-2 d-flex" for="skype_enabled"><i class="mdi mdi-skype mdi-20px lh-1_0 me-1"></i> skype.com/</label>
