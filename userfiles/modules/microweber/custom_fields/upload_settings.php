...
<div class="custom-field-settings-name">
    ...
    <label class="control-label"><?php _e("Format"); ?></label>
    <small class="text-muted d-block mb-2"><?php _e('Allowable formats for upload');?></small>

    <div class="mw-custom-fields-upload-filetypes">
       <div class="column">
           <label class="mw-ui-check d-block">
