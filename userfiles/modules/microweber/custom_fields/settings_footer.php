...
<div class="mw-custom-field-group">
    ...
    <div class="mw-custom-field-form-controls">
        <input type="text"  name="custom_field_error_text" class="mw-ui-field mw-full-width"   value="<?php print ($data['custom_field_error_text']) ?>"  id="custom_field_error_text<?php print $rand; ?>">
    </div>
</div>
