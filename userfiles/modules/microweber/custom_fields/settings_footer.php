...
<div class="mw-custom-field-group<?php print $hidden_class ?>">
    ...
    <div class="mw-custom-field-form-controls mw-full-width">
        <label class="mw-ui-check">
              <input type="checkbox" class="mw-ui-field mw-full-width"  name="required" id="custom_field_required<?php print $rand; ?>" value="1" <?php if ($settings['required']): ?> checked="checked"  <?php endif; ?> >
              <span></span>
        </label>
...
<div class="mw-custom-field-group<?php print $hidden_class ?>">
    ...
    <div class="mw-custom-field-form-controls">
        <label class="radio">
            <input type="radio" class="mw-ui-field mw-full-width" name="is_active"   <?php if (trim($data['custom_field_is_active']) == '1'): ?> checked="checked"  <?php endif; ?>  value="1">
            <?php _e('Yes'); ?> </label>
        <label class="radio">
            <input type="radio" class="mw-ui-field mw-full-width" name="is_active" <?php if (trim($data['custom_field_is_active']) == '0'): ?> checked="checked"  <?php endif; ?>   value="0">
            <?php _e('No'); ?> </label>
    </div>
</div>
<div class="mw-custom-field-group<?php print $hidden_class ?>">
    ...
    <div class="mw-custom-field-form-controls">
        <input type="text"  name="help_text" class="mw-ui-field mw-full-width"   value="<?php print ($data['custom_field_help_text']) ?>"  id="custom_field_help_text<?php print $rand; ?>">
    </div>
</div>
