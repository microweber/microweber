...
<body
    class="is_admin loading view-<?php print mw()->url_manager->param('view'); ?> action-<?php print mw()->url_manager->param('action'); ?>">
<?php
                    ...
                    <ul id="main-menu">
                        ...
                        <li
                            ...
                            <?php elseif ($view == 'content' and $action != false): ?>
                                class="active-parent"
                            <?php endif; ?>
                            ><a href="<?php print admin_url(); ?>view:content" title=""> <span
                                    class="mw-icon-website"></span> <strong><?php _e("Website"); ?></strong> </a>
                            <ul>
                                <li  <?php if ($action == 'pages'): ?> class="active" <?php endif; ?>><a
                                        href="<?php print admin_url(); ?>view:content/action:pages"><?php _e("Pages"); ?></a>
                                </li>
                                <li <?php if ($action == 'posts'): ?> class="active" <?php endif; ?>><a
                                        href="<?php print admin_url(); ?>view:content/action:posts"><?php _e("Posts"); ?></a>
                                </li>

                                <?php if ($shop_disabled == false): ?>
                                    <li <?php if ($action == 'products'): ?> class="active" <?php endif; ?>><a
                                            href="<?php print admin_url(); ?>view:content/action:products"><?php _e("Products"); ?></a>
                                    </li>
                                <?php endif; ?>
                                ...
                                <li <?php if ($action == 'categories'): ?> class="active" <?php endif; ?>><a
                                        href="<?php print admin_url(); ?>view:content/action:categories"><?php _e("Categories"); ?></a>
                                </li>
                            </ul>
                        </li>
                        <?php if ($shop_disabled == false): ?>
                            ...
                            <span class="mw-icon-shop">
                             <?php
                             $notif_html = '';
                             $notif_count = mw()->notifications_manager->get('module=shop&rel=cart_orders&is_read=0&count=1');
                             if ($notif_count > 0) {
                             ...
                             <?php } ?>
                                ...
                                <ul>
                                    <li <?php if ($action == 'orders'): ?> class="active" <?php endif; ?>><a
                                            href="<?php print admin_url(); ?>view:shop/action:orders"><span
                                                class="relative"><?php _e("Orders"); ?><?php if ($view == 'shop') {
                                                    print $notif_html;
                                                } ?></span></a></li>
                                    <li <?php if ($action == 'clients'): ?> class="active" <?php endif; ?>><a
                                            href="<?php print admin_url(); ?>view:shop/action:clients"><?php _e("Clients"); ?></a>
                                    </li>
                                    <li <?php if ($action == 'shipping'): ?> class="active" <?php endif; ?>><a
                                            href="<?php print admin_url(); ?>view:shop/action:shipping"><?php _e("Shipping"); ?></a>
                                    </li>
                                    <li <?php if ($action == 'options'): ?> class="active" <?php endif; ?>><a
                                            href="<?php print admin_url(); ?>view:shop/action:options"><?php _e("Options"); ?></a>
                                    </li>
                                </ul>
                            </li>
                        <?php endif; ?>
                        <li id="main-menu-bottom">
                            <ul>
                                <li class="user-menu-sub">
                                    <a href="<?php print $past_page ?>?editmode=y" class="go-live-edit-href-set"
                                       target="_blank">
                    ...
                    <div id="user-menu" class="scroll-height-exception">
                        ...
                        if (!empty($user)) {
                            ...
                            if ($img != '') {
                                ...
                                <a href="javascript:;" id="main-bar-user-menu-link"
                                   class="main-bar-user-menu-link-has-image"><span id="main-bar-profile-img"
                                                                                   style="background-image: url('<?php print $img; ?>');"></span><span
                                        class="mw-icon-dropdown"></span></a>

                            <?php } else { ?>

                                <a href="javascript:;" id="main-bar-user-menu-link"
                                   class="main-bar-user-menu-link-no-image"><span class="mw-icon-user"
                                                                                  id="main-bar-profile-icon"></span><span
                                        class="mw-icon-dropdown"></span></a>
                        ...
                        <div id="main-bar-user-tip" style="display: none">
                            <div class="mw-ui-btn-vertical-nav main-bar-user-tip-navigation">
                                ...
                                <a href="<?php print admin_url('view:modules/load_module:users#edit-user=' . $user_id); ?>"
                                   class="mw-ui-btn"><?php _e("My Profile"); ?></a>
                                <a href="<?php print admin_url('view:modules/load_module:users'); ?>"
                                   class="mw-ui-btn"><?php _e("Manage Users"); ?></a>
                                <a href="javascript:;" onmousedown="mw.contactForm();"
                                   class="mw-ui-btn"><?php _e("Support"); ?></a>
                                <a href="<?php print site_url(); ?>?editmode=y"
                                   class="mw-ui-btn go-live-edit-href-set"><?php _e("View Website"); ?></a>

                                <a href="<?php print api_url('logout'); ?>"
                                   class="mw-ui-btn"><?php _e("Log out"); ?></a>
