...
\MicroweberPackages\Assets\Facades\Assets::add(mw_includes_url() . 'css/popup.css');


print \Illuminate\Support\Facades\View::make('admin::partials.header', ['body_class'=>'mw-external-loading'])->render();
