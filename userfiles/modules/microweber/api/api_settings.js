...
mw.settings = {
    ...
    handles: {
        ...
        <div contenteditable='false' id='mw_handle_module' class='mw-defaults mw_master_handle mw-sorthandle mw-sorthandle-col mw-sorthandle-module' draggable='false'>\
            ...
            <a title='Click to edit this module.' class='mw-ui-btn mw-ui-btn-medium mw-ui-btn-invert mw-ui-btn-rounded mw_edit_settings' href='javascript:void(0);'  back-onclick='mw.drag.module_settings();return false;'  onclick='mw.live_edit.showSettings(undefined, {mode:\"sidebar\", liveedit:true});return false;' draggable='false'>\
