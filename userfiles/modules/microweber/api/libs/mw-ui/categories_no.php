...
<main>
    <div class="card-body mb-3">
        ...
        <div class=" ">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="no-items-box" style="background-image: url('assets/img/no_categories.svg'); ">
                        <h4>You dont have any categories</h4>
                        <p>Create your firts category right now. <br />
                            It is easy </p>
                        <br />
                        <a href="#" class="btn btn-primary btn-rounded">Create a Category</a>
                    </div>
                </div>
            </div>
