                        ...
                        <div class="row select-settings">
                            ...
                            <div class="col-12 col-sm-6 col-lg-4">
                                <a href="#" class="d-flex my-3">
                                    ...
                                    <div class="info-holder">
                                        <span class="text-primary font-weight-bold">Coupons</span><br/>
                            ...
                            <div class="col-12 col-sm-6 col-lg-4">
                                <a href="#" class="d-flex my-3">
                                    ...
                                    <div class="info-holder">
                                        <span class="text-primary font-weight-bold">Taxes</span><br/>
                            ...
                            <div class="col-12 col-sm-6 col-lg-4">
                                <a href="#" class="d-flex my-3">
                                    ...
                                    <div class="info-holder">
                                        <span class="text-primary font-weight-bold">Payments</span><br/>
                            ...
                            <div class="col-12 col-sm-6 col-lg-4">
                                <a href="#" class="d-flex my-3">
                                    ...
                                    <div class="info-holder">
                                        <span class="text-primary font-weight-bold">Promotions</span><br/>
                            ...
                            <div class="col-12 col-sm-6 col-lg-4">
                                <a href="#" class="d-flex my-3">
                                    ...
                                    <div class="info-holder">
                                        <span class="text-primary font-weight-bold">Invoices</span><br/>
                            ...
                            <div class="col-12 col-sm-6 col-lg-4">
                                <a href="#" class="d-flex my-3">
                                    ...
                                    <div class="info-holder">
                                        <span class="text-primary font-weight-bold">Shipping</span><br/>
