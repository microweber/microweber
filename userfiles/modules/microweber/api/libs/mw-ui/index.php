                        ...
                        <div class="col-12">
                            <div class="bs-component">
                                ...
                                <nav class="nav nav-pills nav-justified btn-group btn-group-toggle btn-hover-style-3">
                                    <a class="btn btn-outline-dark justify-content-center  active" data-bs-toggle="tab" href="#home"><i class="mdi mdi-card-plus mr-1"></i> White</a>
                                    <a class="btn btn-outline-dark justify-content-center " data-bs-toggle="tab" href="#profile"><i class="mdi mdi-card-plus mr-1"></i> Yellow</a>
                                    <a class="btn btn-outline-dark justify-content-center " data-bs-toggle="tab" href="#other"><i class="mdi mdi-card-plus mr-1"></i> Red</a>
                                    <a class="btn btn-outline-dark justify-content-center " data-bs-toggle="tab" href="#other"><i class="mdi mdi-card-plus mr-1"></i> Blue</a>
                                    <a class="btn btn-outline-dark justify-content-center " data-bs-toggle="tab" href="#other"><i class="mdi mdi-card-plus mr-1"></i> Black</a>
                                </nav>
                                <br/>
                                <br/>
