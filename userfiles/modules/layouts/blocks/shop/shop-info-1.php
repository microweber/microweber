...
<div class="product-info-layout-1">
    ...
    <h1 class="edit" field="title" rel="post"><?php _e("Product inner page"); ?></h1>
    ...
    <div class="edit" field="content_body" rel="post">
        <p class="description"><?php _e("This text is set by default and is suitable for edit in real time. By default the drag and drop core feature will allow you to position it
            anywhere on the site. Get creative &"); ?> <strong><?php _e("Make Web"); ?></strong>.</p>
    </div>
</div>
