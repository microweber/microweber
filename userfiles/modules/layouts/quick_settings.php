    ...
    <select name="padding-top" class="mw-ui-field mw_option_field" data-option-group="<?php print $params['id']; ?>">
        ...
        <?php if(isset($css_classes['padding-top'])): ?>
            <?php foreach($css_classes['padding-top'] as $key => $option): ?>
                <option value="<?php print $key; ?>"<?php if ($padding_top == $key) {echo 'selected';} ?>><?php _e("Padding Top"); ?> <?php print $key; ?></option>
            <?php endforeach; ?>
        <?php endif; ?>
    </select>
</div>
    ...
    <select name="padding-bottom" class="mw-ui-field mw_option_field" data-option-group="<?php print $params['id']; ?>">
        ...
        <?php if(isset($css_classes['padding-bottom'])): ?>
            <?php foreach($css_classes['padding-bottom'] as $key => $option): ?>
                <option value="<?php print $key; ?>"<?php if ($padding_bottom == $key) {echo 'selected';} ?>><?php _e("Padding Bottom"); ?> <?php print $key; ?></option>
            <?php endforeach; ?>
        <?php endif; ?>
    </select>
</div>