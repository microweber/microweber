        ...
        <div class="mw-paging pull-right">
            ...
            <?php if ($count < 6) { ?>
                ...
                foreach ($paging_links as $item): ?>
                    <a class="page-<?php print $i; ?> <?php if ($numactive == $i): ?> active <?php endif; ?>"
                       href="#<?php print $paging_param ?>=<?php print $i ?>"
                       onclick="mw.url.windowHashParam('<?php print $paging_param ?>','<?php print $i ?>');return false;"><?php print $i; ?></a>       <?php $i++; endforeach; ?>
            <?php } else { ?>
                <?php if ($numactive > 2) { ?>
    ...
    <div class="mw-no-posts-foot">
        ...
        if ((isset($post_params['content_type']) and $post_params['content_type'] == 'product') or (isset($params['content_type']) and $params['content_type'] == 'product') or $page_is_shop) : ?>
            <div class="no-items-found">
                ...
                ?>
                <a href="<?php print$url; ?>" class="mw-ui-btn mw-ui-btn-info mw-ui-btn-outline m-t-20 m-b-20"><i
                            class="mai-product"></i> <span><?php _e("Add New Product"); ?></span></a>
        ...
        <?php else: ?>
            <div class="no-items-found posts">
                ...
                <?php if (isset($url)): ?>
                    <a href="<?php print $url; ?>" class="mw-ui-btn mw-ui-btn-info mw-ui-btn-outline m-t-20 m-b-20"><i
                                class="mai-post"></i> <span><?php _e("Add New Post"); ?></span></a>
                <?php endif; ?>
