            ...
            <div class="admin-manage-content-wrap">
                                ...
                                <div class="mw-ui-col">
                                    <?php if (isset($edit_page_info['title'])): ?>
                                        <div class="mw-ui-row-nodrop" id="content-title-field-row">
                                            <div class="mw-ui-col">
                                                <input type="text" class="mw-ui-invisible-field mw-ui-field-big" style="min-width: 230px;" value="<?php print ($title_for_input) ?>"
                ...
                <form method="post" <?php if ($just_saved != false) : ?> style="display:none;" <?php endif; ?>
                    ...
                    <div class="mw-ui-field-holder" id="slug-field-holder">
                        <input type="hidden" id="content-title-field-master" name="title" onkeyup="slugFromTitle();" placeholder="<?php print $title_placeholder; ?>" value="<?php print $title_for_input; ?>"/>
