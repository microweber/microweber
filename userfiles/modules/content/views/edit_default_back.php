    ...
    <div class="window-holder">
        ...
        <div class="top-bar">
            ...
            <div class="right-side">
                <a class="mw-ui-btn mw-ui-btn-normal mw-ui-btn-info"><i class="mw-icon-close"></i> Publish</a>
                <a class="mw-ui-btn mw-ui-btn-normal mw-ui-btn-info mw-ui-btn-outline">Live Edit</a>
            </div>
        </div>
                                ...
                                <div class="mw-ui-col">
                                    <div class="create-root">
                                        ...
                                        <div class="post-type-action-label">
                                            <span class="mai-<?php print strtolower($type); ?> admin-manage-toolbar-title-icon"></span>
