        ...
        <div class="mw-ui-col">
            <div class="mw-ui-col-container">
                <div class="mw-ui-field-holder">
                    <label class="mw-ui-label">
                        <?php _e("Description"); ?>
                        <small class="mw-help mw-help-right-bottom" data-help="Short description for yor content.">(?)
                        </small>
                    </label>
                    <textarea
                ...
                <?php if ($show_page_settings == false): ?>
                    <module type="content/views/content_tags" content-type="<?php print $params['content-type'] ?>"
                            content-id="<?php print $params['content-id'] ?>"/>
                <?php endif; ?>
        ...
        <div class="mw-ui-col">
            <div class="mw-ui-col-container">
                <?php if (isset($data['id']) and $data['id'] > 0): ?>
                    <div class="mw-ui-field-holder pull-right">
                        <div class="mw-ui-btn-nav"><a class="mw-ui-btn"
                                                      href="javascript:mw.copy_current_page('<?php print ($data['id']) ?>');">
                                <?php _e("Duplicate"); ?>
                            </a> <a class="mw-ui-btn"
                                    href="javascript:mw.reset_current_page('<?php print ($data['id']) ?>');">
                ...
                <?php if ($show_page_settings != false): ?>
                    <div class="mw-ui-check-selector">
                        <div class="mw-ui-label">
                            <?php _e("Is Home"); ?>
                            <small class="mw-help" data-help="<?php _e("If yes this page will be your Home"); ?>">(?)
                            </small>
                        </div>
          ...
          <?php _e("Yes"); ?>
                    ...
                    <div class="mw-ui-check-selector">
                        <div class="mw-ui-label">
                            <?php _e("Is Shop"); ?>
                            <small class="mw-help"
                                   data-help="<?php _e("If yes this page will accept products to be added to it"); ?>">
                                (?)
                            </small>
                        </div>
                        <label class="mw-ui-check">
          ...
          <?php _e("Yes"); ?>
                ...
                <div class="mw-ui-field-holder">
                    ...
                    <input name="original_link" class="mw-ui-field" type="text"
                           value="<?php print $data['original_link'] ?>">
                </div>
...
<?php if (is_array($available_content_types) and !empty($available_content_types)): ?>
    <div class="mw-ui-field-holder"><br/>
        ...
        <div class="mw_adm_cont_type_change_holder mw-ui-box mw-ui-box-content" style="display:none;margin-top: 12px;">
            <div class="mw-ui-field-holder"><?php _e("Warning! Advanced action!"); ?>
                <br/><?php _e("Do not change these settings unless you know what you are doing."); ?></div>
            <div class="mw-ui-row">
                <div class="mw-ui-col" style="width: 200px;">
                    <div class="mw-ui-col-container">
                        <label class="mw-ui-label">
                            ...
                            <small class="mw-help"
                                   data-help="<?php _e("Changing the content type to different than"); ?> '<?php print $data['content_type'] ?>' <?php _e("is advanced action. Please read the documentation and consider not to change the content type"); ?>">
                                (?)
                            </small>
                        </label>
                ...
                <div class="mw-ui-col">
                    <div class="mw-ui-col-container">
                        <label class="mw-ui-label">
                            ...
                            <small class="mw-help"
                                   data-help="<?php _e("Changing the content type to different than"); ?> '<?php print $data['subtype'] ?>' <?php _e("is advanced action. Please read the documentation and consider not to change the content type"); ?>">
                                (?)
                            </small>
                        </label>
    ...
    <?php if (isset($data['created_at'])): ?>
        <div class="mw-admin-edit-post-created-at" onclick="mw.adm_cont_enable_edit_of_created_at()">
            <small>
                ...
                <input class="mw-admin-edit-post-change-created-at-value" style="display:none" type="datetime"
                       name="created_at" value="<?php print $data['created_at'] ?>" disabled="disabled">
            </small>
        </div>
    <?php endif; ?>
    <?php if (isset($data['updated_at'])): ?>
        <div class="mw-admin-edit-post-updated-at" onclick="mw.adm_cont_enable_edit_of_updated_at()">
            <small>
                ...
                <input class="mw-admin-edit-post-change-updated-at-value" style="display:none" type="datetime"
                       name="updated_at" value="<?php print $data['updated_at'] ?>" disabled="disabled">
            </small>
        </div>
    <?php endif; ?>
<?php endif; ?>
