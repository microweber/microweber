...
<div class="mw-modules-tabs">
    <div class="mw-accordion-item-block mw-live-edit-module-manage-and-list-top">
        <a href="javascript:window.mw.parent().live_edit.showSettings('#<?php print $params['id'] ?>',{mode:'modal', liveedit:true});" class="btn btn-primary mw-ui-btn-rounded">
            <span class="fa fa-list"></span> &nbsp;<?php print $mange_btn_text ?>
        </a>

        <a href="javascript:window.mw.parent().liveedit.manageContent.edit('0','<?php print $cont_type_to_add ?>', '', '<?php print $page_id_for_add ?>', '<?php print $category_id_for_add ?>');" class="btn btn-link mw-ui-btn-notification mw-ui-btn-rounded">
