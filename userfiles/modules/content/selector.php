...
<?php } ?> 
<select name="<?php print $field_name ?>" class="mw-ui-field selector-<?php print $config['module_class'] ?>" id="content_selector_<?php print $rand ?>" title="Select a parent page">
