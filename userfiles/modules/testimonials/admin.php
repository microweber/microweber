    ...
    <div class=" ">
        ...
        <div class="<?php if ($from_live_edit): ?><?php else: ?><?php endif; ?>">
            <nav class="nav nav-pills nav-justified btn-group btn-group-toggle btn-hover-style-3">
                <a class="btn btn-outline-dark justify-content-center  active js-list-testimonials" data-bs-toggle="tab" href="#list">  <?php _e("List of Testimonials") ?></a>
                ...
                <a class="btn btn-outline-dark justify-content-center  js-add-new-testimonials" data-bs-toggle="tab" href="#new" style="display: none;"><i class="mdi mdi-card-plus mr-1"></i><?php _e("Add New / Edit") ?></a>
            </nav>
