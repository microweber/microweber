...
<?php
    ...
    if($font_size == false){$font_size = 30;}
...
<div class="module-live-edit-settings" id="module-logo-settings">
    ...
    <ul class="mw-ui-inline-list">
      <li><span>Logo type</span></li>
      <li><label class="mw-ui-check"><input type="radio" class="mw_option_field" <?php if($logotype=='image'){ ?>checked=""<?php } ?> name="logotype" value="image"><span></span><span>Image</span></label></li>
      <li><label class="mw-ui-check"><input type="radio" class="mw_option_field" <?php if($logotype=='text'){ ?>checked=""<?php } ?> name="logotype" value="text"><span></span><span>Text</span></label></li>
      <li><label class="mw-ui-check"><input type="radio" class="mw_option_field" <?php if($logotype=='both' or $logotype == false){ ?>checked=""<?php } ?> name="logotype" value="both"><span></span><span>Both</span></label></li>
    </ul>
    </div>
    <div class="mw-ui-field-holder">
    ...
    <div class="mw-ui-box mw-ui-box-content"><div class="mw-ui-row-nodrop image-row">
      ...
      <div style="padding-top: 15px; clear: both" ></div>
       ...
       <div class="mw-ui-field-hoilder" style="padding-bottom: 20px;"><input type="text" class="mw-ui-field mw-ui-filed-big mw_option_field w100" placeholder="Enter Text" value="<?php print $text; ?>" name="text" id="text" /></div>
         ...
         <select id="google-fonts" class="mw-ui-field mw_option_field" name="font_family">
          ...
          <option value="Zeyada">Zeyada</option>
                        ...
                        <label class="mw-ui-label" style="padding-top: 20px;">Font size</label>
