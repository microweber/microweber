...
<a href="<?php print site_url(); ?>" class="mw-ui-row-nodrop module-logo navbar-brand" style="width: auto;">
    <?php if ($logoimage == '' and $text == '') {
        ...
        <?php if ($logotype == 'text' or $logotype == false or $logotype == 'both') { ?><span class="mw-ui-col"><span
                ...
                style="color:<?php echo $text_color; ?>;font-family: <?php print $font_family_safe; ?>;font-size:<?php print $font_size; ?>px;line-height:<?php print $font_size; ?>px;"><?php _e($text); ?></span>
            </span><?php } ?>
    <?php } ?>
</a>
