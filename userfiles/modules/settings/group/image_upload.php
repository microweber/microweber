...
<div class="form-group">
    ...
    <div class="custom-control custom-radio d-inline-block mr-2">
        <input type="radio" id="img_resize_choice1" class="custom-control-input" name="automatic_image_resize_on_upload" <?php if ($automatic_image_resize_on_upload == 'y'): ?> checked <?php endif; ?> value="y" option-group="website">
        <label class="custom-control-label" for="img_resize_choice1"><?php _e("Yes"); ?></label>
    </div>

    <div class="custom-control custom-radio d-inline-block mr-2">
        <input type="radio" id="img_resize_choice2" class="custom-control-input" name="automatic_image_resize_on_upload" <?php if (!$automatic_image_resize_on_upload or $automatic_image_resize_on_upload == 'n'): ?> checked <?php endif; ?> value="n" option-group="website">
        <label class="custom-control-label" for="img_resize_choice2"><?php _e("No"); ?></label>
    </div>

    <div class="custom-control custom-radio d-inline-block mr-2">
        <input type="radio" id="img_resize_choice3" class="custom-control-input" name="automatic_image_resize_on_upload" <?php if ($automatic_image_resize_on_upload == 'd'): ?> checked <?php endif; ?> value="d" option-group="website">
