...
<div class="<?php print $config['module_class'] ?>">
  <div class="mw-ui-btn-vertical-nav"> <a class="mw-ui-btn" href="javascript:mw.clear_cache()">
    ...
    </a> <a class="mw-ui-btn" href="javascript:$('.mw_adm_dev_tools_change_holder').toggle(); void(0);"> Developer tools </a> <a class="mw-ui-btn" href="javascript:$('.mw_adm_cont_head_change_holder').toggle(); void(0);">
    <?php _e("Custom head tags"); ?>
    </a> <a class="mw-ui-btn" href="javascript:$('.mw_adm_robots_txt_change_holder').toggle(); void(0);"> robots.txt </a> <a class="mw-ui-btn" href="javascript:mw.load_module('settings/group/internal','#mw-advanced-settings-module-load-holder')">
...
<div class="mw_adm_dev_tools_change_holder mw-ui-box mw-ui-box-content" style="display:none">
  <div class="mw-ui-field-holder"> <a class="mw-ui-btn" href="javascript:mw.load_module('admin/developer_tools/template_exporter','#mw-advanced-settings-dev-tools-output')">Template exporter</a> <a class="mw-ui-btn" href="javascript:mw.load_module('admin/developer_tools/media_cleanup','#mw-advanced-settings-dev-tools-output')">Media cleanup</a> <a class="mw-ui-btn" href="javascript:mw.load_module('admin/developer_tools/database_cleanup','#mw-advanced-settings-dev-tools-output')">Database cleanup</a> <a class="mw-ui-btn" href="javascript:mw.load_module('admin/notifications/system_log','#mw-advanced-settings-dev-tools-output')">
    <?php _e("Show system log"); ?>
    </a> <a class="mw-ui-btn" href="javascript:mw.load_module('admin/modules/packages','#mw-advanced-settings-dev-tools-output')">
    <?php _e("Packages"); ?>
    </a>
