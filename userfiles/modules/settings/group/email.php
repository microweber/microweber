...
<div class="<?php print $config['module_class'] ?>">
  ...
  <label class="mw-ui-label"><?php _e("Send email function"); ?> <small><a class="mw-ui-btn mw-ui-btn-small" href="javascript:$('#test_eml_toggle').toggle(); void(0);">[test]</a></small></label>
