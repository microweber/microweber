...
<div class="form-group">
    <label class="form-label d-block"><?php _e("Powered by"); ?> <?php echo mw()->ui->brand_name(); ?></label>
    <small class="text-muted d-block mb-2"><?php _e("Turn on Powered by"); ?> <?php echo mw()->ui->brand_name(); ?> <?php _e("of your site"); ?></small>
