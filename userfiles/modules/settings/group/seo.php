...
<div class="form-group">
    ...
    <small class="text-muted d-block mb-2">If you have a Google Tag Manager account, you can verify ownership of a site using your Google Tag Manager container snippet code. To verify ownership using Google Tag Manager: Choose Google Tag Manager in the verification details page for your site, and follow the instructions shown. <a href="#">Read the article here.</a></small>
...
<div class="form-group">
    ...
    <small class="text-muted d-block mb-2">Google Analytics' property ID is the identifier associated with your account and used by Google Analytics to collect the data. <a href="#">How to find it read here.</a></small>
...
<div class="other-site-verification-codes-hidden-toggle" style="display: none">
    <div class="form-group">
        <label class="control-label"><?php _e("Site verification code for"); ?> Bing</label>
        <small class="text-muted d-block mb-2">You can find a tutorials in internet where and how to find the code.</small>
        <?php $key_name = 'bing-site-verification-code'; ?>
        <input name="<?php print $key_name ?>" class="mw_option_field form-control" type="text" option-group="website" value="<?php print get_option($key_name, 'website'); ?>"/>
    </div>

    <div class="form-group">
        <label class="control-label"><?php _e("Site verification code for"); ?> Alexa</label>
        <small class="text-muted d-block mb-2">You can find a tutorials in internet where and how to find the code.</small>
    ...
    <div class="form-group">
        <label class="control-label"><?php _e("Site verification code for"); ?> Pinterest</label>
        <small class="text-muted d-block mb-2">You can find a tutorials in internet where and how to find the code.</small>
