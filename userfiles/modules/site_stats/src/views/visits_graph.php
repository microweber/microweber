           ...
           <div class="card-header p-0 justify-content-between">
               ...
               <div class="dashboard-admin-cards d-flex align-items-center">
                   <div class="dashboard-icons-wrapper wrapper-icon-statistics">
                       <img src="<?php print modules_url()?>/microweber/api/libs/mw-ui/assets/img/admin-dashboard-statistics.svg" alt="messages">
                   </div>
           ...
           <div class="stats_box_footer">
               <div class="d-flex justify-content-between">
                   <div class="stats-box-colorscheme col-6 col-sm-2 d-flex align-items-center justify-content-center justify-content-sm-start">
                       ...
                       <span class="text-primary mx-2"><?php print $views_count; ?></span> <span><?php _e('Views'); ?></span>
                   </div>
                   ...
                   <div class="stats-box-colorscheme col-6 col-sm-2 d-flex align-items-center justify-content-center">
                       ...
                       <span class="text-primary mx-2"><?php print $visits_count; ?></span> <span><?php _e('Visitors') ?></span>
                   </div>
