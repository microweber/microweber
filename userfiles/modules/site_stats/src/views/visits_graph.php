       ...
       <div class="card-body mb-3">
           ...
           <div class="stats_box_footer">
               <div class="d-flex justify-content-between">
                   <div class="stats-box-colorscheme d-flex align-items-center justify-content-center justify-content-sm-start mx-3" title="Views">
                       ...
                       <span class="text-primary mx-2" style="font-weight: 600; color: #000 !important;"><?php print $views_count; ?>
                   </div>

                   <div class="stats-box-colorscheme d-flex align-items-center justify-content-center mx-3" title="Visitors">
                       ...
                       <span class="text-primary mx-2" style="font-weight: 600; color: #000 !important;"><?php print $visits_count; ?>
                   </div>
