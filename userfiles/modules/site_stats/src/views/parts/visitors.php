    ...
    <div class="item visitor more-info-show" data-id="more-<?php print $item['id']; ?>">
        <div class="top-row">
            ...
            <div class="visitor-name text-start text-left">
                ...
                <a rel="noreferrer noopener" href="https://www.ip2location.com/demo/<?php print $item['user_ip']; ?>" class="text-muted btn btn-link btn-rounded btn-icon btn-sm"  target="_blank"><i class="mdi  mdi-open-in-new
"></i></a>
