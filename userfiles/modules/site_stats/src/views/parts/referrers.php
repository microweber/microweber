...
<div>
    ...
    <div class="collapse" id="refferers-show-more<?php print $item['id'] ?>">
        ...
        <div href="https://templates.microweber.com/mw/admin/shop/product ">
        ...
        <div class="subsources">
            <?php if (isset($item['referrer_domain_id'])  and isset($item['referrer_paths'])  and $item['referrer_domain_id'] != null AND $item['referrer_paths']): ?>
                <?php foreach ($item['referrer_paths'] as $path): ?>
                    ...
                    <div>
                        <span class="subsource-url my-2"><a href="<?php print $path['referrer_url']; ?>" target="_blank"><?php print $ref_url_display; ?></a></span>
                        <span class="subsource-cnt my-2"><?php print $path['path_sessions_count']; ?></span>
