...
//
			...
			$q = "SELECT COUNT(*) AS unique_visits, SUM(view_count) as total_visits,visit_date, DATE_FORMAT(visit_date, '%X %V') as week  FROM $table where visit_date > '$ago' group by week  ";
