...
<div id="stats-units-setup">
    <div class="form-group">
        ...
        <div class="custom-control custom-radio d-inline-block mr-2">
            <input type="radio" id="stats_disabled1" name="stats_disabled" class="mw_option_field form-check-input" data-option-group="site_stats" value="0" type="radio" <?php if (get_option('stats_disabled', 'site_stats') == 0): ?> checked="checked" <?php endif; ?> >
            <label class="custom-control-label" for="stats_disabled1"><?php _e("Enabled"); ?></label>
        </div>

        <div class="custom-control custom-radio d-inline-block mr-2">
            <input type="radio" id="stats_disabled2" name="stats_disabled" class="mw_option_field form-check-input" data-option-group="site_stats" value="1" type="radio" <?php if (get_option('stats_disabled', 'site_stats') == 1): ?> checked="checked" <?php endif; ?> >
