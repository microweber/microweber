...
<div class="<? print $config['module_class']; ?> menu_item_edit" id="mw_edit_menu_item_<?  print $rand ?>">
    ...
    <a href="javascript:mw.menu_<?  print $rand ?>add_new_menu_item_from_content()" class="mw-ui-btn-rect">New link</a> <a href="javascript:mw.menu_<?  print $rand ?>add_new_menu_item_custom()" class="mw-ui-btn-rect">Custom link</a> <br />
