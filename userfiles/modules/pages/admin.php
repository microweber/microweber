      ...
      $pt_opts['active_ids'] =$posts_parent_page;
		...
		<div class="right mw-ui-select" style="width: 75px; min-width: 0;">
        	<select name="include_categories" class="mw_option_field">
        		<option value="y"  <?php if('y'==  $include_categories): ?>   selected="selected"  <?php endif; ?> >Yes</option>
	        	<option value="n"  <?php if ('y'!= $include_categories): ?>   selected="selected"  <?php endif; ?> >No</option>
        	</select><br />
		</div>
