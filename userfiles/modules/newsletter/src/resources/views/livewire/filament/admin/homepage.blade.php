...
@section('newsletter-content')
    ...
    <div class="">
        ...
        <div class="flex gap-4 mt-2">
            @foreach ($quickActions as $action)
                <a href="{{$action['url']}}" class="bg-white hover:shadow rounded-2xl first:rounded-l-lg last:rounded-r-lg flex items-center gap-3 w-full py-4 px-6 hover:bg-gray-500/5">
    ...
    <div class="mt-4 flex gap-4 bg-white rounded-lg ">
