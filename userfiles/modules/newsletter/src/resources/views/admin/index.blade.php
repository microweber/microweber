    ...
    <div class="container px-5 mb-2">
        ...
        <div>
            ...
            <nav class="nav nav-pills nav-justified btn-group btn-group-toggle btn-hover-style-3 newsletter-navigation">
                <a class="btn btn-outline-dark justify-content-center gap-2 active" data-bs-toggle="tab" href="#campaigns"><i class="mdi mdi-email-check-outline mr-1"></i> <?php _e('Campaigns'); ?></a>
                ...
                <a class="btn btn-outline-dark justify-content-center gap-2" data-bs-toggle="tab" href="#subscribers"><i class="mdi mdi-format-list-bulleted-square mr-1"></i> <?php _e('Subscribers'); ?></a>
