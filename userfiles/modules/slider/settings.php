...
<div class="module-live-edit-settings module-bxslider">
    ...
    <div class="form-group" style="display: none;">
        <label class="form-label d-block"><?php _e("Engine"); ?></label>
        <select name="engine" class="mw_option_field form-select" data-width="100%" data-size="5" option_group="<?php print $params['id'] ?>">
    ...
    <div class="slider-options">
        ...
        <div class="row js-option js-slickslider">
            ...
            <div class="col-md-6 ">
                <div class="form-group">
                    <label class="form-label d-block">Extra Small &lt; 576px</label>
                    <select name="slides-xs" class="mw_option_field form-select" data-width="100%" data-size="5" data-option-group="<?php print $params['id']; ?>" data-columns="xs">
            ...
            <div class="col-md-6 ">
                <div class="form-group">
                    <label class="form-label d-block">Small ≥ 576px</label>
                    <select name="slides-sm" class="mw_option_field form-select" data-width="100%" data-size="5" data-option-group="<?php print $params['id']; ?>" data-columns="sm">
            ...
            <div class="col-md-6 ">
                <div class="form-group">
                    <label class="form-label d-block">Medium ≥ 768px</label>
                    <select name="slides-md" class="mw_option_field form-select" data-width="100%" data-size="5" data-option-group="<?php print $params['id']; ?>" data-columns="md">
            ...
            <div class="col-md-6 ">
                <div class="form-group">
                    <label class="form-label d-block">Large ≥ 992px</label>
                    <select name="slides-lg" class="mw_option_field form-select" data-width="100%" data-size="5" data-option-group="<?php print $params['id']; ?>" data-columns="lg">
            ...
            <div class="col-md-6 ">
                <div class="form-group">
                    <label class="form-label d-block">Extra large ≥ 1200px</label>
                    <select name="slides-xl" class="mw_option_field form-select" data-width="100%" data-size="5" data-option-group="<?php print $params['id']; ?>" data-columns="xl">
        ...
        <div class="row">
            <div class="col-md-6 js-option js-bxslider js-slickslider">
                <div class="form-group">
                    <label class="form-label d-block"><?php _e("Pager"); ?></label>
                    <select name="pager" class="mw_option_field form-select" data-width="100%" data-size="5" option_group="<?php print $params['id'] ?>">
            ...
            <div class="col-md-6 js-option js-bxslider js-slickslider">
                <div class="form-group">
                    <label class="form-label d-block"><?php _e("Controls"); ?></label>
                    <select name="controls" class="mw_option_field form-select" data-width="100%" data-size="5" option_group="<?php print $params['id'] ?>">
            ...
            <div class="col-md-6 js-option js-bxslider js-slickslider">
                <div class="form-group">
                    <label class="form-label d-block"><?php _e("Loop"); ?></label>
                    <select name="loop" class="mw_option_field form-select" data-width="100%" data-size="5" option_group="<?php print $params['id'] ?>">
            ...
            <div class="col-md-6 js-option js-bxslider js-slickslider">
                <div class="form-group">
                    <label class="form-label d-block"><?php _e("Adaptive Height"); ?></label>
                    <select name="adaptive_height" class="mw_option_field form-select" data-width="100%" data-size="5" option_group="<?php print $params['id'] ?>">
            ...
            <div class="col-md-6 js-option js-bxslider js-slickslider">
                <div class="form-group">
                    <label class="form-label d-block"><?php _e("Speed"); ?></label>
            ...
            <div class="col-md-6 js-option js-bxslider js-slickslider">
                <div class="form-group">
                    <label class="form-label d-block"><?php _e("Autoplay Speed"); ?></label>
            ...
            <div class="col-md-6 js-option js-bxslider js-slickslider">
                <div class="form-group">
                    <label class="form-label d-block"><?php _e("Pause on hover"); ?></label>
                    <select name="pause_on_hover" class="mw_option_field form-select" data-width="100%" data-size="5" option_group="<?php print $params['id'] ?>">
            ...
            <div class="col-md-6 js-option js-slickslider">
                <div class="form-group">
                    <label class="form-label d-block"><?php _e("Responsive"); ?></label>
                    <select name="responsive" class="mw_option_field form-select" data-width="100%" data-size="5" option_group="<?php print $params['id'] ?>">
            ...
            <div class="col-md-6 js-option js-bxslider js-slickslider">
                <div class="form-group">
                    <label class="form-label d-block"><?php _e("Autoplay"); ?></label>
                    <select name="autoplay" class="mw_option_field form-select" data-width="100%" data-size="5" option_group="<?php print $params['id'] ?>">
            ...
            <div class="col-md-6 js-option js-bxslider">
                <div class="form-group">
                    <label class="form-label d-block"><?php _e("Touch Enabled"); ?></label>
                    <select name="touch_enabled" class="mw_option_field form-select" data-width="100%" data-size="5" option_group="<?php print $params['id'] ?>">
            ...
            <div class="col-md-6 js-option js-slickslider">
                <div class="form-group">
                    <label class="form-label d-block"><?php _e("Slides per row"); ?></label>
            ...
            <div class="col-md-6 js-option js-slickslider">
                <div class="form-group">
                    <label class="form-label d-block"><?php _e("Center Mode"); ?></label>
                    <select name="center_mode" class="mw_option_field form-select" data-width="100%" data-size="5" option_group="<?php print $params['id'] ?>">
            ...
            <div class="col-md-6 js-option js-slickslider">
                <div class="form-group">
                    <label class="form-label d-block"><?php _e("Center Padding"); ?></label>
            ...
            <div class="col-md-6 js-option js-slickslider">
                <div class="form-group">
                    <label class="form-label d-block"><?php _e("Draggable"); ?></label>
                    <select name="draggable" class="mw_option_field form-select" data-width="100%" data-size="5" option_group="<?php print $params['id'] ?>">
            ...
            <div class="col-md-6 js-option js-slickslider">
                <div class="form-group">
                    <label class="form-label d-block"><?php _e("Fade"); ?>
                        <small>(only for one slide)</small>
                    </label>
                    <select name="fade" class="mw_option_field form-select" data-width="100%" data-size="5" option_group="<?php print $params['id'] ?>">
            ...
            <div class="col-md-6 js-option js-slickslider">
                <div class="form-group">
                    <label class="form-label d-block"><?php _e("Focus On Select"); ?></label>
                    <select name="focus_on_select" class="mw_option_field form-select" data-width="100%" data-size="5" option_group="<?php print $params['id'] ?>">
