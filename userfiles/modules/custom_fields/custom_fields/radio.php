...
<div class="mw-custom-field-group mw-custom-field-group-checkbox custom-field-preview"> <span class="mw-custom-field-label" for="custom_field_help_text<? print $rand ?>"><? print $data["custom_field_name"]; ?></span>
  ...
  <div class="mw-custom-field-form-controls">
    <input type="radio" name="<? print $data["custom_field_name"]; ?>" id="field-<? print $data["id"]; ?>"  data-custom-field-id="<? print $data["id"]; ?>" value="<? print $kv; ?>" <? if(isset($data['custom_field_value']) == true and $data['custom_field_value'] == $kv): ?> checked="checked" <? endif; ?> >
