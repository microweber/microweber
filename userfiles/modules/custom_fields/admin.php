...
<script type="text/javascript">
    function mw_make_new_field($type){
        $('#custom-fields-form-wrap-<? print $rand ?>').load('<? print site_url('api_html/make_custom_field/settings:y/for_module_id:') ?><? print $params['id']; ?>/for:<? print $for  ?>/custom_field_type:'+$type);
