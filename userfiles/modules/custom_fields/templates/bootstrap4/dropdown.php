...
<div class="form-group">
	...
	<div class="mw-ui-controls">
		<select <?php if ($settings['multiple']): ?>multiple="multiple"<?php endif; ?> class="mw-ui-field form-control js-mw-select-<?php echo $data['id']; ?>" <?php if ($settings['required']): ?>required<?php endif; ?> data-custom-field-id="<?php echo $data['id']; ?>" name="<?php echo $data['name']; ?>" />
