<div class="col-<?php echo $settings['field_size']; ?>">
    <div class="form-group">
        ...
        <?php if ($settings['as_text_area']): ?>
            <textarea type="text" class="form-control" <?php if ($settings['required']): ?>required="true"<?php endif; ?> data-custom-field-id="<?php echo $data['id']; ?>" name="<?php echo $data['name']; ?>" placeholder="<?php echo $data['placeholder']; ?>"><?php echo $data['value']; ?></textarea>
        <?php else: ?>
