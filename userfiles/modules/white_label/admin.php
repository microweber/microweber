...
<div class="module-live-edit-settings">
    <form id="white_label_settings_holder">
        <div class="mw-ui-box   ">
            <div class="mw-ui-box-header"><span class="mw-icon-gear"></span><span><?php _e('Branding'); ?></span></div>
            <div class="mw-ui-box-content">
                <div class="mw-ui-row">
                    <div class="mw-ui-col" style="width: 50%">
                        <div class="mw-ui-col-container">
                            <div class="mw-ui-field-holder">
                                <label class="mw-ui-label"><?php _e('Brand Name'); ?></label>
                                <input
                                        name="brand_name"
                                        option-group="whitelabel"
                                        placeholder="<?php _e('Enter the name of your company'); ?>"
                            ...
                            <div class="mw-ui-field-holder">
                                <label class="mw-ui-label"><?php _e('Logo login link'); ?></label>
                                <input
                                        name="admin_logo_login_link"
                                        option-group="whitelabel"
                                        placeholder="<?php _e('Enter website url of your company'); ?>"
                            ...
                            <div class="mw-ui-field-holder">
                                <label class="mw-ui-label"><?php _e('Support page link'); ?></label>
                                <input
                    ...
                    <div class="mw-ui-col" style="width: 50%">
                        <div class="mw-ui-col-container">
                            <div class="mw-ui-field-holder">
                                <label class="mw-ui-label"><?php _e('Logo for Admin panel (36x36 px)'); ?></label>
                                <input
                                        name="logo_admin"
                                        option-group="whitelabel"
                                        placeholder="<?php _e('Upload your logo'); ?>"
                ...
                <div class="mw-ui-row">
                        ...
                        <div class="mw-ui-col-container">
                            <div class="mw-ui-field-holder">
                                ...
                                <textarea name="powered_by_link" id="powered_by_link_text" option-group="whitelabel"
                                          placeholder="<?php _e('HTML code for template footer link'); ?>"
                                          class="mw-ui-field"
                    ...
                    <div class="mw-ui-col" style="width: 50%">
                        <div class="mw-ui-col-container">
                            ...
                            <div class="mw-ui-field-holder">
                                <ul class="mw-ui-inline-list">
                                    <li><span>"<?php _e('Powered By'); ?>"</span></li>
                                    <li>
                                        <label class="mw-ui-check">
                                            <input
                            ...
                            <div class="mw-ui-field-holder">
                                <ul class="mw-ui-inline-list">
                                    <li><span>Enable service links <small
                                                    data-help="such as 'suggest a feature' and 'support'"
                                                    class="mw-help"> (?) </small> </span></li>
                                    <li>
                                        <label class="mw-ui-check">
                                            <input
                            ...
                            <div class="mw-ui-field-holder">
                                <input type="submit" class="mw-ui-btn mw-ui-btn-big mw-ui-btn-notification"
