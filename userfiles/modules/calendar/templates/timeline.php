            ...
            <div class="cd-timeline__block js-cd-block">
                ...
                <div class="cd-timeline__content js-cd-content">
                    <div class="text-center">
                        <h4 class="mb-3"><?php print $event['title']; ?></h4>

                        <img src="<?php print thumbnail($event['image_url'], 350); ?>" alt="">

                        <p><?php print $event['description']; ?></p>

                        <?php if (!!$event['content_id']) {
                            ?>
                            <a href="<?php print $event_post['full_url'] ?>" class="btn btn-primary">Read more</a>
                            <?php
                        } ?>
                    </div>

                    <div class="cd-timeline__date">
                        <h5 class="mt-2"><?php print date('M, d h:i', strtotime($event['start'])); ?> - <?php print date('M, d h:i', strtotime($event['end'])); ?></h5>
                    </div>
                </div>
            </div>
        <?php endforeach; ?>
