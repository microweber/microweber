   ...
   #UITU{height: 5px;overflow: hidden;box-shadow:0 0 4px #BBBBBB;}#UITU.active{height: auto;padding: 30px;#} #qweqwe98989898 td{
        padding: 20px;
  ...
  <table width="100%" id="qweqwe98989898" cellspacing="0">
   <col width="60%" />
   <col width="40%" />
   <tbody>
    ...
    <tr>
      <td><a href="javascript:;" class="mw-ui-btn">Button</a></td>
      <td><textarea><a href="javascript:;" class="mw-ui-btn">Button</a></textarea></td>
    </tr>
    <tr>
        ...
        <td>
            ...
            <ul>
                <li>
                    ...
                    <ul class="mw-accordion-content hide">
