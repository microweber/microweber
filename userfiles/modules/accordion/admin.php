        ...
        <div class="mw-accordion-content mw-ui-box mw-ui-box-content">
            ...
            <div class="module-live-edit-settings module-accordion-settings">
                ...
                <div class="mw-ui-field-holder add-new-button text-right m-b-10">
                    <a class="mw-ui-btn mw-ui-btn-medium mw-ui-btn-notification mw-ui-btn-rounded" href="javascript:accordions.create()"><i class="fas fa-plus-circle"></i> &nbsp;<?php _e('Add new'); ?></a>
                </div>
