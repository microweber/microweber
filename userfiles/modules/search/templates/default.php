...
<div class="mw-search mw-search-default" id="search_box_holder_<?  print $params['id'] ?>">
    ...
    <button class="btn  pull-left"
      onclick="mw.url.windowHashParam('keyword<? print $seach_prefix ?>',mwd.getElementById('search_field_<?  print $params['id'] ?>').value);">
