...
//echo htmlentities(htmlspecialchars($geshi->parse_code()));
...
<pre  class="prettyprint linenums language-<? print $source_code_language ?>" language="<? print $source_code_language ?>">
