            ...
            <div class="mw-coupons-module">
                <?php if(isset($applied_coupon_data['coupon_code'])): ?>
                    <div class="coupon_code_apply_wrapper" >
                        <h5 class="mb-2">You are using coupon code </h5>
                        <div class="form-group d-flex">
                                    ...
                                    <a class="align-self-center mx-4" href="javascript:$('.coupon_code_apply_wrapper').toggle(); void(0);">Change</a>
                        </div>
                    </div>
                <?php endif; ?>
                    <div class="ml-3">
                        <div class="coupon_code_apply_wrapper" <?php if(isset($applied_coupon_data['coupon_code'])): ?>  style="display: none"    <?php endif; ?>  >
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-6">
                                        <button type="button" class="btn btn-outline-primary js-apply-coupon-code">Apply code</button>
                                    </div>
                                </div>
                        </div>
                    </div>
