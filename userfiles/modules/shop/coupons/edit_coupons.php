            ...
            <?php foreach ($allCoupons as $coupon): ?>
                <tr<?php if ($coupon['is_active'] == 1): ?> class="js-table-active" <?php else: ?> class="js-table-inactive" <?php endif; ?>>
                    ...
                    <td class="d-flex align-items-center text-center">
                        ...
                        &nbsp;
                        <a onclick="deleteCoupon(<?php print($coupon['id']) ?>)" data-bs-toggle="tooltip" aria-label="Delete" data-bs-original-title="Delete" class="text-danger"> <svg class="me-1 text-danger" fill="currentColor" xmlns="http://www.w3.org/2000/svg" height="18px" viewBox="0 0 24 24" width="18px"><path d="M0 0h24v24H0V0z" fill="none"></path><path d="M16 9v10H8V9h8m-1.5-6h-5l-1 1H5v2h14V4h-3.5l-1-1zM18 7H6v12c0 1.1.9 2 2 2h8c1.1 0 2-.9 2-2V7z"></path></svg></a>
                    </td>
                </tr>
            <?php endforeach; ?>
        <?php endif; ?>
