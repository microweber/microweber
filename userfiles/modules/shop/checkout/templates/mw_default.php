    ...
    <div class="mw-ui-col" style="width: 50%;">
        <div class="mw-ui-col-container">
            ...
            <div class="mw-ui-field-holder">
                ...
                <input name="first_name" class="mw-ui-field element-block" type="text" value="<?php if (isset($user['first_name'])) {
            ...
            <div class="mw-ui-field-holder">
                ...
                <input name="last_name" class="mw-ui-field element-block" type="text" value="<?php if (isset($user['last_name'])) {
            ...
            <div class="mw-ui-field-holder">
                ...
                <input name="email" class="mw-ui-field element-block" type="text" value="<?php if (isset($user['email'])) {
                    print $user['email'];
                } ?>"/>
            </div>
            ...
            <div class="mw-ui-field-holder">
                ...
                <input name="phone" class="mw-ui-field element-block" type="text" value="<?php if (isset($user['phone'])) {
                    print $user['phone'];
                } ?>"/>
            </div>
        </div>
