...
<div class="clearfix container-fluid module-posts-template-columns module-posts-template-columns-3">
  ...
  <div class="row-fluid">
    ...
    <div class="span4<?php if($count % 3 == 0) { ?> first <?php } ?>">
      ...
      <a class="img-polaroid img-rounded" href="<? print $item['link'] ?>"> <span class="valign"> <span class="valign-cell"> <img <?php if($item['image']==false){ ?>class="pixum"<?php } ?> src="<? print thumbnail($item['image'], $tn[0], $tn[1]); ?>" alt="<? print $item['title'] ?>" title="<? print $item['title'] ?>"  /> </span> </span> </a>
      <? endif; ?>
      ...
      <? $read_more_text ? print $read_more_text : print _e('Read More', true); ?>
      </a>
      <? endif; ?>
