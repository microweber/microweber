...
.mw-cart-small .no-items{
 ...
 <div class="mw-cart-small  mw-cart-<? print $params['id']?> <? print  $template_css_prefix  ?>">
      <span class="cart-icon"><span class="icon-shopping-cart"></span></span>
  ...
  <? else : ?>
    ...
    <span class="no-items"><?   _e('Your cart is empty') ?></span>
