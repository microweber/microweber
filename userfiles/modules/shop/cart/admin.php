 <div class="mw_simple_tabs mw_tabs_layout_simple">
	...
	<div class="tab">
		...
		<div class="mw-ui-select" style="width: 100%;">
			<?php $checkout_link_enanbled =  mw('option')->get('data-checkout-link-enabled', $params['id']); ?>
		...
		<?php $selected_page=mw('option')->get('data-checkout-page', $params['id']); ?>
		<div class="mw-ui-select" style="width: 100%;">
		...
		<label class="mw-ui-check"><input value="y" <?php if(mw('option')->get('show_shipping', $params['id']) == 'y'):  ?> checked="checked" <?php  endif ?> class="mw_option_field" name="show_shipping" type="checkbox"><span></span><span><?php _e("Show shipping price into the shopping cart"); ?></span></label>
	</div>
