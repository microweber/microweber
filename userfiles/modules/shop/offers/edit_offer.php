		...
		<div class="mw-ui-col">
			<div class="mw-ui-col-container">
				<div class="mw-ui-field-holder">
					...
					<input type="text" name="offer_price" class="mw-ui-field js-validation js-validation-float-number" value="<?php print number_format(floatval($data['offer_price']),2); ?>"/>
...
<?php // TODO: expires_at not saving in correct format ?>
					<input type="text" name="expires_at" class="mw-ui-field js-validation js-validation-expiry-date" autocomplete="off" value="<?php print date_system_format($data['expires_at']); ?>"/>
					<div class="js-field-message"></div>
				</div>
 			</div>
		</div>
