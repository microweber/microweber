...
<table class="table-style-1 mw-ui-table">
	...
	?>
	<tr<?php if($offer['is_active'] == 1): ?> class="js-table-active" <?php else: ?> class="js-table-inactive" <?php endif; print $class_product_deleted; ?>>
    ...
    <td><?php print date_system_format($offer['expires_at']) ?></td>
    <td class="<?php print $class_status;?>"><?php print($offer['is_active']==1? 'on':'off') ?></td>
    <td class="action-buttons">
    	<button onclick="editOffer(<?php print($offer['id']) ?>)" class="mw-ui-btn mw-ui-btn-medium mw-ui-btn-info mw-ui-btn-outline" title="Edit">
    			 Edit
		</button>
		<button onclick="deleteOffer(<?php print($offer['id']) ?>)" class="mw-ui-btn mw-ui-btn-medium mw-ui-btn-info mw-ui-btn-outline" title="Delete">
		Delete
		</button>
    </td>
    </tr>
