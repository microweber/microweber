...
namespace shop\shipping\gateways\firstclass;

api_bind('shop/shipping/gateways/firstclass/shipping_firstclass/test', 'shop/shipping/gateways/firstclass/shipping_firstclass/test2');

// print('shop/shipping/gateways/firstclass/shipping_firstclass/test'. 'shop/shipping/gateways/firstclass/shipping_firstclass/test2');
api_expose_admin('shop/shipping/gateways/firstclass/shipping_firstclass/save');
api_expose('shop/shipping/gateways/firstclass/shipping_firstclass/set');
api_expose('shop/shipping/gateways/firstclass/shipping_firstclass/get');
api_expose_admin('shop/shipping/gateways/firstclass/shipping_firstclass/delete');
api_expose_admin('shop/shipping/gateways/firstclass/shipping_firstclass/reorder');

class shipping_firstclass
{
...
//var_dump($shipping_country);
        ...
        app()->shipping_manager->setDefaultDriver('shop/shipping/gateways/firstclass');
