<script>
    function mw_admin_edit_country_item_popup(id) {
        ...
        var dialog = mw.top().dialogIframe({
            url: route('live_edit.module_settings') + '?type=shop/shipping/gateways/firstclass/add_country&live_edit=true&id=mw_admin_edit_country_item_popup_modal_opened__module&edit_id='+id+'&from_url=<?php print site_url() ?>',
            title:modalTitle,
            id: modal_id,
