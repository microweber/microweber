<?php
 ...
 $data = api('shop/shipping/gateways/firstclass/shipping_firstclass/get', "is_active=1");
 $data_disabled = api('shop/shipping/gateways/firstclass/shipping_firstclass/get', "is_active=0");
