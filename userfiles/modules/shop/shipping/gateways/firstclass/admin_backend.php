...
<nav class="nav nav-pills nav-justified btn-group btn-group-toggle btn-hover-style-3">
    <a class="btn btn-outline-primary justify-content-center  active" data-bs-toggle="tab" href="#list"><i class="mdi mdi-cog-outline mr-1"></i> <?php _e('Shipping First Class'); ?></a>
    <a class="btn btn-outline-primary justify-content-center " data-bs-toggle="tab" href="#settings"><i class="mdi mdi-pencil-ruler mr-1"></i> <?php _e('Unit settings'); ?></a>
    <a class="btn btn-outline-primary justify-content-center " data-bs-toggle="tab" href="#tab_shipping_fields_settings"><i class="mdi mdi-pencil-ruler mr-1"></i> <?php _e('Fields settings'); ?></a>
</nav>
...
<div class="tab-content py-3">
    <div class="tab-pane fade show active" id="list">
        <script type="text/javascript">
            ...
            shippingFirstClass = function (el) {
                var data = {
                    option_group: 'shipping',
                    option_key: 'shipping_gw_shop/shipping/gateways/firstclass',
        ...
        $shipping_modules = get_modules("type=shipping_gateway&module=shop/shipping/gateways/firstclass");
        ?>
    ...
    <div class="tab-pane fade" id="tab_shipping_fields_settings">
        <module type="shop/shipping/gateways/firstclass/shipping_fields_settings" id="shipping_fields_settings"/>
    </div>
</div>
