...
<script type="text/javascript">
    ...
    SaveShippingData = function (data) {
        ...
        return $.post('<?php print $config['module_api']; ?>/shipping_standard/save', data)
            .done(function (msg) {
    ...
    SaveShipping = function (form, dataType) {
        ...
        mw.form.post($(form), '<?php print $config['module_api']; ?>/shipping_standard/save', function () {
                ...
                mw.reload_module_everywhere('shop/shipping/gateways/standard/admin_backend');
                mw.reload_module_everywhere('shop/shipping/gateways/standard/admin');


                if (window.parent != undefined && window.parent.mw != undefined) {
                    // window.parent.mw.reload_module('shop/shipping/gateways/standard');
                    mw.reload_module_everywhere('shop/shipping/gateways/standard');
