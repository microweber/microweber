<script>
    function mw_admin_edit_country_item_popup(id) {
        ...
        // }
        //
        // mw.load_module('shop/shipping/gateways/standard/add_country', '#mw_admin_edit_country_item_module', null, params);
    ...
    mw.shipping_country = {
        delete_country : function(id){
            ...
            mw.tools.confirm(q, function(){
                var obj = {};
                obj.id = id;
                $.post("<?php print $config['module_api']; ?>/shipping_standard/delete",  obj, function(data){
...
<div class="">
    ...
    <div class="mw-shipping-items shipping_standard_holder table-responsive mt-3" id="shipping_standard_holder<?php if ($active_or_disabled == 'active'): ?>_active<?php endif; ?>">
