...
<nav class="nav nav-pills nav-justified btn-group btn-group-toggle btn-hover-style-3">
    <a class="btn btn-outline-primary justify-content-center  active" data-bs-toggle="tab" href="#list"><i class="mdi mdi-cog-outline mr-1"></i> <?php _e('Shipping Standard'); ?></a>
...
<div class="tab-content py-3">
    <div class="tab-pane fade show active" id="list">
        <script type="text/javascript">
            ...
            shippingStandardClass = function (el) {
                var data = {
                    option_group: 'shipping',
                    option_key: 'shipping_gw_shop/shipping/gateways/standard',
        ...
        $shipping_modules = get_modules("type=shipping_gateway&module=shop/shipping/gateways/standard");
        ?>
    ...
    <div class="tab-pane fade" id="tab_shipping_fields_settings">
        <module type="shop/shipping/gateways/standard/shipping_fields_settings" id="shipping_fields_settings"/>
    </div>
</div>
