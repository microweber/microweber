...
namespace shop\shipping\gateways\standard;

api_bind('shop/shipping/gateways/standard/shipping_standard/test', 'shop/shipping/gateways/standard/shipping_standard/test2');

// print('shop/shipping/gateways/standard/shipping_standard/test'. 'shop/shipping/gateways/standard/shipping_standard/test2');
api_expose_admin('shop/shipping/gateways/standard/shipping_standard/save');
api_expose('shop/shipping/gateways/standard/shipping_standard/set');
api_expose('shop/shipping/gateways/standard/shipping_standard/get');
api_expose_admin('shop/shipping/gateways/standard/shipping_standard/delete');
api_expose_admin('shop/shipping/gateways/standard/shipping_standard/reorder');

class shipping_standard
{
...
//var_dump($shipping_country);
        ...
        app()->shipping_manager->setDefaultDriver('shop/shipping/gateways/standard');
