...
<script type="text/javascript">
    ...
    shippingCollectionSettingsSet = function (el) {
        var data = {
            option_group: 'shipping',
            option_key: 'shipping_gw_shop/shipping/gateways/collection',
...
<div class="form-group">
    ...
    <div class="custom-control custom-switch pl-0">
        ...
        <input onchange="shippingCollectionSettingsSet(this)" type="checkbox" name="shipping_gw_shop/shipping/gateways/collection" id="shipping_gw_shop/shipping/gateways/collection" data-option-group="shipping" data-id="shipping_gw_shop/shipping/gateways/collection" data-value-checked="y" data-value-unchecked="n" class="mw_option_field custom-control-input" <?php if ($status == 'notification'): ?> checked  <?php endif; ?>>
        <label class="custom-control-label" for="shipping_gw_shop/shipping/gateways/collection"><?php _e('Yes'); ?></label>
    </div>
</div>
