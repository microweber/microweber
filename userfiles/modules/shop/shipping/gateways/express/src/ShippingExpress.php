...
use shop\shipping\gateways\express\shipping_express;

class ShippingExpress implements ShippingDriverInterface
{

    public function isEnabled()
    {
        $module = 'shop/shipping/gateways/express';
    ...
    {
        return (new shipping_express())->get_cost();
    }

    public function quickSetup()
    {
        return '<module type="shop/shipping/gateways/express" template="select_bootstrap4" />';
    }

    public function getCountries()
    {
        return (new shipping_express())->get_available_countries();
    }
