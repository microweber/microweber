<?php
 ...
 $data = api('shop/shipping/gateways/express/shipping_express/get', "is_active=1");
 $data_disabled = api('shop/shipping/gateways/express/shipping_express/get', "is_active=0");
