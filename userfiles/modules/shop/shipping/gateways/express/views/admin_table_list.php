<script>
    function mw_admin_edit_country_item_popup(id) {
        ...
        var dialog = mw.top().dialogIframe({
            url: '<?php print site_url() ?>module/?type=shop/shipping/gateways/express/add_country&live_edit=true&id=mw_admin_edit_country_item_popup_modal_opened__module&edit_id='+id+'&from_url=<?php print site_url() ?>',
            title:modalTitle,
            id: modal_id,
