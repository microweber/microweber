<?php $rand1 = 'shipping_express_holder' ?>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        mw.$(".shipping_express_holder").sortable({
            ...
            update: function () {
                ...
                $.post("<?php print $config['module_api']; ?>/shipping_express/reorder", obj, function () {
                    mw.reload_module('[data-parent-module="shop/shipping"]');
                    if (window.parent != undefined && window.parent.mw != undefined) {
                        window.parent.mw.reload_module('shop/shipping/gateways/express');
                    }
                });
            },
            start: function (a, ui) {
...
<script type="text/javascript">
   ...
   /* ToggleShipping = function (e) {
    ...
    SaveShippingData = function (data) {
        return $.post('<?php print $config['module_api']; ?>/shipping_express/save', data)
            .done(function () {
    ...
    SaveShipping = function (form, dataType) {
        ...
        mw.form.post($(form), '<?php print $config['module_api']; ?>/shipping_express/save', function () {
                if (dataType == 'new') {
                    alert(1);
