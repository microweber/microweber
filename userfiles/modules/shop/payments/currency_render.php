...
<label class="mw-ui-label"><?php _e("Equals to"); ?> (rate: <?php print  $payment_currency_rate ?> <?php _e("or"); ?> <?php print ( currency_format(1, $cur)); ?>=<?php print ( currency_format(1*$payment_currency_rate, $payment_currency)); ?> )</label>
