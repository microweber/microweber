...
<li><label class="mw-ui-label"><?php _e("Test mode"); ?>:</label></li>
 ...
 <li><label class="mw-ui-check">
    <input name="paypalexpress_testmode" class="mw_option_field"    data-option-group="payments"  value="y"  type="radio"  <?php if(get_option('paypalexpress_testmode', 'payments') != 'n'): ?> checked="checked" <?php endif; ?> >
    <span></span><span><?php _e("Yes"); ?></span></label></li>

     <li><label class="mw-ui-check">
    <input name="paypalexpress_testmode" class="mw_option_field"    data-option-group="payments"  value="n"  type="radio"  <?php if(get_option('paypalexpress_testmode', 'payments') == 'n'): ?> checked="checked" <?php endif; ?> >
