    ...
    <div class="mw-ui-col-container">
      <div class="mw-set-payment-options">
        <div style="overflow: hidden;position: relative;padding: 30px 0 0;">
          <div class="mw-ui-btn-nav"> <a class="mw-ui-btn payment-tab active" href="javascript:;">
            <?php _e("Payments"); ?>
            </a> <a class="mw-ui-btn payment-tab" href="javascript:;" id="payment-tab-email">
            <?php _e("Emails for order"); ?>
            </a> <a class="mw-ui-btn payment-tab" href="javascript:;">
            <?php _e("Taxes"); ?>
            </a> <a class="mw-ui-btn payment-tab" href="javascript:;">
            <?php _e("Other"); ?>
            </a> </div>
              ...
              <div class="mw-ui-box-header"  onmousedown="mw.tools.accordion(this.parentNode);">
                <div class="gateway-icon-title">
                  <div class="mw-ui-row">
                    ...
                    <div class="mw-ui-col"> <img src="<?php print $payment_module['icon']; ?>" alt="" /> </div>
                    <div class="mw-ui-col"> <span class="gateway-title"><?php print $payment_module['name'] ?>
