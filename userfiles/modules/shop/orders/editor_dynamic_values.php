...
<div data-value="" title="These values will replaced with the actual content" id="dynamic_vals" class="mw_dropdown mw_dropdown_type_wysiwyg mw_dropdown_action_dynamic_values">
    <span class="mw_dropdown_val_holder">
        <span class="dd_rte_arr"></span>
        <span class="mw_dropdown_val">Dynamic Values</span>
    </span>
