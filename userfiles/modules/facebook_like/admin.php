...
<div class="module-live-edit">
  ...
  <div class="mw-ui-field-holder">
    <label class="mw-ui-label"> Layout </label>
      ...
      <select name="layout"  class="mw-ui-field mw_option_field">
  ...
  <div class="mw-ui-field-holder">
    <label class="mw-ui-label"> Color cheme </label>
      ...
      <select name="color"  class="mw-ui-field mw_option_field">
    ...
    <label class="mw-ui-label"> Show faces </label>
      ...
      <select name="show_faces"  class="mw-ui-field mw_option_field">
