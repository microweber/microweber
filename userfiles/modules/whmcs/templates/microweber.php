...
<div id="site-reg-get-started">
		...
		<form id="user_registration_form" method="post" class="clearfix">
			...
			<div class="box block domain-search-form">
				<div class="box-content">
					<input type="text"   placeholder="Choose Site Name" tabindex="1" class="pull-left invisible-field" autocomplete="off" autofocus="" id="domain-search-field"/>
    ...
    if ($remote_client_id == false): ?>
			...
			<div class="relative">
				...
				<span class="btn btn-default btn-small" id="set_the_pass"><i class="icon-eye-open"></i> <span>Show Password</span></span> </div>
			<?php else: ?>
			Welcome,
			<?php  print user_name(); ?>
			! <br />
			...
			<input type="submit" name="Create site" />
		</form>
