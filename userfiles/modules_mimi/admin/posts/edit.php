  ...
  <div id="orders_tabaasdasds" class="mw_box">
    <div id="tabs">
      <ul >
        ...
        <?
	  $last_mod = date('YmdHis', strtotime('8 september 2011'));
	  if($form_values['created_on'] == false){
		  
		$form_values['created_on'] = date('YmdHis') ;
	  }
	   $when = date('YmdHis', strtotime($form_values['created_on']));
	 ...
	 //  print  $last_mod;
	   ...
	   //print   $when; ?>
        ...
        <? endif; ?>
        <li><a href="#fragment-41"><img src="<?php  print( ADMIN_STATIC_FILES_URL);  ; ?>img/silk/color.png"  height="16" align="left"  class="mw_admin_tab_icon" /><span>Colors</span></a></li>
        <? if($last_mod <  $when ): ?>
        <li><a href="#fragment-42"><img src="<?php  print( ADMIN_STATIC_FILES_URL);  ; ?>img/silk/pencil.png"  height="16" align="left"  class="mw_admin_tab_icon" /><span>Custom Fields</span></a></li>
        <? endif; ?>
      ...
      <div id="fragment-41">
        <mw module="admin/content/colors" id="<? print $form_values['id'] ?>" />
      </div>
      <? if($last_mod <  $when ): ?>
      <div id="fragment-42">
        <mw module="admin/content/custom_field_simple" id="<? print $form_values['id'] ?>" name="model" title="Модел" />
        <mw module="admin/content/custom_field_simple" id="<? print $form_values['id'] ?>" name="size" title="Размери" />
        <mw module="admin/content/custom_field_simple" id="<? print $form_values['id'] ?>" name="price" title="Цена" />
      </div>
      <? endif; ?>
      <div id="fragment-5" >
