...
<div class="main-inner" style="padding-top: 0"> 
  ...
  <div class="pad"> 
    ...
    <a href="<?php print prep_url($more['product_buy_link']); ?>" target="_blank" class="orderbig"  title="<?php if(($more['product_price'])): ?> for $<?php print floatval($more['product_price']); ?><?php endif; ?>" >Buy now</a>
    <?php endif; ?>
