...
<div id="footer">
  <div id="footer-navigation">
    <ul>
      <li id="connect-ico"> <a href="<?php print $this->content_model->getContentURLByIdAndCache(117); ?>"> <strong>Connect</strong> <span>Lorem Ipsum is simply <br />
        dummy text of the printing</span> </a> </li>
      <li id="learn-ico"> <a href="<?php print $this->content_model->getContentURLByIdAndCache(118); ?>"> <strong>Learn</strong> <span>Lorem Ipsum is simply <br />
        dummy text of the printing</span> </a> </li>
      <li id="teach-ico"> <a href="<?php print $this->content_model->getContentURLByIdAndCache(119); ?>"> <strong>Teach</strong> <span>Lorem Ipsum is simply <br />
        dummy text of the printing</span> </a> </li>
      <li id="grow-ico"> <a href="<?php print $this->content_model->getContentURLByIdAndCache(120); ?>"> <strong>Grow</strong> <span>Lorem Ipsum is simply <br />
        dummy text of the printing</span> </a> </li>
    </ul>
    <p>Lorem Ipsum is <a href="#">simply dummy</a> text of the printing Lorem Ipsum is <a href="#">simply dummy</a> text of the printing Lorem Ipsum is simply dummy text of the printing</p>
  </div>
