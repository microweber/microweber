...
<meta name="reply-to" content="<?php print $this->content_model->optionsGetByKey ( 'creator_email' ); ?>" />
<link rev="made" href="mailto:<?php print $this->content_model->optionsGetByKey ( 'creator_email' ); ?>" />
