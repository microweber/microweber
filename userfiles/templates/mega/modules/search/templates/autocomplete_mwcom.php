...
<div class="mw-search mw-search-autocomplete2 " id="search_box_holder_<?php  print $params['id'] . $rand ?>">

    <input type="text"
         id="search_field_<?php  print $params['id'] . $rand  ?>"
         class="box mw-search-field"
...
if(typeof mw.autocompleteSearch === 'undefined'){
    ...
    mw.acnav = function(a, parent){
     ...
     $(document).ready(function(){
      $(mwd.body).bind("mouseup", function(e){
        if(!(mw.tools.hasParentsWithClass(e.target, 'mw-search') || mw.tools.hasClass(e.target, 'mw-search'))){
