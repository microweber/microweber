...
<div id="mw-login">
	...
	<div id="user_login_holder_<?php print $params['id'] ?>">
		<form   method="post" id="user_login_<?php print $params['id'] ?>"  class="clearfix" action="#" data-callback="gotoprofile"  >
			...
			<a class="reset-password-link" href="javascript:mw.load_module('users/forgot_password', '#<?php print $params['id'] ?>', {template:'default'});">
			...
			<span class="or-register">or <a href="javascript:mw.load_module('users/register', '#<?php print $params['id']; ?>', false, {template:'default'});">
			<?php _e("Register"); ?>
			</a></span>
