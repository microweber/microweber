  ...
  <div class="mw-comments-form" id="comments-<?php print $data['id'] ?>">
    <form autocomplete="on" id="comments-form-<?php print $data['id'] ?>">
      ...
      <?php endif; ?>
            ...
            <div class="vpad"><textarea required class="box" placeholder="<?php _e("Comment"); ?>" name="comment_body" style="width:100%;height:120px;"></textarea></div>
          ...
          <input type="submit" class="orangebtn pull-right" value="<?php _e("Add comment"); ?>">
