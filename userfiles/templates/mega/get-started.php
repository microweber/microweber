...
<div id="header">
	<div class="container">
		<div id="get-started-header"> <a href="<?php print site_url(); ?>" id="logo" class="logomark" title="Microweber">Microweber</a> <span>Make Web. Easy and Fun!</span> </div>
	</div>
	<!-- /#header > .container --> 
</div>
<!-- /# header -->
...
<div id="content" class="get-started-content">
	<div class="container narrow">
		<div class="main"> <img style="margin: 37px 0 0 16px;" class="pull-right" alt="" src="<?php  print TEMPLATE_URL ?>site/free-arr.png"> <img class="pull-right" alt="" src="<?php  print TEMPLATE_URL ?>site/free.png">
			<h4 style="padding-top: 27px;" class="nomargin">Great! Few steps to create your website.</h4>
		...
		<?php if(isset($_REQUEST['plan'])) : ?>
		<table width="100%">
			<col width="445">
			<col width="160">
			<tr>
				<td></td>
				<td><a href="javascript:;" class="fbtn fitem-orange fbtn-medium" id="user_registration_submit">Start Now</a></td>
			</tr>
		</table>
		<?php endif; ?>
		<?php if(!isset($_REQUEST['plan'])) : ?>
		...
		<div class="box mw-features">
			...
			<table width="100%">
				...
				<tr>
					...
					<td><p style="margin:-10px 0 30px;"><strong>Free</strong></p>
						<a href="javascript:;" class="fbtn fitem-orange fbtn-medium" id="user_registration_submit">Start Free</a></td>
				</tr>
			</table>
		</div>
		<?php endif; ?>
