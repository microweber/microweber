...
jQuery(document).ready(function($) {
	...
	if ( $('#footer-partners ul li').size() > 0 ) { var slider=jQuery("#footer-partners ul").bxSlider({infiniteLoop: true, pager: false, controls: true, auto: true, autoHover: true, speed: '200', pause:'3000',displaySlideQty: 5,moveSlideQty: 5 }); }
