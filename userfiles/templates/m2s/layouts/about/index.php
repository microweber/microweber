...
?>
<? include TEMPLATE_DIR. "header.php"; ?><div class="inner_container">
        <div class="inner_container_top"></div>
        <div class="inner_container_mid">
          <div class="inner_left">
            <ul>
              <li><a href="aboutus.html" class="current">About This Website</a></li>
              <li><a href="our_mission.html" >Our Mission</a></li>
              <li><a href="#" >Partners</a></li>
              <li><a href="#" >What the clients xays</a></li>
              <li><a href="#" >More Information</a> </li>
            </ul>
          </div>
          <div class="inner_rt">
            <div class="page_tit"> About Us </div>
            <div class="about_banner"><script language='JavaScript' type='text/javascript'>
<!--
