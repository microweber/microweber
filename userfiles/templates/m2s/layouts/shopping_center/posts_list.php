...
$cats =  get_categories($get_categories_params);
  ...
  <div class="each_cat_box">
    ...
    <div class="each_cat_box_rt">
	  ...
	  print character_limiter( $post['content_description'], 50 , "...")?></div>
...
<div class="money_inner_rt">
  <div class="money_sponsored_text"> Money2study is sponsored by: </div>
...
// p( $posts_sidebar);
  ...
  <div class="last10_box">
    ...
    <div class="money_sponsored_text2"> Money2study is sponsored by: </div>
