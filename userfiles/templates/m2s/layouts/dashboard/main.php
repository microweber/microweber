...
if(($hide_friends === undefined) || ($hide_friends == 'false') || ($hide_friends == 0)){
$hide_friends = false;	
}

if(($show_all_users === undefined) || ($show_all_users == 'false')|| ($show_all_users == 0)){
...
?>
  ...
  <form method="post" action="#" id="update-status">
    ...
    <a onclick="mw.users.User.statusUpdate('#update-status', function() {refesh_dashboard()});" class="xsubmit">Post</a> <small id="update-status-done" style="display:none">Status updated...</small>
 ...
 ?>
  ...
  <div class="whatis_tabs">
    ...
    <ul class="tabnav dash_tabs">
      ...
      <li class="dash_tab_1"><a href="javascript:refesh_dashboard(<? print $dashboard_user ?>); mark_active_dash_tab('.dash_tab_1')" >Dashboard</a></li>
  ...
  <?php  else : ?> 
      ...
      <li><a href="javascript:refesh_dashboard('<? print implode(',',  $subusers_ids) ?>',1);">My users</a></li>
      
      
        <? endif; ?>
         
        <li class="active dash_tab_2"><a href="javascript:refesh_dashboard(<? print $dashboard_user ?>,0,0,1);  mark_active_dash_tab('.dash_tab_2')"  >News feed</a></li>
