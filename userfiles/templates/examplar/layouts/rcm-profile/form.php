...
<small>Percentage of patients with specified payer</small>
    ...
    <tr>
      <td >Estimated number of claims filed in the last year</td>
      <td ><div class="field">
          <input type="text" class="required"  name="Estimated number of claims filed in the last year" />
          <span class="err">Please enter Estimated number of claims filed in the last year</span> </div></td>
    </tr>
    <tr>
      <td >Estimated insurance revenue in the last year </td>
      <td><div class="field">
          <input type="text" class="required"  name="Estimated insurance revenue in the last year" />
          <span class="err">Please enter  Estimated insurance revenue in the last year</span> </div></td>
    </tr>
    <tr>
