...
<div id="main">
  ...
  <div class="portlet portlet-closable">
    ...
    <div class="portlet-content">
      ...
      <table id="dataTable" class="data" cellpadding="0" cellspacing="0">
        ...
        <tbody>
          <tr class="odd">
            ...
            <td><img src="<?php print TEMPLATE_URL; ?>/cssjs/pencil.png" />&nbsp;&nbsp;<img src="<?php print TEMPLATE_URL; ?>/cssjs/cross.png" /></td>
          </tr>
          <tr class="even">
            <td>Mike Jones</td>
      ...
      <!-- End Table -->
      <div class="pg"> <span class="disabled">&laquo; Previous</span> &nbsp;&nbsp;<a  class="current"  href="javascript:;">1</a> &nbsp;&nbsp;<a  href="javascript:;">2</a> &nbsp;&nbsp;<a  href="javascript:;">3</a> &nbsp;&nbsp;<a  href="javascript:;">4</a> &nbsp;&nbsp;<a  href="javascript:;">5</a> &nbsp;&nbsp;<a  href="javascript:;">6</a> &nbsp;&nbsp;<a  href="javascript:;">7</a> &nbsp;&nbsp;<a  href="javascript:;">8</a> &nbsp;&nbsp;<a  href="javascript:;">9</a> &nbsp;&nbsp;<a  href="javascript:;">10</a> &nbsp;&nbsp;<a href="javascript:;">Next &raquo;</a> </div>
      <!-- .pg -->
    </div>
    <!-- .portlet-content -->
  </div>
  ...
  <div class="portlet portlet-closable">
    ...
    <!-- .portlet-header -->
    <div class="portlet-content">
      <p class="message message-info message-closable">Informative Message</p>
      <p class="message message-warning message-closable">Warning Message</p>
      <p class="message message-success message-closable">Success Message</p>
      <p class="message message-error message-closable">Error Message</p>
    </div>
    <!-- .portlet-content -->
  </div>
  <!-- .portlet -->
    ...
    <div class="portlet-content">
      <div id="inline-form" class="portlet-tab-content">
        <form action="#" method="post" class="form label-inline">
          ...
          <div class="controlset field"> <span class="label">Preferred Location</span>
          ...
          <div class="controlset field"> <span class="label">Something Else </span>
            <div class="controlset-pad">
              <input name="approved" id="check1" value="1" type="checkbox" />
              <label for="check1">Some Option 1</label>
              <br />
              <input name="pending" id="check2" value="1" type="checkbox" />
              <label for="check2">Some Option 2</label>
              <br />
              <input name="actives" id="check3" value="1" type="checkbox" />
              <label for="check3">Some Option 3</label>
              <br />
            </div>
          </div>
          <div class="buttonrow">
      ...
      <div id="ontop-form" class="portlet-tab-content hide">
        <form action="#" method="post" class="form label-top">
          <div class="field">
            ...
            <input id="fname2" name="fname2" size="50" type="text" class="medium"  />
          </div>
          <div class="field">
            <label for="lname2">Last Name </label>
            <input id="lname2" name="lname2" size="50" type="text" class="medium"  />
          </div>
          <div class="field">
            <label for="address12">Address 1 </label>
            <input id="address12" size="50" type="text" class="large"  />
          </div>
          <div class="field">
            <label for="telephone2">Telephone</label>
            <input id="telephone2" size="3" type="text" class="xsmall" />
            -
            <input size="3" type="text" class="xsmall" />
            -
            <input size="4" type="text" class="xsmall" />
          ...
          <div class="controlset field"> <span class="label">Preferred Location</span>
            <div>
              <input name="radio2" id="radio12" value="1" type="radio" />
              <label for="radio12">Option 1</label>
              <br />
              <input name="radio2" id="radio22" value="1" type="radio" />
              <label for="radio22">Option 2</label>
              <br />
              <input name="radio2" id="radio23" value="1" type="radio" />
              <label for="radio23">Option 3</label>
              <br />
            </div>
          </div>
          <div class="controlset field"> <span class="label">Something Else </span>
            <div>
              <input name="approved" id="check12" value="1" type="checkbox" />
              <label for="check12">Some Option 1</label>
              <br />
              <input name="pending" id="check22" value="1" type="checkbox" />
              <label for="check22">Some Option 2</label>
              <br />
              <input name="actives" id="check32" value="1" type="checkbox" />
              <label for="check32">Some Option 3</label>
              <br />
            </div>
          </div>
          <div class="buttonrow">
...
<div id="sidebar">
  ...
  <!-- End Comments Nav  -->
  <h3>Gallery</h3>
  <div id="gallery"> <a href="./images/lightbox/image1.jpg"><img src="<?php print TEMPLATE_URL; ?>/cssjs/thumb_image1.jpg" alt="Lightbox Image" /></a> <a href="./images/lightbox/image2.jpg"><img src="<?php print TEMPLATE_URL; ?>/cssjs/thumb_image2.jpg" alt="Lightbox Image"  /></a> <a href="./images/lightbox/image3.jpg"><img src="<?php print TEMPLATE_URL; ?>/cssjs/thumb_image3.jpg" alt="Lightbox Image"  /></a> <a href="./images/lightbox/image4.jpg"><img src="<?php print TEMPLATE_URL; ?>/cssjs/thumb_image4.jpg" alt="Lightbox Image"  /></a> <a href="./images/lightbox/image1.jpg"><img src="<?php print TEMPLATE_URL; ?>/cssjs/thumb_image1.jpg" alt="Lightbox Image"  /></a> <a href="./images/lightbox/image5.jpg"><img src="<?php print TEMPLATE_URL; ?>/cssjs/thumb_image5.jpg" alt="Lightbox Image"  /></a> </div>
  <!-- #gallery -->
</div>
<!-- #sidebar -->
<!-- #body -->
