...
<form method="post" action="#" id="form-reserve-hotels" class="rForm">
  ...
  <div id="vid-stai">
    ...
    <div class="item" id="room-1" style="display: block">
      ...
      <div class="xitem" style="width:240px">
        ...
        <div class="c">&nbsp;</div>
        <small> Тук можете да посочите Вашите специални изисквания; вида на стаята, ако тя не е стандартен тип; имената на други гости; възрастта на децата </small> </div>
    </div>
  ...
  <div class="item">
    <div class="xitem" style="width:125px">
      <label> <span>Дата на настаняване </span> </label>
      <span class="field">
  ...
  <div class="item">
    <div class="xitem" style="width:125px">
      <label> <span>Дата на напускане </span> </label>
      <span class="field">
      <input style="width: 125px;" type="text" class="datepick" />
      </span> </div>
  </div>
  <div class="item">
    <div class="xitem" style="width:125px">
      <label> <span>Брой нощувки</span> </label>
      <span class="field">
  ...
  */ ?>
    ...
    <div class="item">
      <div class="xitem" style="width:340px">
        <label> <span>Допълнителна информация</span> <small style="display: block;">(тук можете да посочите, ако имате други специални изисквания)</small> </label>
        <span class="field">
  ...
  <div class="item">
    <div class="xitem" style="width:140px">
      ...
      <ul style="width: 200px;">
        <li>
          <input type="radio" id="vbroi" name="NachinNaPlashtane" checked="checked" />
          В брой в офиса на фирмата</li>
        <li>
          <input type="radio" id="vbanka" name="NachinNaPlashtane" />
          По банков път</li>
        <li>
          <input type="radio" id="vkarta" name="NachinNaPlashtane" />
          С кредитна карта *</li>
      </ul>
      <div style="display: none" id="nachin-txt-vbroi"> София<br />
        ул. "Иван Вазов" 12А<br />
        (02) 981 09 56<br />
        (02) 981 09 63<br />
        <a href="mailto:yomex@yomexbg.com">yomex@yomexbg.com</a> </div>
      ...
      <div style="display: none" id="nachin-txt-vkarta"> <span class="kreditnikarti">&nbsp;</span>
        <p>Върху плащанията с кредитна карта се начислява банкова такса от 3%</p>
      </div>
      <div id="nachin-txt"> София<br />
        ул. "Иван Вазов" 12А<br />
        (02) 981 09 56<br />
        (02) 981 09 63<br />
        <a href="mailto:yomex@yomexbg.com">yomex@yomexbg.com</a> </div>
    ...
    <div class="c">&nbsp;</div>
    <div class="drugi richtext" style="padding: 5px 0;"> <strong style="display: block;padding: 5px 0 5px 0">Списък на придружителите</strong>
      <table id="drugi-table">
        <thead>
          <tr>
            <th>№</th>
            <th>Трите имена на латиница<br />
              (по паспорт/лична карта)</th>
            <th>ЕГН</th>
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><a href="javascript:;" onclick="deleteRow(this)"><u>Изтрий</u></a></td>
          </tr>
          <tr>
            <td>3.</td>
            <td><span class="field">
      ...
      <a href="javascript:;" onclick="newRow('drugi-table')">Добави <u>придружител</u></a> </div>
  </div>
  <?php /*
  <div class="item">
    <div class="xitem" style="width:140px">
  ...
  */ ?>
  ...
  <ul style="padding: 10px 0 0 17px;list-style: disc">
    <li><small>Чрез този формуляр Вие извършвате онлайн заявка за резервация на почивка.</small></li>
    <?php /*   <li><small>До 24 часа (в работни дни) ще получите информация по имейл за наличните места и статуса на екскурзията за посочената от Вас дата.</small></li>
  ...
  Modal.overlay();
    ...
    $("input[name='NachinNaPlashtane']").click(function(){
     ...
     setTimeout(function(){
      ...
      $(".rForm a.active").replaceWith("Дестинация: " + ahahtml + "<div style='padding-bottom:12px;' class='c'>&nbsp;</div>") ;
