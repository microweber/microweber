    ...
    <ul id="uictrl" class="stabs">
         ...
         <!-- <li><a href="javascript:;">Videos</a></li>-->
          <li><a href="javascript:;">Offer options</a></li>
           <li><a href="javascript:;">Dates</a></li>
...
<div id="side-content-wrapper">
    ...
    <div id="tabsobj" style="position: absolute;top:-10000px">
      <ul style="height: 34px;display: none !important">
          ...
          <li><a href="#uitab_dates">Dates</a></li>
          <li><a href="#uitab_meta">Meta tags</a></li>
      ...
      <?php require_once (TEMPLATE_DIR . 'admin/content/content_blocks/title_and_url_selector.php')  ?>

        <?php require_once (TEMPLATE_DIR . 'admin/content/content_blocks/text_and_desctiprion_editor.php')  ?>
        
        <?php require_once (TEMPLATE_DIR . 'admin/content/content_blocks/offer_description.php')  ?>
      </div>
      ...
      <div class="objtabs" id="uitab5"><?php require_once (TEMPLATE_DIR . 'admin/content/content_blocks/gallery.php')  ?></div>
      ...
      <div class="objtabs" id="uitab7"><?php require_once (TEMPLATE_DIR . 'admin/content/content_blocks/offer_options.php')  ?></div>
  <div class="objtabs" id="uitab_dates"><?php require_once (TEMPLATE_DIR . 'admin/content/content_blocks/dates.php')  ?></div>
 <div class="objtabs" id="uitab_meta"><?php require_once (TEMPLATE_DIR . 'admin/content/content_blocks/meta_tags.php')  ?></div>
