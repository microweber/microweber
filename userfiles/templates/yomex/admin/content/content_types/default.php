...
<div id="side-content-wrapper">
    ...
    <div id="tabsobj" style="position: absolute;top:-10000px">
      ...
      <div class="objtabs" id="uitab4"><?php require_once (TEMPLATE_DIR . 'admin/content/content_blocks/gallery.php')  ?></div>
      
      
           <div class="objtabs" id="uitab5"><?php require_once (TEMPLATE_DIR . 'admin/content/content_blocks/videos.php')  ?></div>
