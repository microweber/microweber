...
<form id="edit_categories_ajax_form" method="post" enctype="multipart/form-data" onsubmit="return false;">
  <div class="modal_edit_save"> <a href="javascript:;" onClick="edit_category_do_ajax_save(false)" class="btn"><span>Save</span></a> <a href="javascript:;" onClick="edit_category_do_ajax_save(true)" class="btn"><span>Save and close</span></a> </div>
    ...
    <tr>
      <td colspan="2"><div class="the_edit_categories_ajax_container_accordion">
          ...
          <div>
            ...
            <textarea name="content_body"  id="content_body" rows="5" cols="10"><?php print $form_values['content_body']; ?></textarea>
