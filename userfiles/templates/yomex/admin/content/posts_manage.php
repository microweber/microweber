...
for ($x = 1; $x <= $number; $x++) : ?>
              ...
              <tr>
                <td><label class="ico"><img src="<?php print_the_static_files_url() ; ?>/icons/eye.png" alt=" " border="0">Visible on site?</label>
                  <select name="visible_on_frontend">
                   <option value="">any</option>
                                  <option value="y"  <?php if($search_by_visible_on_frontend ==  'y') : ?> selected="selected" <?php endif; ?> >yes</option>
                                  <option value="n"  <?php if($search_by_visible_on_frontend ==  'n') : ?> selected="selected" <?php endif; ?> >no</option>
   ...
   ?>
            ...
            <a href="javascript:;" onclick="$('#searchengine').submit()" class="btn right" style="position: static">Search </a>
          ...
          <table class="tablesorter tables" id="sortedtable" cellspacing="0" cellpadding="0">
            ...
            <tbody id="the_content_items_container">
              ...
              <tr id="content_row_id_<?php print $item['id']; ?>">
                ...
                <td style="display: none"><?php print ($item['content_title']) ?> 
                ...
                <td class="visibleCell"><div class="cont_image" style="background-image: url('<?php print   $thumb = $this->content_model->contentGetThumbnailForContentId($item['id'], 150); ?>')"><a class="visit_post_link" href="<?php print $this->content_model->contentGetHrefForPostId($item['id']) ; ?>" target="_blank" >Visit</a></div>
                  ...
                  <div class="visibleCell_middle">
                    <h3><?php print ($item['content_title']) ?> <?php if($item['visible_on_frontend'] == 'n') : ?>
                <img src="<?php print_the_static_files_url() ; ?>/icons/monitor_delete.png" alt="Invisible on site" border="0"> 
                 <?php endif; ?></h3>
