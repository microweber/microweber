...
<br /><br />
        ...
        <div id="side-content">
          ...
          <form class="" id="searchengine" action="<?php print site_url('admin/content/posts_manage_do_search_by_keyword/'); ?>" method="post">
            ...
            <div style="display: none">
              ...
              <div class="d"></div>
              <label class="ico"><img src="<?php print_the_static_files_url() ; ?>/icons/star.png" alt=" " border="0">In Featured?</label>
              ...
              <div class="d"></div>
              <label class="ico"><img src="<?php print_the_static_files_url() ; ?>/icons/comment.png" alt=" " border="0">With comments? </label>
   ...
   ?>
              ...
              <div class="d"></div>
              <label class="ico"><img src="<?php print_the_static_files_url() ; ?>/icons/thumb_up.png" alt=" " border="0">Only voted</label>
              <select name="voted">
...
for ($x = 1; $x <= $number; $x++) : ?>
              ...
              <div class="d"></div>
              <label class="ico">Results per page</label>
