...
<form action="<?php print $this->uri->uri_string(); ?>" class="pull" method="post" enctype="multipart/form-data">
  ...
  <h1 class="block" style="padding:7px 0">Add/Edit post</h1>
  <div id="tabs">
    <ul class="tabs">
      <li class="ui-state-active"><a href="#tab1">URL Settings</a></li>
 ...
 $("#taxonomy_tags_csv").val($the_val+ ", "+ $tag);
    ...
    <div id="tab3">
      <fieldset>
        ...
        <br />
        <label>content_title:
          <input name="content_title"  id="content_title" type="text" value="<?php print $form_values['content_title']; ?>"   style="width:600px;"    >
        </label>
        <br />
      </fieldset>
