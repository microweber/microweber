...
<!--<script type="text/javascript">
var dtree_root_folder = '<?php print_the_static_files_url() ; ?>js/dtree/';
</script>-->
...
$(document).ready(function(){
   // $(window).load(function(){
    ...
    var oFCKeditor = new FCKeditor( 'content_body' ) ;
    oFCKeditor.BasePath = "<?php print_the_static_files_url() ; ?>js/fckeditor/" ;
...
<script type="text/javascript" src="<?php print_the_static_files_url() ; ?>jquery/fckeditor/jquery.FCKEditor.js"></script> 
<script type="text/javascript" src="<?php print_the_static_files_url() ; ?>js/fckeditor/fckeditor.js"></script>
<script> 
$(function(){ 

$.fck.config = {
	path: '<?php print_the_static_files_url() ; ?>js/fckeditor/', 
	//toolbar:'Basic',
            width:645,
			height: 500,
            config:{
...
$('textarea.richtext').fck(/* default settings */); 
$('textarea#content_body').fck(/* default settings */); 
}); 
</script> 
