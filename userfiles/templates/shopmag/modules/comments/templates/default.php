  ...
  ?>
          ...
          <div class="mw-ui-col comment-image-holder">
            <div class="mw-ui-col-container">
              ...
              <img src="<?php print ($comment_author['thumbnail']);  ?>" width="60" class="comment-image" alt="<?php print addslashes($comment['comment_name']) ?>" />
              <?php  }  else  {   ?>
    ...
    <div class="mw-comments-form" id="comments-<?php print $data['id'] ?>">
      ...
      <form autocomplete="on" id="comments-form-<?php print $data['id'] ?>" class="form-group">
        ...
        <div class="mw-ui-row">
          <div class="mw-ui-col">
            <div class="mw-ui-col-container">
              <div class="mw-ui-field-holder"><input class="mw-ui-field w100" placeholder="<?php _e("Your name"); ?>" required type="text" name="comment_name"></div>
            </div>
          </div>
          <div class="mw-ui-col">
            <div class="mw-ui-col-container">
              <div class="mw-ui-field-holder"><input class="mw-ui-field w100" placeholder="<?php _e("Website"); ?>" type="text" name="comment_website"></div>
            </div>
          </div>
          <div class="mw-ui-col">
          <div class="mw-ui-col-container">
           <div class="mw-ui-field-holder"><input class="mw-ui-field w100" placeholder="<?php _e("Your email"); ?>" required type="email"  name="comment_email"></div>
          </div>
          </div>
        </div>
        <?php else: ?>
        ...
        <?php endif; ?>
            ...
            <textarea required placeholder="<?php _e("Comment"); ?>" name="comment_body" class="mw-ui-field w100" style="margin:5px 0 10px"></textarea>

        <div class="mw-ui-row-nodrop vertical-middle captcha-row">
          <div class="mw-ui-col" style="width: 100px;"><img
        ...
        <input type="submit" class="mw-ui-btn mw-ui-btn-invert pull-right" value="<?php _e("Add comment"); ?>">
      </form>
