...
<?php
   ...
   // $settings = '{"0":{"primari":"22299"}}';
    ...
    $skins = scandir($config['path_to_module'] . 'skins');
        ...
        <ul class="magic-images-holder">
          ...
          <?php
            if(isset($slide['images'])) {
              ...
              if($image != ''){
            ?>
              <li><span class="bgimg" data-image="<?php print $image; ?>" style="background-image:url(<?php print $image; ?>);"></span><span class="mw-icon-close" onclick="deletemagicimage(event);"></span></li>
          <?php } } } } ?>
        </ul>
