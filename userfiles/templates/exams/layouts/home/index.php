  ...
  <div class="home_center_mid container_holder">
    <editable  rel="page" field="content_body">
      <div class="container">
        <div class="row">
          <div class="column">
            <div class="col" style="aazzz:448px;"> <img width="448"  height="322" src="<? print TEMPLATE_URL ?>img/ppl.png" /> </div>
            <div class="col" style="aazzz:100px;"> <br />
              <br />
              <br />
              <br />
              ...
              <br />
              <img    src="<? print TEMPLATE_URL ?>img/arr1.png" /> <br />
              <br />
              <br />
              <span style="color:#707070;font-size:12px;">Check out the new books. </span> </div>
            <div class="col" style="aazzz:300px;"> <img    src="<? print TEMPLATE_URL ?>img/book1.png" /> </div>
            <div class="col" style="aazzz:100px;"> <img    src="<? print TEMPLATE_URL ?>img/book2.png" /> <br />
              <br />
  ...
  <div class="home_center_mid container_holder">
    <editable  rel="page" field="custom_field_content_second">
      <div class="container">
        <div class="row">
          <div class="column">
            <div class="col" style="aazzz:448px;"> <img  src="<? print TEMPLATE_URL ?>img/book_big.png" /> </div>
            <div class="col" style="aazzz:520px;">
