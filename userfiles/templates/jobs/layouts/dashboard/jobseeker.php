...
<form action="#" method="post" enctype="multipart/form-data" id="edit-profile-form" class="form validate edit-profile-form xproform">
  ...
  <div class="role1">
    ...
    <div class="control-group">
      ...
      <div class="controls">
        <label> <b>Year certificatified:</b>
  ...
  <span class="field xright" style="margin-right: 50px;"> <a href="javascript:if($('#edit-profile-form')){save_user()};" ><img src="<? print TEMPLATE_URL ?>images/pwd_change_save_but_45.jpg" /></a> </span>
</form>
