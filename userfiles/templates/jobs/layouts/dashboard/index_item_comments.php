...
<div class="xcom_s"  id="<? print $form_id; ?>">
  <div >
    <form method="post" action="#" class="ajax_comment_form commentForm comment_form form" >
      <input type="hidden" name="to_table" value="<? print get_instance()->core_model->securityEncryptString($comment_to_table); ?>">
      <input type="hidden" name="to_table_id" value="<? print get_instance()->core_model->securityEncryptString($comment_to_id); ?>">
      <? if($display): ?>
