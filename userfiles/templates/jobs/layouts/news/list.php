...
<div class="body_part_inner">
  ...
  <? foreach($posts as $post): ?>
      ...
      <div class="news_blk">
      <div class="news_thumb"><a href="<? print post_link($post['id']) ?>"><img src="<? print TEMPLATE_URL ?>images/news_thumb_1.jpg" alt="news" /></a></div>
      <div class="news_content">
        <div class="news_head"><? print $post['content_title'] ?></div>
