...
<ul class="posts-list">
  <? foreach($posts['posts'] as $post): ?>
  <li itemscope itemtype="http://schema.org/Article" class="single-post"> <strong ><a  class="post-title"  href="<? print post_link($post['id']); ?>"  itemprop="name"><? print $post['title'] ?></a></strong>
    ...
    <p class="single-post-description" itemprop="description"><? print $post['description'];  ?></p>
