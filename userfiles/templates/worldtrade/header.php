...
<script type="text/javascript">
         ...
         <script type="text/javascript" src="<? print TEMPLATE_URL ?>js/dropdowns/msdropdown/js/jquery.dd.js"></script>
<link href="<? print TEMPLATE_URL ?>js/dropdowns/msdropdown/dd.css" rel="stylesheet" type="text/css" />
