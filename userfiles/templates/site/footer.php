...
<!-- TYXO -->
  ...
  <!--
  _d=document;
  _d.write('<a href="http://www.tyxo.bg/?146467" title="Tyxo.bg counter"><img width="1" height="1" border="0" alt="Tyxo.bg counter" src="'+location.protocol+'//cnt.tyxo.bg/146467?rnd='+Math.round(Math.random()*2147483647));
  _d.write('&sp='+screen.width+'x'+screen.height+'&r='+escape(_d.referrer)+'"></a>');
  //-->
