...
<div class="module-posts-template-sidebar">
  ...
  <?php foreach ($data as $item): ?>
            ...
            <?php if(!isset($show_fields) or $show_fields == false or in_array('thumbnail', $show_fields)): ?>
              <a href="<?php print $item['link'] ?>" class="pull-left sidebar-post-image" style="background-image: url(<?php print thumbnail($item['image'], 150, 150); ?> );">
              ...
              <div class="media-body extra-wrap">
               ...
               <?php endif; ?>
                ...
                <?php if(!isset($show_fields) or $show_fields == false or in_array('read_more', $show_fields)): ?>
                    <a href="<?php print $item['link'] ?>" class="btn btn-link btn-sm"><?php $read_more_text ? print $read_more_text : print _e('Continue Reading', true); ?></a>
                <?php  endif; ?>
               </div>
            </li>
  <?php endforeach; ?>
