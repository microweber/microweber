...
<div id="footer" class="container">
    <div class="mw-ui-row">
        <div class="mw-ui-col" id="copyright"><div class="edit"><p class="element">Copyright &copy; All rights reserved</p></div></div>
        <div class="mw-ui-col" id="footer-menu">
            <div class="edit"><module type="menu"  name="footer_menu" template="small" id="footer-menu"></div>
        </div>
