    ...
    $.fn.magnify = function(options){
        ...
        return this.each(function(){
            ...
            $sensor.css({
                ...
                left: $("#main_magnify").offset().left + "px",
                backgroundColor: '#fff',
                opacity: '0'
            });
            $sensor.mousemove(function(e){
                 fimg = $("#dio-lens img:first");
                //

                   $lens.css("left", parseInt(e.pageX - (settings.lensWidth * .5)) + "px");
                   $lens.css("top", parseInt(e.pageY - (settings.lensHeight * .5)) + "px");
                   $lens.show();
