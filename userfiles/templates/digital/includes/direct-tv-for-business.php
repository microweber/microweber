<div class="direction">
  <div class="wrapper">
    <div id="post-40" class="post-40 page type-page status-publish hentry"> <br />
      <br />
      <img src="<?php bloginfo('template_url') ?>/images/directv_top_text.png"  />
      <div class="c" style="height: 20px;">&nbsp;</div>
      <div class="b btrans">
        <div class="bt">&nbsp;</div>
        <div class="bm"> <img style="float:left;margin:-10px 0 0 -20px" src="<?php bloginfo('template_url') ?>/images/dtv_banner_top.png"  />
          <div class="c" style="padding-bottom: 20px;">&nbsp;</div>
          <img src="<?php bloginfo('template_url') ?>/images/bsf.jpg" />
          ...
          <div class="quote offer_ctrl_1 offer_ctrl"> <br />
            <p><img src="<?php bloginfo('template_url') ?>/images/quot1.jpg" /></p>
          ...
          <div class="quote offer_ctrl_2 offer_ctrl"> <br />
            <p><img src="<?php bloginfo('template_url') ?>/images/quot2.jpg" /></p>
          ...
          <div class="quote offer_ctrl_3 offer_ctrl"> <br />
            <p><img src="<?php bloginfo('template_url') ?>/images/quot3.jpg" /></p>
          ...
          <div class="quote offer_ctrl_4 offer_ctrl"> <br />
            <p><img src="<?php bloginfo('template_url') ?>/images/quot4.jpg" /></p>
          ...
          <div class="quote offer_ctrl_5 offer_ctrl"> <br />
            <p><img src="<?php bloginfo('template_url') ?>/images/quot5.jpg" /></p>
          ...
          <div class="quote offer_ctrl_6 offer_ctrl"> <br />
            <p><img src="<?php bloginfo('template_url') ?>/images/quot6.jpg" /></p>
          ...
          <div class="c">&nbsp;</div>
          <img src="<?php bloginfo('template_url') ?>/images/piis.jpg" /> <br />
          <br />
          <div class="c">&nbsp;</div>
          <div id="theform"> <br />
            <br />
          ...
          <div id="xtheform"> <img style="margin-left: -10px" src="<?php bloginfo('template_url') ?>/images/dtfbS.jpg" alt="" />
