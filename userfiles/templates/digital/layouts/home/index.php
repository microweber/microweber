          ...
          <div class="bm">
            <div id="slider">
              <div id="slider_holder">
                <div class="slide"><a href="<?php echo page_link(3478); ?>"><img border="0" src="<? print TEMPLATE_URL ?>images/hm.jpg" alt="" /></a></div>
                <div class="slide"><a href="<?php echo page_link(3479); ?>"><img border="0" src="<? print TEMPLATE_URL ?>images/banner_DIRECTV.jpg" alt="" /></a></div>
                <div class="slide"><a href="<?php echo page_link(3480); ?>"><img border="0" src="<? print TEMPLATE_URL ?>images/banner_DIRECTV_FOR_BUSINESS.jpg" alt="" /></a></div>
                <div class="slide"><a href="<?php echo page_link(3477); ?>"><img border="0" src="<? print TEMPLATE_URL ?>images/banner_Dish_network.jpg" alt="" /></a></div>
                <div class="slide"><a href="<?php echo page_link(3481); ?>"><img border="0" src="<? print TEMPLATE_URL ?>images/banner_WILD_BLUE_INTERNET.jpg" alt=""  /></a></div>
              </div>
            </div>
            <div id="ctrl"></div>
            ...
            <table cellpadding="0" cellspacing="0" id="xboxes">
              <tr>
                <td class="td1"><img src="<? print TEMPLATE_URL ?>images/td1.jpg"  />
                  ...
                  <ul>
                    <li><a href="<?php echo page_link(3479); ?>">DirecTV</a></li>
                    <li><a href="<?php echo page_link(3480); ?>">DirecTV For Business</a></li>
                    <li><a href="<?php echo page_link(3477); ?>">Dish Network</a></li>
                    <li><a href="<?php echo page_link(3478); ?>">Comcast / Xfinity</a></li>
                  </ul></td>
                <td class="td2"><img src="<? print TEMPLATE_URL ?>images/td2.jpg"  />
                  <h2>Internet</h2>
                  <p>Always be connected with high speed internet</p>
                  <ul>
                    <li><a href="<?php echo page_link(3481); ?>">Wild Blue Internet</a></li>
                    <li><a href="<?php echo page_link(3478); ?>">Xfinity Internet</a></li>
                  </ul></td>
