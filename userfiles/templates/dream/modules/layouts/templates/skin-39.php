    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-5 voh allow-drop">
                ...
                <p class="lead">
                    A multitude of colour and font options make Dream's look dynamic and adaptable.
                </p>
                <div class="feature feature-2 col-xs-6 col-sm-12 cloneable">
                    <div class="feature__title nodrop">
                        ...
                        <h6>Over 2,000 Icons</h6>
                    </div>
                    <p>
                        Dream includes the premium Icons Mind icon kit: A stunning collection of icons to suit multiple purposes.
                    </p>
                </div>
                <div class="feature feature-2 col-xs-6 col-sm-12 cloneable">
                    <div class="feature__title nodrop">
                        <i class="icon icon-Photo-2 safe-element"></i>
                        <h6>Beautiful Typography</h6>
                    </div>
                    <p>
