...
<section class="section--overlap safe-mode cta cta-8 variant-overlap-mrv nodrop edit <?php print $padding ?>" field="layout-skin-44-<?php print $params['id'] ?>" rel="module">
    <div class="container">
        <div class="row">
            <div class="col-md-5 col-sm-5 text-center voh">
                <module type="newsletter" template="skin-2"/>
            </div>
