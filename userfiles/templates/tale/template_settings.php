  ...
  <div class="mw-ui-row-nodrop">
    <div class="mw-ui-col">
        <div id="ts_bg_position" class="mw-dropdown mw-dropdown-type-wysiwyg">
          <span class="mw-dropdown-value">
              ...
              <span style="width: auto;display: block" class="mw-dropdown-val">Position</span>
          </span>
    ...
    <div class="mw-ui-col">
        <div title="Background Size" id="ts_bg_size" class="mw-dropdown mw-dropdown-type-wysiwyg"> <span class="mw-dropdown-value">
            <span class="mw-dropdown-arrow"></span> <span class="mw-dropdown-val" style="width: auto;display: block">Size</span> </span>
