...
<div class="fb-like-box" data-href="https://www.facebook.com/dbozhanov" data-width="292" data-show-faces="true" data-stream="true" data-header="true"></div>
    ...
    <br /> <div class="right_sidebar">
<center>
 <h4 class="post_title_small"> <a href="https://www.facebook.com/dbozhanov">Купи си книга</a></h4>
      <a href="<? print  post_link($post['id']); ?>"><img src="<? print TEMPLATE_URL ?>img/sep_2011_design_knigi.png"  border="0" /></a>
<a id="order3" href="http://coffee.massmediapublishing.com/order.php" title="Поръчай онлайн">Поръчай онлайн</a>
