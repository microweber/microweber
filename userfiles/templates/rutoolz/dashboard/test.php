...
<div onclick="Dashboard.getCounts(<?php echo $statuses_ids_json;?>, <?php echo $contents_ids_json;?>);">load voated and comments count</div>
	
	
<script>

//after vote/comment call Dashboard.getCounts to update wanted items
...
$(document).ready(function(){
	Dashboard.getCounts(<?php echo $statuses_ids_json;?>, <?php echo $contents_ids_json;?>);
});
