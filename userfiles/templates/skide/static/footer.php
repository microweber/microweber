          ...
          <div class="footer-content">
            ...
            <div class="footer-list">
                ...
                <ul>
                  ...
                  <li><a href="#">Find Skid-e-Teachers</a></li>
        ...
        <div id="addr">
            <div id="addr-content">
                 <address>&copy; <?php echo date('Y') ?> Skid-e-Kids Network. All Rights Reserved</address>
                 <span id="web-design">Created by <a href="http://ooyes.net" title="Website Design">ooYes.net</a></span>
            </div>
        </div>
	</body>
</html>