...
<div id="commentForm">
  <?php $table_content = base64_encode(CI::model('core')->securityEncryptString('table_content')); ?>
  <?php $table_id = base64_encode(CI::model('core')->securityEncryptString($post['id']));
