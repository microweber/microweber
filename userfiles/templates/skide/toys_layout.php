...
$(document).ready(function() {
  ...
  $(".content_search").onStopWriting(function(){
      ...
      <input type="text" default="Search toys"  class="content_search"  />
      ...
      <div id="main_side_content">
          ...
          <? include(TEMPLATE_DIR.'post_item_toy_inner.php')	; ?>
          <? else : ?>
          <h2>
            <? breadcrumbs('/') ?>
          </h2>
...
include(TEMPLATE_DIR.'post_item_toy.php')	;?>
          <? $i++; endforeach; ?>
          <br />
          <br />
          <? paging($display = 'divs') ?>
