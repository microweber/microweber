...
*/ ?>
          ...
          <microweber module="posts/add" title="Post your question" submit_btn_text="Post your question" category="questions" redirect_on_success="<? print page_link($page['id']); ?>" title_label="Question title: " body_label="Question: "></microweber>
          <? else:?>
          <div class="c">&nbsp;</div>
          ...
          <? if(empty($post)): ?>
          <div class="post_list">
            <microweber module="posts/list" category="<? print intval($questions['content_subtype_value']) ?>" display="questions_and_answers" ></microweber>
          </div>
          <? else : ?>
          <microweber module="posts/read" post_id="<? print intval($post['id']) ?>" display="read_questions_and_answers"></microweber>
          <? endif; ?>
          <? endif; ?>
          <? /*
        /Q & A END
