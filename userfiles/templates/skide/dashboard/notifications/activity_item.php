...
<?php $content_data = CI::model('content')->contentGetByIdAndCache ( $notification ['to_table_id'] );
$url = CI::model('content')->getContentURLByIdAndCache($notification ['to_table_id']);
 ?>
