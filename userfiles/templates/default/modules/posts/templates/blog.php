   ...
   <? if(!isset($show_fields) or $show_fields == false or in_array('title', $show_fields)): ?>
    ...
    <div class="blog-post-body">
     ...
     <? endif; ?>
          ...
          <? if(!isset($show_fields) or $show_fields == false or in_array('created_on', $show_fields)): ?><div class="post-meta">Date: <? print $item['created_on'] ?></div><? endif; ?>

     
     
      <!--        
-->
     <? if(!isset($show_fields) or $show_fields == false or in_array('description', $show_fields)): ?>  <p class="p0"><? print $item['description'] ?></p> <? endif; ?>
    </div>
    <? if(!isset($show_fields) or $show_fields == false or in_array('read_more', $show_fields)): ?>
    <div class="blog-post-footer"> <a href="<? print $item['link'] ?>" class="btn btn-success blog-fleft"><? $read_more_text ? print $read_more_text : print 'Continue Reading'; ?><i class="icon-chevron-right icon-white"></i></a>
