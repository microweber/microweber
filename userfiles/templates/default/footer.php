  ...
  <div class="container">
    ...
    <div id="footer-bottom">
        <div class="row">
            ...
            <div class="col-md-4"><span class="muted pull-right">Powered by <a class="muted" title="Free Website and Onine Shop" href="http://microweber.com" target="_blank">Microweber</a> (<a class="MW" href="http://microweber.com" title="Microweber - Drag and Drop Content Management System" target="_blank">MW</a>) <a title="Free Website, Blog and Onine Shop" href="http://microweber.com" target="_blank">Make Web</a></span></div>
        </div>
    </div>
  </div>
</div>
