              ...
              <div class="container">
                ...
                <div id = "main-nav-menu" class="nav-collapse nav-collapse_ collapse">
                  <ul class="nav sf-menu">
                    <li class="sub-menu"><a href="index.html"><span>Home <em> welcome page</em></span></a><em></em>
                      <ul>
                    ...
                    <li class="active sub-menu"><a href="#"><span>Elements <em> site elements</em></span></a><em></em>
                      <ul>
  ...
  <div class="row">
    <div class="span12">
      <div class="page-header1">
        <h2>Components<small><a href="#">Download Decision</a> or customize variables, components, javascript plugins, and more.</small></h2>
      </div>
  ...
  <div class="row">
    ...
    <div class="span9">
      ...
      <section id="dropdowns">
        ...
        <h2>Example</h2>
        <p>Toggleable, contextual menu for displaying lists of links. Made interactive with the <a href="javascript-2.html#dropdowns">dropdown javascript plugin</a>.</p>
...
&lt;/div&gt;
        ...
        <p>Button groups can also function as radios, where only one button may be active, or checkboxes, where any number of buttons may be active. View <a href="javascript-2.html#buttons">the Javascript docs</a> for that.</p>
      ...
      <section id="buttonDropdowns">
        ...
        <div class="bs-docs-example">
          <div class="btn-toolbar" style="margin: 0;">
            ...
            <!-- /btn-group -->
            <div class="btn-group">
              <button class="btn btn-success dropdown-toggle" data-toggle="dropdown">Info <span class="caret"></span></button>
              <ul class="dropdown-menu">
                <li><a href="#">Action</a></li>
                <li><a href="#">Another action</a></li>
                <li><a href="#">Something else here</a></li>
...
&lt;/div&gt;
        ...
        <p>Button dropdowns require the <a href="javascript-2.html#dropdowns">Bootstrap dropdown plugin</a> to function.</p>
...
&lt;/ul&gt;
        ...
        <hr class="bs-docs-separator">
        <h2>Dropdowns</h2>
        <p>Add dropdown menus with a little extra HTML and the <a href="javascript-2.html#dropdowns">dropdowns javascript plugin</a>.</p>
...
&lt;/ul&gt;
        ...
        <p> <span class="label label-info">Note</span> For nesting within a nav list, include <code>class="nav nav-list"</code> on any nested <code>&lt;ul&gt;</code>. </p>
...
&lt;/div&gt;
        ...
        <p>All tabbable tabs are powered by our lightweight jQuery plugin. Read more about how to bring tabbable tabs to life <a href="javascript-2.html#tabs">on the javascript docs page</a>.</p>
...
&lt;/div&gt;
        ...
        <div class="bs-docs-example">
          <div class="navbar">
            <div class="navbar-inner"> <a class="brand" href="#">Title</a> </div>
          </div>
        </div>
        <pre class="prettyprint linenums">
...
&lt;/form&gt;
        ...
        <p>Add dropdowns and dropups to the nav with a bit of markup and the <a href="javascript-2.html#dropdowns">dropdowns javascript plugin</a>.</p>
        <pre class="prettyprint linenums">
&lt;ul class="nav"&gt;
  &lt;li class="dropdown"&gt;
...
&lt;/ul&gt;
        ...
        <p>Visit the <a href="javascript-2.html#dropdowns">javascript dropdowns documentation</a> for more markup and information on calling dropdowns.</p>
        <h3>Text</h3>
        ...
        <div class="bs-docs-example bs-navbar-top-example">
          <div class="navbar navbar-fixed-top" style="position: absolute;">
            <div class="navbar-inner">
              <div class="container" style="width: auto; padding: 0 20px;"> <a class="brand" href="#">Title</a>
                <ul class="nav">
                  <li class="active"><a href="#">Home</a></li>
                  <li><a href="#">Link</a></li>
                  <li><a href="#">Link</a></li>
...
&lt;/div&gt;
        ...
        <div class="bs-docs-example">
          <div class="navbar">
            <div class="navbar-inner">
              <div class="container"> <a class="btn btn-navbar" data-toggle="collapse" data-target=".nav-collapse"> <span class="icon-bar"></span> <span class="icon-bar"></span> <span class="icon-bar"></span> </a> <a class="brand" href="#">Title</a>
...
&lt;/div&gt;
        ...
        <div class="alert alert-info"> <strong>Heads up!</strong> The responsive navbar requires the <a href="javascript-2.html#collapse">collapse plugin</a> and <a href="scaffolding.html#responsive">responsive Bootstrap CSS file</a>. </div>
        <hr class="bs-docs-separator">
        ...
        <div class="bs-docs-example">
          <div class="navbar navbar-inverse" style="position: static;">
            <div class="navbar-inner">
              <div class="container"> <a class="btn btn-navbar" data-toggle="collapse" data-target=".subnav-collapse"> <span class="icon-bar"></span> <span class="icon-bar"></span> <span class="icon-bar"></span> </a> <a class="brand" href="#">Title</a>
...
&lt;/div&gt;
      ...
      <section id="thumbnails">
        ...
        <div class="row-fluid">
          <ul class="thumbnails">
            <li class="span4">
              <div class="thumbnail"> <img src="http://placehold.it/300x200" alt="">
                <div class="caption">
...
&lt;/div&gt;
        ...
        <p>Use the <a href="javascript-2.html#alerts">alerts jQuery plugin</a> for quick and easy dismissal of alerts.</p>
        <hr class="bs-docs-separator">
        <h2>Options</h2>
...
<footer>
  ...
  <div class="footer-2">
    <div class="container">
      <div class="row">
        <div class="span12">Decision &copy; 2012 <a href="#">Privacy Policy</a></div>
      </div>
    </div>
  </div>
</footer>
