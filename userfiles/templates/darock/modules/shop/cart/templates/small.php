...
<a class="mw-ui-row-nodrop cart-small-checkout-link" href="<?php print checkout_url(); ?>">
    ...
    <span class="mw-ui-col"><span class="mw-cart-small-order-info"><strong><?php print $total_qty; ?></strong><span class="smallcartdelimiter">|</span><span class="mw-cart-small-order-info-total"><?php print currency_format($total_price); ?></span></span></span>
    <?php
