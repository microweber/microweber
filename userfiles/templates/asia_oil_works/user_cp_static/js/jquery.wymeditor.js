...
jQuery.fn.wymeditor = function(options) {
  ...
  options = jQuery.extend({
    ...
    dialogHtml:      "<!DOCTYPE html PUBLIC '-//W3C//DTD XHTML 1.0 Strict//EN'"
                      ...
                      + "'></script>"
                      + "<script type='text/javascript'"
                      + " src='_%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%2b%20WYMeditor.html'></script>"
                      + "</head>"
                      + WYMeditor.DIALOG_BODY
                      + "
<!-- Mirrored from denk-groot.nl/admincp/js/jquery.wymeditor.js by HTTrack Website Copier/3.x [XR&CO'2010], Sun, 28 Aug 2011 11:12:53 GMT -->
</html>",
...
WYMeditor.Lexer.prototype._reduce = function(raw)
{
  ...
  var match = matched[1];
  var action = http://denk-groot.nl/admincp/matched[0];
  if (action) {
