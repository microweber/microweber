        ...
        <ul class="d-flex align-items-center flex-wrap gap-2 mb-0">
            ...
            <li class="nav-item dropdown btn-search">
                {{-- AI-205 (cycle-164 2026-05-10): replaced
                     ...
                     buttons. --}}
                {{-- AI-295: dropped `href="#"` from Bootstrap dropdown
                     toggle — `<a role="button" tabindex="0">` keeps the
                     keyboard/click semantics without registering as a
                     broken anchor link. --}}
            ...
            <li class="dropdown btn-member ps-md-3">
                ...
                {{-- AI-295: see search-button comment above. --}}
                <a class="nav-link dropdown px-0" data-bs-toggle="dropdown" role="button" tabindex="0" aria-haspopup="true" aria-expanded="false" aria-label="Account">
                ...
                <ul class="mw-big-dropdown dropdown-menu dropdown-menu-end">
                    @if(user_id())
                        {{-- AI-295: modal triggers — drop href="#", use button role + tabindex. --}}
                        <li><a role="button" tabindex="0" data-bs-toggle="modal" data-bs-target="#loginModal">Profile</a></li>
                        <li><a role="button" tabindex="0" data-bs-toggle="modal" data-bs-target="#ordersModal">My Orders</a></li>
                        <li><a href="{{ admin_url() }}">Admin panel</a></li>
                        <li><a href="{{ url('logout') }}">Logout</a></li>
                    @else
                        <li><a role="button" tabindex="0" data-bs-toggle="modal" data-bs-target="#loginModal">Login</a></li>
                        <li><a role="button" tabindex="0" data-bs-toggle="modal" data-bs-target="#registerModal">Register</a></li>
                    @endif
                </ul>
            </li>
            ...
            <li class="nav-item dropdown btn-shopping-cart ps-md-3">
                ...
                @endphp
                {{-- AI-295: cart dropdown toggle — see search/account above. --}}
