...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('templates/big2/dist/build/app.css') }}">
    ...
    {{--
        ...
        (Big2, Big1, etc.) inherited Bootstrap's general 44h rules via
        main.scss compilation but did NOT get the public-touch.css
        rules. Tester confirmed at 390×844 that the Big2 active-site
...
{{--        <link rel="stylesheet" href="{{ asset('templates/big2/dist/build/app-rtl.css') }}">--}}
{{--    @endif--}}
    <script>
...
{{-- TICKET-D2 (audit-test reply 2026-05-06): WCAG 2.4.1 Bypass Blocks.
     First focusable element on every public Big2 page; jumps past the
...
<script src="{{ asset('templates/big2/dist/build/app.js') }}"></script>
