...
<section class="section {{ $layout_classes }} ">
    ...
    <div class="mw-layout-container no-element container edit safe-mode" field="layout-price-lists-skin-3-{{ $params['id'] }}" rel="module">
        <div class="row ">
            ...
            <div class="col-12 col-sm-10 col-lg-6 mx-auto cloneable element safe-mode ">
                <div class="ps-lg-5 text-lg-start pb-5  ">
                    <img loading="lazy" src="{{ asset('templates/big/img/layouts/coffee.jpg') }}" alt=""/>
                </div>
            </div>
        </div>
    </div>
