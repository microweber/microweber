...
<section class="section {{ $layout_classes }} ">
    ...
    <div class="mw-layout-container no-element container-fluid edit safe-mode" field="layout-feature-skin-22-{{ $params['id'] }}" rel="module">
            ...
            <div class="col-12 col-sm-10 col-lg-6 mx-auto text-center text-sm-start d-flex align-items-center cloneable element">
                <div class="mw-layout-container no-element container-fluid-right-col-in-mw-layout-container no-element container">
                    <div class="ps-lg-5">
                        ...
                        <div class="row py-4 text-center text-sm-start d-flex justify-content-center justify-content-lg-between">
