...
<section class="section {{ $layout_classes }} ">
    ...
    <div class="mw-layout-container no-element container-fluid edit" field="layout-feature-skin-61-{{ $params['id'] }}" rel="module">
        <div class="row ">
            <h2 data-mwplaceholder="{{ _e('Enter title here') }}" class="text-center mb-5">SERVICES</h2>

            <div class="col-xl-10 d-flex justify-content-center mx-auto text-center text-lg-start flex-wrap">
                <div class="col-12 col-xl-6 cloneable element safe-mode background-color-element p-3">
