...
<section class="section {{ $layout_classes }} ">
    ...
    <div class="mw-layout-container no-element container edit safe-mode" field="layout-feature-skin-27-{{ $params['id'] }}" rel="module">
