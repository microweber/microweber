...
<section class="section {{ $layout_classes ?? '' }} ">
    ...
    <div class="container-fluid mw-layout-container safe-mode no-element safe-mode  edit" field="layout-content-skin-74-{{ $params['id'] }}" rel="module">
        <div class="row col-12 d-xl-flex mx-auto cloneable element safe-mode background-color-element safe-mode">
