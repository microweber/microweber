...
<section class="section {{ $layout_classes }} ">
    ...
    <div class="container-fluid mw-layout-container safe-mode no-element   edit " field="layout-content-skin-3-mirror-{{ $params['id'] }}" rel="module">
        <div class="row safe-mode nodrop no-select">
            <div class="col-12 col-lg-6 px-md-5 cloneable element background-color-element  safe-mode allow-select allow-drop" style="min-height:50px">
