...
name: Content 49 - full width

position: 49 - full width
...
<section class="section {{ $layout_classes }} ">
    ...
    <div class="mw-layout-container safe-mode no-element   edit" field="layout-content-skin-49-full-width-{{ $params['id'] }}" rel="module">
