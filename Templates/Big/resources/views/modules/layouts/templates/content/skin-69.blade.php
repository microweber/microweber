...
<section class="section   {{ $layout_classes }} ">
    ...
    <div class="container mw-layout-container safe-mode no-element   edit" field="layout-content-skin-content-69-{{ $params['id'] }}" rel="module">
        <div id="layout-content-skin-content-69-{{ $params['id'] }}-container">
            <div class="row cloneable element background-color-element safe-mode px-0 no-drag nodrop">
            ...
            <div class="row cloneable element background-color-element safe-mode px-0 allow-select">
                <div class="col-12 col-lg-6  element allow-drop" style="min-height:50px">
