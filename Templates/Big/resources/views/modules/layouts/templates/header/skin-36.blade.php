...
<section class="section mw-header-36-hero d-flex justify-content-center align-items-center mw-header-section-mh-100vh" id="section_1">
    ...
    <div class="container mw-layout-container" style="z-index: 3;">
        <div class="row edit  no-element" field="layout-header-skin-36-{{ $params['id'] ?? '' }}" rel="module">
