...
<x-layout-section
    ...
    field-name="layout-header-skin-27"
    default-padding-top="pt-5"
    container-class="mw-layout-container py-4 no-element d-flex align-items-center mw-big-skin-3-background no-element edit"
>
