...
<div class="mw-custom-field-group">
  ...
  <? print $data["custom_field_value"]; ?>
    <input type="hidden"   <? if (trim($data['custom_field_required']) == 'y'): ?> required="true"  <? endif; ?>  data-custom-field-id="<? print $data["id"]; ?>"  name="<? print $data["custom_field_type"]; ?>" id="custom_field_help_text{rand}" value="<? print $data["custom_field_value"]; ?>">
