...
<div class="mw-custom-field-group mw-custom-field-group-checkbox custom-field-preview"> <span class="mw-custom-field-label" for="custom_field_help_text{rand}"><? print $data["custom_field_name"]; ?></span>
