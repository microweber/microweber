...
if ($query [0] == $table_name) {
	...
	$fields_to_add [] = array ('job_title', "TEXT default NULL" );
	$fields_to_add [] = array ('job_description', 'TEXT default NULL' );
	$fields_to_add [] = array ('job_src', 'TEXT default NULL' );
	$fields_to_add [] = array ('job_link', "varchar(1500) default NULL" );
	$fields_to_add [] = array ('job_hash', "TEXT default NULL" );
	$fields_to_add [] = array ('job_priority', 'int(11) default 1' );
	$fields_to_add [] = array ('job_email', "varchar(1500) default NULL" );
	$fields_to_add [] = array ('job_name', "varchar(1500) default NULL" );
	$fields_to_add [] = array ('job_pub_date', 'datetime default NULL' );
	$fields_to_add [] = array ('job_mailsent_date', 'datetime default NULL' );
	$fields_to_add [] = array ('for_download', 'int(1) default 0' );
