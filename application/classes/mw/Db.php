...
class Db
{
        ...
        switch ($mode) {
            case 1 :
                ...
                if (isset($results_map[$criteria_id])) {
                    ...
                    $results_map[$criteria_id] = $get_data;
     ...
     * @subpackage Advanced
     */
    static function get_by_id($table, $id = 0, $field_name = 'id')
    {
     ...
     * @package Database
     */
    static function save($table, $data, $data_to_save_options = false)
    {
...
//d($from_save_cats);
     ...
     *
     */
    static function query($q, $cache_id = false, $cache_group = 'global', $only_query = false, $connection_settigns = false)
    {
        if (trim($q) == '') {
            return false;
        }
        ...
        $dbtype_file = MW_DB_ADAPTER_DIR . $dbtype . '.php';
     ...
     *
     */
    static function q($q, $connection_settigns = false)
    {
     ...
     * </code>
     */
   static function map_array_to_table($table, $array)
    {
     ...
     * @see get
     */
    static function get_long($table = false, $criteria = false, $limit = false, $offset = false, $orderby = false, $cache_group = false, $debug = false, $ids = false, $count_only = false, $only_those_fields = false, $exclude_ids = false, $force_cache_id = false, $get_only_whats_requested_without_additional_stuff = false)
    {
     ...
     * @package Database
     */
    static function delete_by_id($table, $id = 0, $field_name = 'id')
    {
    ...
    static function get_fields($table, $exclude_fields = false)
    {
