...
/*FCKConfig.ToolbarSets["Default"] = [
	...
	['insertHtmlCode','GeSHiPro','Form','Checkbox','Radio','TextField','Textarea','Select','Button','ImageButton','HiddenField'],
	'/',
...
FCKConfig.ToolbarSets["Default"] = [
	['Bold','Italic','-','OrderedList','UnorderedList','-','insertHtmlCode','-','Link','Unlink','Anchor','-','Cut','Copy','Paste','PasteText','PasteWord','-','SpellCheck']
] ;
...
//alert(FCKEditorPath);
// alert(FCKConfig.BasePath + 'speller/server-scripts/spellchecker.php');
