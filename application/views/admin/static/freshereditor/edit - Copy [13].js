...
function init_sortables(){
	...
	var place1 = $('<div class="empty ui-state-highlight2" style="display:none;"><span>Please drag items here</span></div>');			
  ...
  $(".column", '.edit').each(function (c) {
   ...
   // items: '.row:not(.disabled),.col',
	 items: '.col,li.module-item,.row>.column>.row,.row, .empty, .ui-state-highlight2',
	 dropOnEmpty:true,
