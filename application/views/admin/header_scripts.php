...
<link rel="stylesheet" href="<?php   print( ADMIN_STATIC_FILES_URL);  ?>css/style.css" type="text/css"    />
...
<script type="text/javascript" src="<?php   print( ADMIN_STATIC_FILES_URL);  ?>js/jquery.scrollTo-min.js"></script>
<!--<script type="text/javascript" src="<?php   print( ADMIN_STATIC_FILES_URL);  ?>js/jquery.formbuilder.js"></script> -->
<script type="text/javascript">
 function posts_search_box($kw, $category_id){
