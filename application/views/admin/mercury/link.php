        ...
        <ol>
          <li id="link_external_url_input" class="string input optional stringish">
            <label class="label" for="link_external_url">
              ...
              URL</label>
            <input class="selectable mw_finder" id="link_external_url"  name="link[external_url]" type="text"/>
             <div class="mw_finder_list"></div>
 
                        <a style="float:right; margin-right:10px;" class="button filebrowser" href="javascript:parent.openKCFinder('#link_external_url');" >File browser</a>
  ...
  <!--        <li id="link_existing_bookmark_input" class="select input optional">
            ...
            <option>addfgdfgdfgdfgdfgfdgdfgfdgdfgfdasd</option>
            </select>
          </li>-->
      ...
      <fieldset class="inputs">
        ...
        <ol>
          <li id="link_external_url_input" class="string input optional stringish">
            <label class="label" for="link_class">
               CSS Class</label>
            <input class="selectable" id="link_class" name="link[link_class]" type="text"/>
