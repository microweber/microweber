  ...
  <div class="mercury-modal-pane-container">
    <div class="mercury-modal-pane">
      <fieldset class="inputs">
        ...
        <ol> <!-- <li id="link_external_url_input" class="string input optional stringish">
            <label class="label" for="link_external_url">
              
             Link URL</label>
            <input class="selectable mw_finder" id="link_external_url"  name="media[external_url]" type="text"/>
          ...
          <li id="media_image_url_input" class="string input optional stringish">
            <label class="label" for="media_image_url">
              <input name="media_type" id="image_url" type="radio" value="image_url" checked="checked"/>
             Media path</label>
