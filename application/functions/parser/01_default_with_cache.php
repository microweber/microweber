...
$function_cache_id_parser = false;

$function_cache_id_parser = __FUNCTION__ . crc32($layout);

$cache_group_parser = 'parser/global';

$cache_content_parser = cache_get_content($function_cache_id_parser, $cache_group_parser);

if (($cache_content_parser) != false) {
	$layout = $cache_content_parser;
	...
	$layout = $pq -> htmlOuter();
	cache_store_data($layout, $function_cache_id_parser, $cache_group_parser);
