<x-filament-panels::page>
    <div class="w-full min-h-screen flex items-center justify-center">
        <div class="bg-white dark:bg-[#1f2937] shadow-2xl rounded-2xl p-10 max-w-sm text-center">
            ...
            <p class="text-gray-600 dark:text-gray-400">Your purchase was successful.</p>

            <div class="mt-6">
                <a href="{{ route('filament.billing.home') }}"
                   class="inline-block px-6 py-2 bg-green-500 hover:bg-green-500 text-white text-sm font-medium rounded-lg transition-all duration-300">
                    Go to Dashboard
                </a>
            </div>
        </div>
