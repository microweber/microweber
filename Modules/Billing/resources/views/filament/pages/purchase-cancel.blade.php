<x-filament-panels::page>
    <div class="w-full min-h-screen flex items-center justify-center">
        <div class="bg-white dark:bg-[#1f2937] shadow-2xl rounded-2xl p-10 max-w-sm text-center">
            ...
            <h1 class="text-2xl font-bold text-red-700 dark:text-white mb-2">Purchase Cancelled</h1>
            <p class="text-gray-600 dark:text-gray-400">Your purchase was cancelled.</p>
