    ...
    <div class="w-full min-h-[60vh] flex items-center justify-center">
        ...
        @else
            <div class="bg-white dark:bg-[#1f2937] shadow-2xl rounded-2xl p-8 max-w-lg w-full">
                ...
                <p class="text-gray-600 dark:text-gray-400 text-center mb-6">Your subscription was successful.</p>
                        ...
                        <div class="space-y-3">
                            @if(isset($subscription['plan_name']))
                                <div class="flex justify-between">
                                    ...
                                    <span class="font-medium text-gray-800 dark:text-white">{{ $subscription['plan_name'] }}</span>
                                </div>
                            @endif
                            ...
                            @if(isset($subscription['current_period_end']))
                                <div class="flex justify-between">
                                    <span class="text-gray-600 dark:text-gray-400">Current Period Ends:</span>
                                    <span class="font-medium text-gray-800 dark:text-white">
                                        {{ \Carbon\Carbon::createFromTimestamp($subscription['current_period_end'])->toFormattedDateString() }}
                                    </span>
                                </div>
                            @endif
                        </div>
