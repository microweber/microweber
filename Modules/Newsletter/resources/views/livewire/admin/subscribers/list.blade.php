<div>
    ...
    <div class="mb-3 d-flex gap-3">
        <div>
            <div>Keyword</div>
            <input type="text" class="form-control" placeholder="Search..." wire:model.live.debounce.500ms="keyword" />
        </div>
        <div style="width:300px">
            <div>List</div>
            <select class="form-control" wire:model.live.debounce.500ms="listId">
    ...
    <div class="table-responsive">
        <table class="table table-hover table-striped">
            ...
            <tr>
                <td>
                    <input type="checkbox" wire:model.live.debounce.500ms="checked" value="<?php print $subscriber['id']; ?>" />
                </td>
