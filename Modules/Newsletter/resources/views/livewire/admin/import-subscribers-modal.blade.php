    ...
    @if(!empty($this->importDone))
        <div class="mt-4 px-1 pb-5">
            ...
            <div class="alert alert-success">
                ...
                <div>
                    <button type="button" class="btn btn-outline-success" @click="$dispatch('closeModal', true)">
                        Back to Newsletter
                    </button>
                </div>
            </div>
        ...
        <div class="mx-auto col-md-10">
            <div>
                ...
                <div class="input-group mb-3">
                    ...
                    <select class="form-select" wire:model.live.debounce.500ms="importSubscribers.sourceType">
                        ...
                        @else
                            ...
                            <div>
                                <div>
                                    ...
                                    <select wire:model.live.debounce.500ms="list_id" class="form-control">
