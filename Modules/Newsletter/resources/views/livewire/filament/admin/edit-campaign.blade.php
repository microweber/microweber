<div>
    <div class="text-center my-8">
        <div x-data="editCampaignTitle()" class="flex items-center justify-center p-4 m-auto">
            ...
            <input wire:model.live.debounce.500ms="state.name" type="text" x-model="text" x-show="isEditing" @click.away="toggleEditingState" @keydown.enter="disableEditing" @keydown.window.escape="disableEditing"
