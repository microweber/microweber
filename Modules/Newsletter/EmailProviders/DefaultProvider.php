...
class DefaultProvider
{
    ...
    protected $listUnsubscribeLink = null;

    public function getListUnsubscribeLink()
    {
        return $this->listUnsubscribeLink;
    }

    public function setListUnsubscribeLink($listUnsubscribeLink): void
    {
        $this->listUnsubscribeLink = $listUnsubscribeLink;
    }
    ...
    protected function sendToEmail()
    {
        ...
        Mail::raw($this->getBody(), function ($message) {
            ...
            if ($listUnsubscribeLink) {
                $message->getHeaders()->addTextHeader('List-Unsubscribe', '<' . $listUnsubscribeLink . '>');
            }
        });
