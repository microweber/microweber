        ...
        <div class="col-sm-6 col-md-4 col-lg-4 mb-8">
            <div class="d-block position-relative show-on-hover-root">
                ...
                <div class="img-as-background square">
                    <img loading="lazy" src="<?php print thumbnail($member['file'], 800); ?>" alt="<?php echo $member['name'] ?? __('Team member'); ?>"/>
                </div>
                <?php } else { ?>
                <div class="img-as-background square">
                    <img loading="lazy" src="<?php print asset('modules/teamcard/default-content/default-image.svg'); ?>" alt="<?php echo $member['name'] ?? __('Team member'); ?>"/>
                </div>
                <?php } ?>
