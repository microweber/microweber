<div class="row mb-4">
    ...
    <div class="col-xl-6 col-lg-7 d-block d-sm-flex justify-content-end ms-auto">
        <div class="col-md-6 col-12 col-sm px-1 ms-auto">
            <select wire:model.live.debounce.500ms="limit" class="form-select">
        ...
        <div class="col-md-6 col-12 col-sm px-1 ms-auto">
            <select wire:model.live.debounce.500ms="sortBy" class="form-select">
                <option value="created_at">{{ _e('Sort by date') }}</option>
                <option value="title">{{ _e('Sort by title') }}</option>
            </select>
        </div>
        <div class="col-md-6 col-12 col-sm px-1 ms-auto">
            <select wire:model.live.debounce.500ms="sortOrder" class="form-select">
