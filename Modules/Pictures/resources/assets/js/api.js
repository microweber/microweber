...
;(function(){
    ...
    const safeFilename = url => {
        ...
        return url.replace(/["]/g, "%22").replace(/[']/g, "%27").replace(/\(/g, "%28").replace(/\)/g, "%29");

    }

    const urlAsBackground = function(url, el){
              ...
              if(mode == 'numbers'){
                ...
                if(!reflection){
                    ...
                    for( ; i<l; i++){
                      ...
                      urlAsBackground(items[i].getElementsByTagName('img')[0].src, a);
