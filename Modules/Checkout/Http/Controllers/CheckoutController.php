...
class CheckoutController extends Controller {
    ...
    public function login() {
        ...
        return $this->_renderView('modules.checkout::login');
    }
    ...
    public function forgotPassword() {
        ...
        return $this->_renderView('modules.checkout::forgot_password');
    }
    ...
    public function register() {
        ...
        return $this->_renderView('modules.checkout::register');
    }

    public function index() {

        return redirect(route('checkout.contact_information'));
        //return $this->_renderView('modules.checkout::index');
    }
    ...
    public function finish($id) {
        ...
        return $this->_renderView('modules.checkout::finish', ['order'=>[
            'id'=>$findOrder->id
        ]]);
    }
