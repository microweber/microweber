...
<style>
    ...
    .blog-posts-21 .post-21:hover::after {
        width: 100%;
    }

    .blog-posts-21 .img-as-background img {
   ...
   @else
        @foreach ($data as $item)
            ...
            @if($categories)
                ...
                @endforeach
            @endif
            <div class="position-relative mx-auto mx-md-0 col-sm-10 col-md-6 col-lg-4 mb-5" itemscope itemtype="{{ $schema_org_item_type_tag }}">
                <div class="h-100 d-flex flex-column post-21">
