...
<div class="mw-flex-row">
    <div class="mw-flex-col-xs-4 ">
        <div class="mw-ui-field-holder">
            ...
            <select name="columns-xs" class="mw-ui-field mw_option_field mw-full-width" data-option-group="{{ $params['id'] }}" data-columns="xs">
    ...
    <div class="mw-flex-col-xs-4 ">
        <div class="mw-ui-field-holder">
            ...
            <select name="columns-sm" class="mw-ui-field mw_option_field mw-full-width" data-option-group="{{ $params['id'] }}" data-columns="sm">
    ...
    <div class="mw-flex-col-xs-4 ">
        <div class="mw-ui-field-holder">
            ...
            <select name="columns-md" class="mw-ui-field mw_option_field mw-full-width" data-option-group="{{ $params['id'] }}" data-columns="md">
    ...
    <div class="mw-flex-col-xs-4 ">
        <div class="mw-ui-field-holder">
            ...
            <select name="columns-lg" class="mw-ui-field mw_option_field mw-full-width" data-option-group="{{ $params['id'] }}" data-columns="lg">
    ...
    <div class="mw-flex-col-xs-4 ">
        <div class="mw-ui-field-holder">
            ...
            <select name="columns-lg" class="mw-ui-field mw_option_field mw-full-width" data-option-group="{{ $params['id'] }}" data-columns="xl">
    ...
    <div class="mw-flex-col-xs-4 ">
        <div class="mw-ui-field-holder">
            ...
            <input name="custom-classes" class="mw-ui-field mw_option_field mw-full-width" data-option-group="{{ $params['id'] }}" value="<?php print $custom_classes; ?>" data-classes=""/>
        </div>
    </div>
</div>
...
<div class="mw-flex-row hidden">
    <div class="mw-flex-col-xs-12 ">
        <div class="mw-ui-field-holder">
            ...
            <input name="columns" class="mw-ui-field mw_option_field mw-full-width" data-option-group="{{ $params['id'] }}" value="<?php print $columns; ?>"/>
        </div>
    </div>
</div>
