                ...
                <div class="   overflow-hidden h-100 d-flex flex-column bg-body hover-  ">
                    <a href="<?php print $item['link'] ?>" class="d-block position-relative">
                        ...
                        <?php if (!isset($show_fields) or $show_fields == false or in_array('description', $show_fields)): ?>
                            <div class="img-as-background square-75" itemprop="image" itemscope itemtype="http://schema.org/ImageObject">
                                <img loading="lazy" src="<?php print $item['image']; ?>" itemprop="url" alt="<?php print $item['title'] ?>" />
                    ...
                    <div class="d-flex flex-column h-100 px-md-0 px-2 pt-3 pb-5">
                        ...
                        <?php if (!isset($show_fields) or $show_fields == false or in_array('title', $show_fields)): ?>
                            <a href="<?php print $item['link'] ?>" class="text-dark text-decoration-none" itemprop="headline"><h3 class="mb-2"><?php print $item['title'] ?></h3></a>
                        <?php endif; ?>
