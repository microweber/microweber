<div class="mw-flex-row">
    <div class="mw-flex-col-xs-4 ">
        <div class="mw-ui-field-holder">
            ...
            <select name="slides-xs" class="mw-ui-field mw_option_field mw-full-width" data-option-group="{{ $params['id'] }}" data-columns="xs">
    ...
    <div class="mw-flex-col-xs-4 ">
        <div class="mw-ui-field-holder">
            ...
            <select name="slides-sm" class="mw-ui-field mw_option_field mw-full-width" data-option-group="{{ $params['id'] }}" data-columns="sm">
    ...
    <div class="mw-flex-col-xs-4 ">
        <div class="mw-ui-field-holder">
            ...
            <select name="slides-md" class="mw-ui-field mw_option_field mw-full-width" data-option-group="{{ $params['id'] }}" data-columns="md">
    ...
    <div class="mw-flex-col-xs-4 ">
        <div class="mw-ui-field-holder">
            ...
            <select name="slides-lg" class="mw-ui-field mw_option_field mw-full-width" data-option-group="{{ $params['id'] }}" data-columns="lg">
    ...
    <div class="mw-flex-col-xs-4 ">
        <div class="mw-ui-field-holder">
            ...
            <select name="slides-lg" class="mw-ui-field mw_option_field mw-full-width" data-option-group="{{ $params['id'] }}" data-columns="xl">
...
<div class="mw-flex-row slider-options">
    <div class="mw-flex-col-xs-4 ">
        <div class="mw-ui-field-holder">
            ...
            <select name="pager" class="mw-ui-field mw_option_field mw-full-width" option_group="{{ $params['id'] }}">
    ...
    <div class="mw-flex-col-xs-4 ">
        <div class="mw-ui-field-holder">
            ...
            <select name="controls" class="mw-ui-field mw_option_field mw-full-width" option_group="{{ $params['id'] }}">
    ...
    <div class="mw-flex-col-xs-4 ">
        <div class="mw-ui-field-holder">
            ...
            <select name="loop" class="mw-ui-field mw_option_field mw-full-width" option_group="{{ $params['id'] }}">
    ...
    <div class="mw-flex-col-xs-4 ">
        <div class="mw-ui-field-holder">
            ...
            <select name="adaptive_height" class="mw-ui-field mw_option_field mw-full-width" option_group="{{ $params['id'] }}">
    ...
    <div class="mw-flex-col-xs-4 ">
        <div class="mw-ui-field-holder">
            ...
            <input type="text" value="<?php print $speed; ?>" name="speed" class="mw-ui-field mw_option_field mw-full-width" option_group="{{ $params['id'] }}"/>
        </div>
    </div>
    ...
    <div class="mw-flex-col-xs-4 ">
        <div class="mw-ui-field-holder">
            ...
            <select name="pause_on_hover" class="mw-ui-field mw_option_field mw-full-width" option_group="{{ $params['id'] }}">
    ...
    <div class="mw-flex-col-xs-4 ">
        <div class="mw-ui-field-holder">
            ...
            <select name="autoplay" class="mw-ui-field mw_option_field mw-full-width" option_group="{{ $params['id'] }}">
    ...
    <div class="mw-flex-col-xs-4 ">
        <div class="mw-ui-field-holder">
            ...
            <select name="draggable" class="mw-ui-field mw_option_field mw-full-width" option_group="{{ $params['id'] }}">
    ...
    <div class="mw-flex-col-xs-4 ">
        <div class="mw-ui-field-holder">
            ...
            <select name="fade" class="mw-ui-field mw_option_field mw-full-width" option_group="{{ $params['id'] }}">
    ...
    <div class="mw-flex-col-xs-4 ">
        <div class="mw-ui-field-holder">
            ...
            <select name="focus_on_select" class="mw-ui-field mw_option_field mw-full-width" option_group="{{ $params['id'] }}">
    ...
    <div class="mw-flex-col-xs-4 ">
        <div class="mw-ui-field-holder">
            ...
            <input name="center_padding" class="mw-ui-field mw_option_field mw-full-width" data-option-group="{{ $params['id'] }}" value="<?php print $centerPadding; ?>" placeholder="40px"/>
        </div>
    </div>
</div>
