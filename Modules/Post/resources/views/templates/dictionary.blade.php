...
// pre-fix) before the Content dictionary @include. Cart buttons in
// the included Content template are correctly gated behind
// !empty($item['prices']) checks (Content dictionary lines 376/386
// /397), so the cart UI itself never appears for priceless items —
// but shop.js still loads.
//
...
@endif
@include('modules.content::templates.dictionary')
