...
Route::name('api.')
    ...
    ->group(function () {
        ...
        Route::any('offers_get_by_product_id', OfferApiResourceController::class . '@getByProductId');
        Route::get('offers_search_products', OfferApiResourceController::class . '@searchProducts');
    });
