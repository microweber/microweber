...
<form class="contact-form-container mw_form position-relative" data-form-id="{{ $form_id }}" name="{{ $form_id }}" method="post">
    ...
    <br><br>
    <module type="btn" button_action="submit" class="mb-2 w-100" button_style="btn-primary" button_size="px-5 d-block w-100" button_text="@lang('Send Message')"/>
