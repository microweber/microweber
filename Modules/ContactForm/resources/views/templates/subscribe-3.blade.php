    ...
    <div class="row justify-content-center">
        <div class="col-md-9">
            <module type="custom_fields" for-id="{{ $params['id'] }}" data-for="module" template="bootstrap5_flex"
                    default-fields="Name[type=text,field_size=6,show_placeholder=true], Email[type=email,field_size=6,show_placeholder=true]" input_class="form-control"/>
        </div>

        <div class="col-md-3">
            <module type="btn" button_action="submit" class="mb-2" button_style="btn-primary" button_size="w-100 justify-content-center" button_text="@lang('Join')"/>
        </div>
    </div>
