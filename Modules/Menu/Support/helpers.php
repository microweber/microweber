...
if (!function_exists('get_menus')) {
    ...
    {
        return app()->menu_manager->get_menus($params);
    }
}
...
if (!function_exists('menu_tree')) {
    ...
    {
        return app()->menu_manager->menu_tree($menu_id, $maxdepth, $show_images);
    }
}
...
if (!function_exists('is_in_menu')) {
    ...
    {
        return app()->menu_manager->is_in_menu($menu_id, $content_id);
    }
}
...
if (!function_exists('add_new_menu')) {
    ...
    {
        return app()->menu_manager->menu_create($data_to_save);
    }
}
...
if (!function_exists('get_menu')) {
    ...
    {
        return app()->menu_manager->get_menu($params);
    }
}
...
if (!function_exists('menu_delete')) {
    ...
    {
        return app()->menu_manager->menu_delete($id);
    }
}
...
if (!function_exists('get_menu_item')) {
    ...
    {
        return app()->menu_manager->menu_item_get($id);
    }
}
...
if (!function_exists('edit_menu_item')) {
    ...
    {
        return app()->menu_manager->menu_item_save($data_to_save);
    }
}
...
if (!function_exists('reorder_menu_items')) {
    ...
    {
        return app()->menu_manager->menu_items_reorder($data);
    }
}
