...
class PageApiRequest extends FormRequest
{
    /**
    ...
    public function rules(): array
    {
        ...
        return [
            ...
            'url' => [
                ...
                'string',
                'max:500',
                Rule::unique('content', 'url')->ignore($pageId),
            ],
    ...
    public function messages(): array
    {
        return [
            ...
            'title.max' => 'The page title may not be greater than 500 characters.',
            'url.unique' => 'This page URL is already in use.',
        ];
    }
