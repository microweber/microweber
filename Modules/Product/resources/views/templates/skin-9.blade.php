   ...
   @else
    <div class="row shop-products pt-7">
        @foreach ($data as $key => $item)
            ...
            <div class="mx-auto mx-md-0 col-lg-12 item-{{ $item['id'] }}"
                ...
                <div class="product h-100 d-flex flex-column position-relative">
                    <div class="h-100 d-md-flex">
                        ...
                        @if ($show_fields == false or in_array('thumbnail', $show_fields))
                            <a class="col-md-6 col-12" href="{{ $item['link'] }}">
                                <div class="img-as-background">
                                    ...
                                    @if (isset($item['original_price']) and $item['original_price'] != '')
                                        ...
                                        @endif
                                    @endif
                                    <img loading="lazy" class="mw-product-module-img" src="{{ thumbnail($item['image'], 850, 850) }}" alt="{{ $item['title'] ?? '' }}"/>
                                </div>
                            </a>
                        @endif
