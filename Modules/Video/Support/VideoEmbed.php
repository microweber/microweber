    ...
    public function render()
    {
        ...
        if ($this->isPlayEmbedVideo()) {
            ...
            if (!$html) {
                ...
                if (in_live_edit()) {
                    $html = "<div class='video-module-default-view mw-open-module-settings h-100 d-flex align-items-center justify-content-center'>
<img src='" . asset('modules/video/img/video_background_cover.svg') . "' style='width: 40px; height: 40px;'/></div>";
                }
            }
