...
class Content
{
    ...
    /**
     *  Array that holds the database table names as key and prefixed table name as value
     *
     * for example $tables['content'] = 'my_table_prefix_content'
     *
     * @var $tables
     */
    public $tables = array();
    ...
    public function db_init()
    {
        ...
        $fields_to_add['parent']= 'integer';
        $fields_to_add['description']= 'longText';
        $fields_to_add['content_meta_title']= 'longText';

        $fields_to_add['content_meta_keywords']= 'longText';
        $fields_to_add['position']= 'int(11) default 1');

        $fields_to_add['content']= 'LONGlongText';
        $fields_to_add['content_body']= 'LONGlongText';

        $fields_to_add['is_active']= "string";
        $fields_to_add['is_home']= "string";
        $fields_to_add['is_pinged']= "string";
        $fields_to_add['is_shop']= "string";
        $fields_to_add['is_deleted']= "string";
        $fields_to_add['draft_of']= 'integer';

        $fields_to_add['require_login']= "string";

        $fields_to_add['status']= 'longText';

        $fields_to_add['subtype']= 'longText';
        $fields_to_add['subtype_value']= 'longText';


        $fields_to_add['custom_type']= 'longText';
        $fields_to_add['custom_type_value']= 'longText';


        $fields_to_add['original_link']= 'longText';
        $fields_to_add['layout_file']= 'longText';
        ...
        $fields_to_add['created_by']= 'integer';
        $fields_to_add['edited_by']= 'integer';
        $fields_to_add['content_id']= 'string(11) DEFAULT NULL';
        $fields_to_add['field_name']= 'LONGlongText';
        $fields_to_add['field_value']= 'LONGlongText';
        ...
        $fields_to_add['value']= 'LONGlongText';
        $this->app->db->build_table($table_name, $fields_to_add);
        ...
        $fields_to_add['values']= 'longText';
        $fields_to_add['num_value']= 'float(11) default NULL';
        ...
        $fields_to_add['custom_field_help_text']= 'longText';
        $fields_to_add['options']= 'longText';


        $fields_to_add['custom_field_is_active']= "string";
        $fields_to_add['custom_field_required']= "string";
        ...
        $fields_to_add['item_type']= 'string(33) default NULL';
        $fields_to_add['parent_id']= 'integer';
        $fields_to_add['content_id']= 'integer';
        $fields_to_add['categories_id']= 'integer';
        $fields_to_add['position']= 'integer';
        $fields_to_add['updated_on']= 'dateTime';
        $fields_to_add['created_on']= 'dateTime';
        $fields_to_add['is_active']= "string";
        ...
        $fields_to_add['position']= 'integer';
        $fields_to_add['is_deleted']= "string";
        $fields_to_add['users_can_create_subcategories']= "string";
        $fields_to_add['users_can_create_content']= "string";
        $fields_to_add['users_can_create_content_allowed_usergroups']= 'longText';

        $fields_to_add['categories_content_type']= 'longText';
    ...
    public function db_filters()
    {
        ...
        $this->app->db->filter('category', $filters);
        $this->app->db->filter('categories', $filters);
    }
