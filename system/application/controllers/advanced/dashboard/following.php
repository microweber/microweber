...
$dashboard_following = $this->users_model->realtionsGetFollowedIdsForUser ( $aUserId = false,  $is_special, $query_options );
$query_options ['get_count'] = true;

$query_options ['items_per_page'] = false;
$dashboard_following_count = $this->users_model->realtionsGetFollowedIdsForUser ( $aUserId = false,  $is_special, $query_options );
