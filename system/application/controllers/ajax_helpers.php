...
*/
	...
	function cart_itemsGetTotal() {
		print (CI::model ( 'cart' )->itemsGetTotal ( false, CI::library ( 'session' )->userdata ( 'shop_currency' ) )) ;
	}
	...
	function cart_getTotal() {
		...
		print CI::model ( 'cart' )->itemsGetTotal ( $code, CI::library ( 'session' )->userdata ( 'shop_currency' ) );
	}
	...
	function cart_shippingCalculateToCountryName() {
		...
		print CI::model ( 'cart' )->shippingCalculateToCountryName ( $country, CI::library ( 'session' )->userdata ( 'shop_currency' ) );
	}
