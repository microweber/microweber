...
class Orders extends Controller {
	...
	function index() {
		...
		$primarycontent = CI::view ( 'admin/orders/index', true, true );
	...
	function promo_codes() {
		...
		$primarycontent = CI::view ( 'admin/orders/promo_codes', true, true );
	...
	function shipping_cost() {
		...
		$primarycontent = CI::view ( 'admin/orders/shipping_cost', true, true );
