...
class User extends Controller {
	...
	function status_update() {
		if ($_POST) {
			...
			$this->statuses_model->cleanOldStatuses ( $currentUser );
	...
	function statusUpdate() {
		exit ( __FUNCTION__ . ' is not supported anymore in ' . __FILE__ . ' line: ' . __LINE__ );
		if ($_POST) {
	...
	function message_send() {
		if ($_POST) {
			...
			$data ['is_read'] = 'n';
			$sent = $this->messages_model->messageSave ( $data );
