...
$table_name = false;
$table_name = TABLE_PREFIX . "cart_orders_shipping_cost";
...
if ($query [0] == $table_name) {
	...
	*/
	...
	$fields_to_add [] = array ('ship_to_continent', 'TEXT default NULL' );
	$fields_to_add [] = array ('shiping_cost_per_item', 'TEXT default NULL' );
