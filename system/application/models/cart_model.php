...
class Cart_model extends Model {
	...
	function ups_shiping_cost($ship_to, $ship_from, $shipment) {
		...
		$access_license_number = CI::model ( 'core' )->optionsGetByKey ( 'shop_ups_access_license_number' );
		
		$user_id = CI::model ( 'core' )->optionsGetByKey ( 'shop_ups_username' );
		$password = CI::model ( 'core' )->optionsGetByKey ( 'shop_ups_password' );
		$shipper_number = CI::model ( 'core' )->optionsGetByKey ( 'shop_ups_shipper_number' );
		
		$shipper_postal_code = CI::model ( 'core' )->optionsGetByKey ( 'shop_ups_shipper_postal_code' );
		
		$shipment_service_code = CI::model ( 'core' )->optionsGetByKey ( 'shop_ups_shipment_service_code' );
