...
$GLOBALS["error_msg"] = array(
	...
	"miscfilesize"		=> "Datei ist größer als die maximal zulässige Größe.",
...
$GLOBALS["messages"] = array(
	...
	'enter_alias_name' => 'Bitte geben Sie einen Aliasnamen für dieses Lesezeichen an',
	...
	'ftp_login_lbl' => 'Bitte geben Sie Ihre Login-Daten für den FTP Server ein',
	...
	'password_warning_text' => 'Das Benutzerkonto, mit dem Sie angemeldet sind (admin mit Passwort admin) entspricht dem des Standard-eXtplorer Administratorkontos. Wird Ihre eXtplorer Installation mit diesen Einstellungen betrieben, so können Unbefugte leicht von außen auf sie zugreifen. Sie sollten diese Sicherheitslücke unbedingt schließen!',
	'change_password_success' => 'Ihr Passwort wurde geändert!',
	'success' => 'Erfolg',
