...
smarty_core_load_plugins(array('plugins' => array(array('function', 'url', 'SitesManager/templates/DisplayAlternativeTags.tpl', 40, false),)), $this); ?>
...
piwik.php?idsite=<?php echo $this->_tpl_vars['idSite']; ?>
...
If you would like to contribute a version of the client in another programming language (Python, Java, Ruby, Perl, etc.) please <a target='_blank' href='<?php echo $this->_tpl_vars['currentUrlWithoutFilename']; ?>
?module=Proxy&action=redirect&url=http://dev.piwik.org/'>create a ticket</a> in our developer area (please attach the client code to the ticket).
</p><p>Follow these instructions to get started with the Tracking API:
<ul style='list-style-type:decimal;'>
<li><a href='<?php echo $this->_tpl_vars['currentUrlWithoutFilename']; ?>
<?php echo smarty_function_url(array('action' => 'downloadPiwikTracker'), $this);?>
...
PiwikTracker::$URL = '<?php echo $this->_tpl_vars['piwikUrl']; ?>
';<br/>
 ?&gt;
</code>
...
<br/>
echo '&lt;img src="'. Piwik_getUrlTrackPageView( $idSite = <?php echo $this->_tpl_vars['idSite']; ?>
...
echo '&lt;img src="'. Piwik_getUrlTrackGoal( $idSite = <?php echo $this->_tpl_vars['idSite']; ?>
...
<?php if (! isset ( $this->_tpl_vars['calledExternally'] ) || ! $this->_tpl_vars['calledExternally']): ?>
	<p>
	Read more about the Piwik Tracking API <a href='<?php echo $this->_tpl_vars['currentUrlWithoutFilename']; ?>
?module=Proxy&action=redirect&url=http://piwik.org/docs/tracking-api/' target='_blank'>in the documentation</a>
	</p>
<?php endif; ?>
</div>