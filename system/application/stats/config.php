...
if (is_file ( $f )) {
			...
			// Database Connection
$db_host = $mw_config ['db_hostname']; // database server (e.g. localhost)
$db_user = $mw_config ['db_username']; // user
$db_pass = $mw_config ['db_password']; // password
$db_name = $mw_config ['db_database'];// database name
$db_prefix = 'chilli_stats_1_'; // database prefix
