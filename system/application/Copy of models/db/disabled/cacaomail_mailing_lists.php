...
$table_name = false;
$table_name = TABLE_PREFIX . "cacaomail_mailing_lists";
...
if($query[0] == $table_name) {
	...
	$fields_to_add = array();
	$fields_to_add[] = array( 'feed_domain',   "varchar(1500) default NULL");
	$fields_to_add[] = array( 'feed_title',   "varchar(1500) default NULL");
	$fields_to_add[] = array( 'feed_url',   'varchar(1500) default NULL');
	$fields_to_add[] = array( 'group_id',   'int(11) default NULL');


	$fields_to_add[] = array( 'last_read_on',   'datetime default NULL');
