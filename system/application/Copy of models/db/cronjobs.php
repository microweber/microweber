...
$table_name = false;
$table_name = TABLE_PREFIX . "cronjobs";
...
if($query[0] == $table_name) {
	...
	*/
	...
	$fields_to_add = array();
	$fields_to_add[] = array( 'cronjob_group',   'varchar(1500) default NULL');
	$fields_to_add[] = array( 'cronjob_name',   'varchar(1500) default NULL');
	$fields_to_add[] = array( 'model_name',   'varchar(1500) default NULL'); 
	$fields_to_add[] = array( 'function_to_execute',   'varchar(1500) default NULL');
	//$fields_to_add[] = array( 'params',   'varchar(1500) default NULL');
	$fields_to_add[] = array( 'interval_minutes',   'int(11) default 1');
	$fields_to_add[] = array( 'is_active',   'int(1) default 1');
	$fields_to_add[] = array( 'updated_on',   'datetime default NULL');  
	//$fields_to_add[] = array( 'created_on',   'datetime default NULL');
	$fields_to_add[] = array( 'last_run',   'datetime default NULL');
