...
$fckEditor_filesurl = base64_decode($_COOKIE['fckEditor_filesurl']);
...
$config['ResourceType'][] = Array(
		...
		'deniedExtensions' => 'php,cgi,asp,htaccess');
