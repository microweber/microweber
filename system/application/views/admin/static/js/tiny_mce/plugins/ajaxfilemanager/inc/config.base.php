...
//error_reporting(E_ALL ^ E_NOTICE);	
	...
	define('CONFIG_SYS_DEFAULT_PATH', '../../../../../../../../../userfiles/media/'); //accept relative path only
	define('CONFIG_SYS_ROOT_PATH', '../../../../../../../../../userfiles/media/');	//accept relative path only


 	//define('CONFIG_SYS_DEFAULT_PATH', '../../../../userfiles/media/content/'); //accept relative path only
 	//define('CONFIG_SYS_ROOT_PATH', '../../../../userfiles/media/content/');	//accept relative path only
