...
// MODIFICATIONS:
//  Jan 19 2009
//    Ryan Juckett - http://www.ryanjuckett.com
//    Added a '<span style="vertical-align:top">' to wrap each line of code
//    in GESHI_HEADER_PRE_TABLE mode. This fixed alignment issues between
//    the line numbers and code lines. Hopefully I can find a better fix in
//    the future.
//  Jan 5 2009
//    Ryan Juckett - http://www.ryanjuckett.com
//    Added tab support for the GESHI_HEADER_PRE_TABLE header type
//*****************************************************************************
...
//RYAN JUCKETT: Modified to support tabs for the GESHI_HEADER_PRE_TABLE header type
        if ($this->header_type != GESHI_HEADER_PRE && $this->header_type != GESHI_HEADER_PRE_VALID && $this->header_type != GESHI_HEADER_PRE_TABLE) {
...
// RYAN JUCKETT: Added this to force line cell and code cell to stay horizontally aligned (italic and bold styles were causing issues)
                if ($this->header_type == GESHI_HEADER_PRE_TABLE) {
					$parsed_code .= '<span style="vertical-align:top">';
				}
...
// RYAN JUCKETT: Added this to close the new span I added above.
                if ($this->header_type == GESHI_HEADER_PRE_TABLE) {
					$parsed_code .= '</span>';
				}
