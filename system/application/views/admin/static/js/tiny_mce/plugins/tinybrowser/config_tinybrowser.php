...
$tinybrowser['obfuscate'] = 's0meranaazzzzzzxd0mjunk!!!111';
...
$tinybrowser['docroot'] = '';
//$tinybrowser['docroot'] = 'http://workspace.ooyes.net/wfl_dev/static/js/tiny_mce/plugins/tinybrowser/';

// Folder permissions for Unix servers only
$tinybrowser['unixpermissions'] = 0777;

// File upload paths (set to absolute by default)
@mkdir($filespath.'image/');
@mkdir($filespath.'media/');
@mkdir($filespath.'file/');

$tinybrowser['path']['image'] = $filespath.'image/'; // Image files location - also creates a '_thumbs' subdirectory within this path to hold the image thumbnails
$tinybrowser['path']['media'] = $filespath.'media/'; // Media files location
$tinybrowser['path']['file']  = $filespath.'file/'; // Other files location
...
$tinybrowser['link']['image'] = $filesurl.'image/'; // Image links
$tinybrowser['link']['media'] = $filesurl.'media/';; // Media links
$tinybrowser['link']['file']  = $filesurl.'file/';; // Other file links
