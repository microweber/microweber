 ...
 <link rel="stylesheet" href="<?php   print( ADMIN_STATIC_FILES_URL);  ?>aloha/css/aloha.css" type="text/css">
	<script src="<?php   print( ADMIN_STATIC_FILES_URL);  ?>aloha/lib/aloha.js" data-aloha-plugins="common/format,common/highlighteditables,common/list,common/link,common/undo,common/paste,common/block"></script>
    
    
<!--
<script type="text/javascript" src="<?php   print( ADMIN_STATIC_FILES_URL);  ?>aloha/examples/aloha/aloha.js"></script>
...
<style>
 ...
 <button id="ContentSave" onclick="mw_save_all()">Save all</button>
