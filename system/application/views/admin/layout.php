...
<div id="container" align="center">
  <div id="liquid" align="left">
    ...
    <!-- /#header -->
    <div id="content">
      <div class="box radius mainbox"> {content} </div>
      <button onclick="mw.modal.alert('This is an alert')">alert</button>
      <button onclick="mw.modal.confirm({html:'Confirm?', yes:function(){alert('yes')}, no:function(){alert('no')}, id:'some_id'})">confirm</button>
      <!-- /.mainbox -->
    </div>
    <!-- /#content -->
  </div>
