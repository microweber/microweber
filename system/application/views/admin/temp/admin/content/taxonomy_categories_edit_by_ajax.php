...
<?php $cat_pic = $this->core_model->mediaGetThumbnailForItem('table_taxonomy', $form_values['id'], $size = 128, $order_direction = "DESC", $media_type = 'picture'); ?>
 ...
 <label class="lbl">Pictures:</label>
          ...
          <div>
            ...
            <input type="button" name="old_category_reasign_items" value="Old category items migrate" onclick="categories_migrate_old_category_items()"  />
