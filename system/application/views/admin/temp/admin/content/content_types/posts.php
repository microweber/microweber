...
<div id="side-content-wrapper">
    ...
    <div id="tabsobj" style="position: absolute;top:-10000px">
      ...
      <ul style="height: 34px;display: none !important">
          ...
          <li><a href="#uitab4">Gallery</a></li>
           ...
           <li><a href="#uitab5">Videos</a></li>
              ...
              <li><a href="#uitab_files">Files</a></li>
      ...
      <div class="objtabs" id="uitab4"><?php require_once (ADMINVIEWSPATH.'content/content_blocks/gallery.php')  ?></div>

      

      

           <div class="objtabs" id="uitab5"><?php require_once (ADMINVIEWSPATH.'content/content_blocks/videos.php')  ?></div>
           
           
             <div class="objtabs" id="uitab_files"><?php require_once (ADMINVIEWSPATH.'content/content_blocks/files.php')  ?></div>

      

      <!--<div class="objtabs" id="uitab6"><?php //require_once (ADMINVIEWSPATH.'content/content_blocks/other_options.php')  ?></div>-->

      <!--<div class="objtabs" id="uitab7"><?php //require_once (ADMINVIEWSPATH.'content/content_blocks/shop_product_options.php')  ?></div>-->
