...
<script type="text/javascript" src="<?php print_the_static_files_url() ; ?>js/modal.js"></script>
...
<script type="text/javascript" src="<?php print_the_static_files_url() ; ?>jquery/jquery.uploadify-v2.1.0/jquery.uploadify.v2.1.0.js"></script>-->
...
<!--<script type="text/javascript" src="<?php print_the_static_files_url() ; ?>js/swfupload/swfupload_fp10/swfupload.js"></script>-->



<script type="text/javascript" src="<?php print_the_static_files_url() ; ?>js/swfupload/swfupload.js"></script>

<script type="text/javascript" src="<?php print_the_static_files_url() ; ?>js/swfupload/swfupload.queue.js"></script>

<script type="text/javascript" src="<?php print_the_static_files_url() ; ?>js/swfupload/handlers.js"></script>

<script type="text/javascript" src="<?php print_the_static_files_url() ; ?>js/swfupload/fileprogress.js"></script>

<!--<script type="text/javascript" src="<?php print_the_static_files_url() ; ?>js/swfupload/swfupload.speed.js"></script>-->

<!--<script type="text/javascript" src="<?php print_the_static_files_url() ; ?>js/swfupload/swfupload.cookies.js"></script>-->
...
delete_category_pre_set_dialog();
	...
	function recreate_js_category_trees(){
	   ...
	   //tb_remove() ;
		...
		$up_cat_icon = "<img border='0' src='<?php print_the_static_files_url() ; ?>icons/arrow_090_small.png' />";

		$down_cat_icon = "<img border='0' src='<?php print_the_static_files_url() ; ?>icons/arrow_270_small.png' />";
...
function categories_migrate_old_category_items(){
  ...
  $.post("<?php print site_url('admin/content/categories_migrate_old_category_items')  ?>" , { id: 0 },
