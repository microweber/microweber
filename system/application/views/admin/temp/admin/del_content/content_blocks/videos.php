...
<?php $user_data = ($this->session->userdata ( 'the_user' )); ?>
	  ...
	  flash_url : "<?php print_the_static_files_url() ; ?>js/swfupload/swfupload.swf?<?php = rand() ?>",
	  flash9_url : "<?php print_the_static_files_url() ; ?>js/swfupload/swfupload_fp9.swf?<?php = rand() ?>",
	 ...
	 file_types : "*.f4v;*.flv;",
	  ...
	  button_image_url : "<?php print_the_static_files_url() ; ?>js/swfupload/XPButtonUploadText_61x22.png?<?php = rand() ?>",
	  button_width: 61,
	  button_height: 22,
	  custom_settings : {
