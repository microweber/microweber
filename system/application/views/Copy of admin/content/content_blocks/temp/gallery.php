...
var media_upload_queue = $('#media_queue_pictures').val();
	$("#uploadify").uploadify({
		...
		'script'         : "<?php print site_url('admin/media/mediaUploadPictures') ?>/to_table:table_content/queue_id:"+media_upload_queue,
		'cancelImg'      : uploadify_cancel_image_url,
		'folder'         : "<?php print site_url('admin/media/mediaUploadPictures') ?>/to_table:table_content/queue_id:"+media_upload_queue,
