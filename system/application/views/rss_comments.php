...
<rss version="2.0"
    ...
    <?php foreach($comments as $item): ?>
        ...
        <item>
          ...
          <title><?php print xml_convert($item['comment_name']); ?></title>
          <link><![CDATA[<?php print $this->content_model->contentGetHrefForPostId($post['id']); ?>#comment-<?php print $item['id'] ?>]]></link>
