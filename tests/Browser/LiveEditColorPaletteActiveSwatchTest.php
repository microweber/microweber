...
class LiveEditColorPaletteActiveSwatchTest extends DuskTestCase
{
    ...
    /**
     * Programmatically show `mw.top().app.templateSettingsWidget` — the
     * `mw.controlBox` that hosts the Vue TemplateSettings component via
     * teleport into `#template-settings-teleport-widget-content`. Users
     * normally open it by clicking the sidebar toggle, but calling
     * `.show()` is the same API the toolbar binds to.
     */
