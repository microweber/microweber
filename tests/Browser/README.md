# Browser Automation Tests with Laravel Dusk

This directory contains comprehensive browser automation tests using Laravel Dusk for critical user flows in the Microweber CMS.
